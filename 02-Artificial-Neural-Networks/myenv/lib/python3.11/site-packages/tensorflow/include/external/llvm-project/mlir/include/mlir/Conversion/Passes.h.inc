...
template <typename DerivedT>
class ConvertBufferizationToMemRefBase : public ::mlir::OperationPass<mlir::ModuleOp> {
public:
  using Base = ConvertBufferizationToMemRefBase;

  ConvertBufferizationToMemRefBase() : ::mlir::OperationPass<mlir::ModuleOp>(::mlir::TypeID::get<DerivedT>()) {}
  ConvertBufferizationToMemRefBase(const ConvertBufferizationToMemRefBase &other) : ::mlir::OperationPass<mlir::ModuleOp>(other) {}
...
public:
  ...
  ::llvm::StringRef getDescription() const override { return "Convert NVVM dialect to LLVM dialect"; }
...
std::unique_ptr<::mlir::Pass> createConvertVectorToArmSME();
...
private:
  ...
  friend std::unique_ptr<::mlir::Pass> createConvertVectorToArmSME() {
    return std::make_unique<DerivedT>();
  }
};
} // namespace impl
...
std::unique_ptr<::mlir::Pass> createConvertVectorToArmSME() {
  return impl::createConvertVectorToArmSME();
}
...
protected:
  ...
  ::mlir::Pass::Option<bool> armSME{*this, "enable-arm-sme", ::llvm::cl::desc("Enables the use of ArmSME dialect while lowering the vector dialect."), ::llvm::cl::init(false)};
...
inline void registerConvertVectorToArmSME() {
  ::mlir::registerPass([]() -> std::unique_ptr<::mlir::Pass> {
    return createConvertVectorToArmSME();
  });
}
