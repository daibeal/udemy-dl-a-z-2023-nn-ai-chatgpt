...
constexpr PrimitiveType PrimitiveType_MAX = F8E4M3FNUZ;
...
constexpr DimLevelType DimLevelType_MAX = DIM_COMPRESSED_WITH_HI;
...
inline void OpMetadata::clear_creation_pass_id() {
  _impl_.creation_pass_id_ = int64_t{0};
}
inline int64_t OpMetadata::_internal_creation_pass_id() const {
  return _impl_.creation_pass_id_;
}
inline int64_t OpMetadata::creation_pass_id() const {
  // @@protoc_insertion_point(field_get:xla.OpMetadata.creation_pass_id)
  return _internal_creation_pass_id();
}
inline void OpMetadata::_internal_set_creation_pass_id(int64_t value) {
  
  _impl_.creation_pass_id_ = value;
}
inline void OpMetadata::set_creation_pass_id(int64_t value) {
...
inline void OpMetadata::clear_logical_creation_pass_id() {
  _impl_.logical_creation_pass_id_ = int64_t{0};
}
inline int64_t OpMetadata::_internal_logical_creation_pass_id() const {
  return _impl_.logical_creation_pass_id_;
}
inline int64_t OpMetadata::logical_creation_pass_id() const {
  // @@protoc_insertion_point(field_get:xla.OpMetadata.logical_creation_pass_id)
  return _internal_logical_creation_pass_id();
}
inline void OpMetadata::_internal_set_logical_creation_pass_id(int64_t value) {
  
  _impl_.logical_creation_pass_id_ = value;
}
inline void OpMetadata::set_logical_creation_pass_id(int64_t value) {
...
inline int32_t DeviceAssignmentProto_ComputationDevice::_internal_replica_device_ids(int index) const {
  return _impl_.replica_device_ids_.Get(index);
}
inline int32_t DeviceAssignmentProto_ComputationDevice::replica_device_ids(int index) const {
...
inline void DeviceAssignmentProto_ComputationDevice::set_replica_device_ids(int index, int32_t value) {
...
inline void DeviceAssignmentProto_ComputationDevice::_internal_add_replica_device_ids(int32_t value) {
  _impl_.replica_device_ids_.Add(value);
}
inline void DeviceAssignmentProto_ComputationDevice::add_replica_device_ids(int32_t value) {
