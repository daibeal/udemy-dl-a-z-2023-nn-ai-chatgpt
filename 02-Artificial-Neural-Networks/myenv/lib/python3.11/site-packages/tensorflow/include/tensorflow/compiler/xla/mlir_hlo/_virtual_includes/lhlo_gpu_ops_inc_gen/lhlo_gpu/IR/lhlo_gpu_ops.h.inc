...
namespace mlir {
namespace lmhlo_gpu {
class fusedMHAWithMaskBackwardOp;
} // namespace lmhlo_gpu
} // namespace mlir
namespace mlir {
namespace lmhlo_gpu {
class fusedMHAWithScaledBiasOp;
} // namespace lmhlo_gpu
} // namespace mlir
namespace mlir {
namespace lmhlo_gpu {
class fusedMHAWithScaledMaskOp;
} // namespace lmhlo_gpu
} // namespace mlir
#endif
...
protected:
  ...
  ::mlir::RegionRange odsRegions;
public:
  ConvForwardGraphOpGenericAdaptorBase(::mlir::DictionaryAttr attrs = nullptr, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {});
...
public:
  ConvForwardGraphOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs = nullptr, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {}) : Base(attrs, properties, regions), odsOperands(values) {}
...
class ConvForwardGraphOp : public ::mlir::Op<ConvForwardGraphOp, ::mlir::OpTrait::ZeroRegions, ::mlir::OpTrait::ZeroResults, ::mlir::OpTrait::ZeroSuccessors, ::mlir::OpTrait::AtLeastNOperands<4>::Impl, ::mlir::OpTrait::OpInvariants, ::mlir::MemoryEffectOpInterface::Trait> {
public:
  using Op::Op;
  using Op::print;
  ...
  ::mlir::Attribute removeWindowReversalAttr();
  ::mlir::Attribute removePrecisionConfigAttr();
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Value input, ::mlir::Value filter, ::mlir::ValueRange binary_operands, ::mlir::Value output, ::mlir::Value scratch, /*optional*/::mlir::DenseIntElementsAttr window_strides, /*optional*/::mlir::DenseIntElementsAttr padding, /*optional*/::mlir::DenseIntElementsAttr lhs_dilation, /*optional*/::mlir::DenseIntElementsAttr rhs_dilation, /*optional*/::mlir::DenseElementsAttr window_reversal, ::mlir::mhlo::ConvDimensionNumbersAttr dimension_numbers, ::mlir::IntegerAttr feature_group_count, ::mlir::IntegerAttr batch_group_count, /*optional*/::mlir::ArrayAttr precision_config, ::mlir::FloatAttr result_scale, ::mlir::StringAttr serialized_graph, ::mlir::lmhlo_gpu::ConvolutionBackendConfigAttr backend_config);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value input, ::mlir::Value filter, ::mlir::ValueRange binary_operands, ::mlir::Value output, ::mlir::Value scratch, /*optional*/::mlir::DenseIntElementsAttr window_strides, /*optional*/::mlir::DenseIntElementsAttr padding, /*optional*/::mlir::DenseIntElementsAttr lhs_dilation, /*optional*/::mlir::DenseIntElementsAttr rhs_dilation, /*optional*/::mlir::DenseElementsAttr window_reversal, ::mlir::mhlo::ConvDimensionNumbersAttr dimension_numbers, ::mlir::IntegerAttr feature_group_count, ::mlir::IntegerAttr batch_group_count, /*optional*/::mlir::ArrayAttr precision_config, ::mlir::FloatAttr result_scale, ::mlir::StringAttr serialized_graph, ::mlir::lmhlo_gpu::ConvolutionBackendConfigAttr backend_config);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Value input, ::mlir::Value filter, ::mlir::ValueRange binary_operands, ::mlir::Value output, ::mlir::Value scratch, /*optional*/::mlir::DenseIntElementsAttr window_strides, /*optional*/::mlir::DenseIntElementsAttr padding, /*optional*/::mlir::DenseIntElementsAttr lhs_dilation, /*optional*/::mlir::DenseIntElementsAttr rhs_dilation, /*optional*/::mlir::DenseElementsAttr window_reversal, ::mlir::mhlo::ConvDimensionNumbersAttr dimension_numbers, uint64_t feature_group_count, uint64_t batch_group_count, /*optional*/::mlir::ArrayAttr precision_config, ::llvm::APFloat result_scale, ::llvm::StringRef serialized_graph, ::mlir::lmhlo_gpu::ConvolutionBackendConfigAttr backend_config);
  static void build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value input, ::mlir::Value filter, ::mlir::ValueRange binary_operands, ::mlir::Value output, ::mlir::Value scratch, /*optional*/::mlir::DenseIntElementsAttr window_strides, /*optional*/::mlir::DenseIntElementsAttr padding, /*optional*/::mlir::DenseIntElementsAttr lhs_dilation, /*optional*/::mlir::DenseIntElementsAttr rhs_dilation, /*optional*/::mlir::DenseElementsAttr window_reversal, ::mlir::mhlo::ConvDimensionNumbersAttr dimension_numbers, uint64_t feature_group_count, uint64_t batch_group_count, /*optional*/::mlir::ArrayAttr precision_config, ::llvm::APFloat result_scale, ::llvm::StringRef serialized_graph, ::mlir::lmhlo_gpu::ConvolutionBackendConfigAttr backend_config);
  static void build(::mlir::OpBuilder &, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::ValueRange operands, ::llvm::ArrayRef<::mlir::NamedAttribute> attributes = {});
  ::mlir::LogicalResult verifyInvariantsImpl();
  ::mlir::LogicalResult verifyInvariants();
...
protected:
  ...
  ::mlir::RegionRange odsRegions;
public:
  fusedMHABackwardOpGenericAdaptorBase(::mlir::DictionaryAttr attrs = nullptr, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {});
...
public:
  fusedMHABackwardOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs = nullptr, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {}) : Base(attrs, properties, regions), odsOperands(values) {}
...
class fusedMHABackwardOp : public ::mlir::Op<fusedMHABackwardOp, ::mlir::OpTrait::ZeroRegions, ::mlir::OpTrait::ZeroResults, ::mlir::OpTrait::ZeroSuccessors, ::mlir::OpTrait::AtLeastNOperands<10>::Impl, ::mlir::OpTrait::OpInvariants, ::mlir::MemoryEffectOpInterface::Trait> {
public:
  using Op::Op;
  using Op::print;
  ...
  ::mlir::MutableOperandRange getBmm1GradGemm1RhsMutable();
  ::mlir::MutableOperandRange getBmm1GradGemm2RhsMutable();
  ::mlir::MutableOperandRange getBmm2GradGemm2RhsMutable();
  ::mlir::MutableOperandRange getBmm2GradGemm1LhsMutable();
  ::mlir::MutableOperandRange getDOutputMutable();
  ::mlir::MutableOperandRange getDBmm1LhsMutable();
  ::mlir::MutableOperandRange getDBmm1RhsMutable();
  ::mlir::MutableOperandRange getDBmm2RhsMutable();
...
protected:
  ...
  ::mlir::RegionRange odsRegions;
public:
  fusedMHAOpGenericAdaptorBase(::mlir::DictionaryAttr attrs = nullptr, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {});
...
public:
  fusedMHAOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs = nullptr, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {}) : Base(attrs, properties, regions), odsOperands(values) {}
...
class fusedMHAOp : public ::mlir::Op<fusedMHAOp, ::mlir::OpTrait::ZeroRegions, ::mlir::OpTrait::ZeroResults, ::mlir::OpTrait::ZeroSuccessors, ::mlir::OpTrait::AtLeastNOperands<5>::Impl, ::mlir::OpTrait::OpInvariants, ::mlir::MemoryEffectOpInterface::Trait> {
public:
  using Op::Op;
  using Op::print;
  ...
  ::mlir::MutableOperandRange getLhsBmm1Mutable();
  ::mlir::MutableOperandRange getRhsBmm1Mutable();
  ::mlir::MutableOperandRange getRhsBmm2Mutable();
  ::mlir::MutableOperandRange getOutputMutable();
  ::mlir::MutableOperandRange getScratchMutable();
...
//===----------------------------------------------------------------------===//
// ::mlir::lmhlo_gpu::fusedMHAWithMaskBackwardOp declarations
//===----------------------------------------------------------------------===//

namespace detail {
class fusedMHAWithMaskBackwardOpGenericAdaptorBase {
public:
protected:
  ::mlir::DictionaryAttr odsAttrs;
  ::std::optional<::mlir::OperationName> odsOpName;
  ::mlir::RegionRange odsRegions;
public:
  fusedMHAWithMaskBackwardOpGenericAdaptorBase(::mlir::DictionaryAttr attrs = nullptr, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {});
...
template <typename RangeT>
class fusedMHAWithMaskBackwardOpGenericAdaptor : public detail::fusedMHAWithMaskBackwardOpGenericAdaptorBase {
  using ValueT = ::llvm::detail::ValueOfRange<RangeT>;
  using Base = detail::fusedMHAWithMaskBackwardOpGenericAdaptorBase;
public:
  fusedMHAWithMaskBackwardOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs = nullptr, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {}) : Base(attrs, properties, regions), odsOperands(values) {}

  fusedMHAWithMaskBackwardOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs, ::mlir::OpaqueProperties properties, ::mlir::RegionRange regions = {}) : fusedMHAWithMaskBackwardOpGenericAdaptor(values, attrs, (properties ? *properties.as<::mlir::EmptyProperties *>() : ::mlir::EmptyProperties{}), regions) {}
...
class fusedMHAWithMaskBackwardOpAdaptor : public fusedMHAWithMaskBackwardOpGenericAdaptor<::mlir::ValueRange> {
public:
  using fusedMHAWithMaskBackwardOpGenericAdaptor::fusedMHAWithMaskBackwardOpGenericAdaptor;
  fusedMHAWithMaskBackwardOpAdaptor(fusedMHAWithMaskBackwardOp op);

  ::mlir::LogicalResult verify(::mlir::Location loc);
};
class fusedMHAWithMaskBackwardOp : public ::mlir::Op<fusedMHAWithMaskBackwardOp, ::mlir::OpTrait::ZeroRegions, ::mlir::OpTrait::ZeroResults, ::mlir::OpTrait::ZeroSuccessors, ::mlir::OpTrait::AtLeastNOperands<11>::Impl, ::mlir::OpTrait::OpInvariants, ::mlir::MemoryEffectOpInterface::Trait> {
public:
  using Op::Op;
  using Op::print;
  using Adaptor = fusedMHAWithMaskBackwardOpAdaptor;
  template <typename RangeT>
  using GenericAdaptor = fusedMHAWithMaskBackwardOpGenericAdaptor<RangeT>;
  using FoldAdaptor = GenericAdaptor<::llvm::ArrayRef<::mlir::Attribute>>;
  static ::llvm::ArrayRef<::llvm::StringRef> getAttributeNames() {
    static ::llvm::StringRef attrNames[] = {::llvm::StringRef("algorithm_config"), ::llvm::StringRef("bmm1_grad_gemm1_dot_dimension_numbers"), ::llvm::StringRef("bmm1_grad_gemm2_dot_dimension_numbers"), ::llvm::StringRef("bmm2_grad_gemm1_dot_dimension_numbers"), ::llvm::StringRef("bmm2_grad_gemm2_dot_dimension_numbers"), ::llvm::StringRef("dropout_rate"), ::llvm::StringRef("fmha_scale"), ::llvm::StringRef("fused_mha_dag"), ::llvm::StringRef("seed")};
    return ::llvm::ArrayRef(attrNames);
  ...
  static constexpr ::llvm::StringLiteral getOperationName() {
    return ::llvm::StringLiteral("lmhlo_gpu.fMHAWithMaskBackward");
  }
...
MLIR_DECLARE_EXPLICIT_TYPE_ID(::mlir::lmhlo_gpu::fusedMHAWithMaskBackwardOp)

namespace mlir {
namespace lmhlo_gpu {

//===----------------------------------------------------------------------===//
// ::mlir::lmhlo_gpu::fusedMHAWithScaledBiasOp declarations
//===----------------------------------------------------------------------===//

namespace detail {
class fusedMHAWithScaledBiasOpGenericAdaptorBase {
public:
protected:
  ::mlir::DictionaryAttr odsAttrs;
  ::std::optional<::mlir::OperationName> odsOpName;
  ::mlir::RegionRange odsRegions;
public:
  fusedMHAWithScaledBiasOpGenericAdaptorBase(::mlir::DictionaryAttr attrs = nullptr, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {});
...
template <typename RangeT>
class fusedMHAWithScaledBiasOpGenericAdaptor : public detail::fusedMHAWithScaledBiasOpGenericAdaptorBase {
  using ValueT = ::llvm::detail::ValueOfRange<RangeT>;
  using Base = detail::fusedMHAWithScaledBiasOpGenericAdaptorBase;
public:
  fusedMHAWithScaledBiasOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs = nullptr, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {}) : Base(attrs, properties, regions), odsOperands(values) {}

  fusedMHAWithScaledBiasOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs, ::mlir::OpaqueProperties properties, ::mlir::RegionRange regions = {}) : fusedMHAWithScaledBiasOpGenericAdaptor(values, attrs, (properties ? *properties.as<::mlir::EmptyProperties *>() : ::mlir::EmptyProperties{}), regions) {}
...
class fusedMHAWithScaledBiasOpAdaptor : public fusedMHAWithScaledBiasOpGenericAdaptor<::mlir::ValueRange> {
public:
  using fusedMHAWithScaledBiasOpGenericAdaptor::fusedMHAWithScaledBiasOpGenericAdaptor;
  fusedMHAWithScaledBiasOpAdaptor(fusedMHAWithScaledBiasOp op);

  ::mlir::LogicalResult verify(::mlir::Location loc);
};
class fusedMHAWithScaledBiasOp : public ::mlir::Op<fusedMHAWithScaledBiasOp, ::mlir::OpTrait::ZeroRegions, ::mlir::OpTrait::ZeroResults, ::mlir::OpTrait::ZeroSuccessors, ::mlir::OpTrait::AtLeastNOperands<6>::Impl, ::mlir::OpTrait::OpInvariants, ::mlir::MemoryEffectOpInterface::Trait> {
public:
  using Op::Op;
  using Op::print;
  using Adaptor = fusedMHAWithScaledBiasOpAdaptor;
  template <typename RangeT>
  using GenericAdaptor = fusedMHAWithScaledBiasOpGenericAdaptor<RangeT>;
  using FoldAdaptor = GenericAdaptor<::llvm::ArrayRef<::mlir::Attribute>>;
  static ::llvm::ArrayRef<::llvm::StringRef> getAttributeNames() {
    static ::llvm::StringRef attrNames[] = {::llvm::StringRef("algorithm_config"), ::llvm::StringRef("bmm1_dot_dimension_numbers"), ::llvm::StringRef("bmm2_dot_dimension_numbers"), ::llvm::StringRef("dropout_rate"), ::llvm::StringRef("fmha_scale"), ::llvm::StringRef("fused_mha_dag"), ::llvm::StringRef("intermediate_tensor_dimensions"), ::llvm::StringRef("intermediate_tensor_layout"), ::llvm::StringRef("seed")};
    return ::llvm::ArrayRef(attrNames);
  ...
  static constexpr ::llvm::StringLiteral getOperationName() {
    return ::llvm::StringLiteral("lmhlo_gpu.fMHAWithScaledBias");
  }
...
MLIR_DECLARE_EXPLICIT_TYPE_ID(::mlir::lmhlo_gpu::fusedMHAWithScaledBiasOp)

namespace mlir {
namespace lmhlo_gpu {

//===----------------------------------------------------------------------===//
// ::mlir::lmhlo_gpu::fusedMHAWithScaledMaskOp declarations
//===----------------------------------------------------------------------===//

namespace detail {
class fusedMHAWithScaledMaskOpGenericAdaptorBase {
public:
protected:
  ::mlir::DictionaryAttr odsAttrs;
  ::std::optional<::mlir::OperationName> odsOpName;
  ::mlir::RegionRange odsRegions;
public:
  fusedMHAWithScaledMaskOpGenericAdaptorBase(::mlir::DictionaryAttr attrs, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {});
...
template <typename RangeT>
class fusedMHAWithScaledMaskOpGenericAdaptor : public detail::fusedMHAWithScaledMaskOpGenericAdaptorBase {
  using ValueT = ::llvm::detail::ValueOfRange<RangeT>;
  using Base = detail::fusedMHAWithScaledMaskOpGenericAdaptorBase;
public:
  fusedMHAWithScaledMaskOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs, const ::mlir::EmptyProperties &properties = {}, ::mlir::RegionRange regions = {}) : Base(attrs, properties, regions), odsOperands(values) {}

  fusedMHAWithScaledMaskOpGenericAdaptor(RangeT values, ::mlir::DictionaryAttr attrs, ::mlir::OpaqueProperties properties, ::mlir::RegionRange regions = {}) : fusedMHAWithScaledMaskOpGenericAdaptor(values, attrs, (properties ? *properties.as<::mlir::EmptyProperties *>() : ::mlir::EmptyProperties{}), regions) {}
...
class fusedMHAWithScaledMaskOpAdaptor : public fusedMHAWithScaledMaskOpGenericAdaptor<::mlir::ValueRange> {
public:
  using fusedMHAWithScaledMaskOpGenericAdaptor::fusedMHAWithScaledMaskOpGenericAdaptor;
  fusedMHAWithScaledMaskOpAdaptor(fusedMHAWithScaledMaskOp op);

  ::mlir::LogicalResult verify(::mlir::Location loc);
};
class fusedMHAWithScaledMaskOp : public ::mlir::Op<fusedMHAWithScaledMaskOp, ::mlir::OpTrait::ZeroRegions, ::mlir::OpTrait::ZeroResults, ::mlir::OpTrait::ZeroSuccessors, ::mlir::OpTrait::AtLeastNOperands<6>::Impl, ::mlir::OpTrait::AttrSizedOperandSegments, ::mlir::OpTrait::OpInvariants, ::mlir::MemoryEffectOpInterface::Trait> {
public:
  using Op::Op;
  using Op::print;
  using Adaptor = fusedMHAWithScaledMaskOpAdaptor;
  template <typename RangeT>
  using GenericAdaptor = fusedMHAWithScaledMaskOpGenericAdaptor<RangeT>;
  using FoldAdaptor = GenericAdaptor<::llvm::ArrayRef<::mlir::Attribute>>;
  static ::llvm::ArrayRef<::llvm::StringRef> getAttributeNames() {
    static ::llvm::StringRef attrNames[] = {::llvm::StringRef("algorithm_config"), ::llvm::StringRef("bmm1_dot_dimension_numbers"), ::llvm::StringRef("bmm2_dot_dimension_numbers"), ::llvm::StringRef("dropout_rate"), ::llvm::StringRef("fmha_scale"), ::llvm::StringRef("fused_mha_dag"), ::llvm::StringRef("intermediate_tensor_dimensions"), ::llvm::StringRef("intermediate_tensor_layout"), ::llvm::StringRef("operand_segment_sizes"), ::llvm::StringRef("seed")};
    return ::llvm::ArrayRef(attrNames);
  }
  ...
  static constexpr ::llvm::StringLiteral getOperationName() {
    return ::llvm::StringLiteral("lmhlo_gpu.fMHAWithScaledMask");
  }
...
MLIR_DECLARE_EXPLICIT_TYPE_ID(::mlir::lmhlo_gpu::fusedMHAWithScaledMaskOp)
