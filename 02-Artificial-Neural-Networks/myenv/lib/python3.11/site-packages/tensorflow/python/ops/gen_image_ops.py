...
def adjust_contrastv2_eager_fallback(images: _atypes.TensorFuzzingAnnotation[TV_AdjustContrastv2_T], contrast_factor: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_AdjustContrastv2_T]:
...
def adjust_hue_eager_fallback(images: _atypes.TensorFuzzingAnnotation[TV_AdjustHue_T], delta: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_AdjustHue_T]:
  _attr_T, (images,) = _execute.args_to_matching_eager([images], ctx, [_dtypes.half, _dtypes.float32, ], _dtypes.float32)
...
def adjust_saturation_eager_fallback(images: _atypes.TensorFuzzingAnnotation[TV_AdjustSaturation_T], scale: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_AdjustSaturation_T]:
  _attr_T, (images,) = _execute.args_to_matching_eager([images], ctx, [_dtypes.half, _dtypes.float32, ], _dtypes.float32)
...
def decode_and_crop_jpeg(contents: _atypes.TensorFuzzingAnnotation[_atypes.String], crop_window: _atypes.TensorFuzzingAnnotation[_atypes.Int32], channels:int=0, ratio:int=1, fancy_upscaling:bool=True, try_recover_truncated:bool=False, acceptable_fraction:float=1, dct_method:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.UInt8]:
...
def decode_and_crop_jpeg_eager_fallback(contents: _atypes.TensorFuzzingAnnotation[_atypes.String], crop_window: _atypes.TensorFuzzingAnnotation[_atypes.Int32], channels: int, ratio: int, fancy_upscaling: bool, try_recover_truncated: bool, acceptable_fraction: float, dct_method: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.UInt8]:
  if channels is None:
    channels = 0
  channels = _execute.make_int(channels, "channels")
  if ratio is None:
...
def decode_bmp_eager_fallback(contents: _atypes.TensorFuzzingAnnotation[_atypes.String], channels: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.UInt8]:
  if channels is None:
    channels = 0
  channels = _execute.make_int(channels, "channels")
  contents = _ops.convert_to_tensor(contents, _dtypes.string)
...
def decode_gif(contents: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.UInt8]:
...
def decode_gif_eager_fallback(contents: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.UInt8]:
  contents = _ops.convert_to_tensor(contents, _dtypes.string)
  _inputs_flat = [contents]
  _attrs = None
...
def decode_image(contents: _atypes.TensorFuzzingAnnotation[_atypes.String], channels:int=0, dtype:TV_DecodeImage_dtype=_dtypes.uint8, expand_animations:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[TV_DecodeImage_dtype]:
...
def decode_image_eager_fallback(contents: _atypes.TensorFuzzingAnnotation[_atypes.String], channels: int, dtype: TV_DecodeImage_dtype, expand_animations: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_DecodeImage_dtype]:
  if channels is None:
    channels = 0
  channels = _execute.make_int(channels, "channels")
  if dtype is None:
...
def draw_bounding_boxes_v2(images: _atypes.TensorFuzzingAnnotation[TV_DrawBoundingBoxesV2_T], boxes: _atypes.TensorFuzzingAnnotation[_atypes.Float32], colors: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name=None) -> _atypes.TensorFuzzingAnnotation[TV_DrawBoundingBoxesV2_T]:
  r"""Draw bounding boxes on a batch of images.
...
def draw_bounding_boxes_v2_eager_fallback(images: _atypes.TensorFuzzingAnnotation[TV_DrawBoundingBoxesV2_T], boxes: _atypes.TensorFuzzingAnnotation[_atypes.Float32], colors: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_DrawBoundingBoxesV2_T]:
  _attr_T, (images,) = _execute.args_to_matching_eager([images], ctx, [_dtypes.float32, _dtypes.half, ], _dtypes.float32)
  boxes = _ops.convert_to_tensor(boxes, _dtypes.float32)
...
def encode_jpeg_variable_quality_eager_fallback(images: _atypes.TensorFuzzingAnnotation[_atypes.UInt8], quality: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def encode_png_eager_fallback(image: _atypes.TensorFuzzingAnnotation[TV_EncodePng_T], compression: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  if compression is None:
    compression = -1
  compression = _execute.make_int(compression, "compression")
...
def hsv_to_rgb_eager_fallback(images: _atypes.TensorFuzzingAnnotation[TV_HSVToRGB_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_HSVToRGB_T]:
...
TV_ImageProjectiveTransformV2_dtype = TypeVar("TV_ImageProjectiveTransformV2_dtype", _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int32, _atypes.Int64, _atypes.UInt8)

def image_projective_transform_v2(images: _atypes.TensorFuzzingAnnotation[TV_ImageProjectiveTransformV2_dtype], transforms: _atypes.TensorFuzzingAnnotation[_atypes.Float32], output_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int32], interpolation: str, fill_mode:str="CONSTANT", name=None) -> _atypes.TensorFuzzingAnnotation[TV_ImageProjectiveTransformV2_dtype]:
...
def image_projective_transform_v2_eager_fallback(images: _atypes.TensorFuzzingAnnotation[TV_ImageProjectiveTransformV2_dtype], transforms: _atypes.TensorFuzzingAnnotation[_atypes.Float32], output_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int32], interpolation: str, fill_mode: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ImageProjectiveTransformV2_dtype]:
  interpolation = _execute.make_str(interpolation, "interpolation")
  if fill_mode is None:
    fill_mode = "CONSTANT"
  fill_mode = _execute.make_str(fill_mode, "fill_mode")
...
TV_ImageProjectiveTransformV3_dtype = TypeVar("TV_ImageProjectiveTransformV3_dtype", _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int32, _atypes.Int64, _atypes.UInt8)
...
def non_max_suppression_v2(boxes: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV2_T], scores: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV2_T], max_output_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], iou_threshold: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV2_T_threshold], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  r"""Greedily selects a subset of bounding boxes in descending order of score,
...
def non_max_suppression_v2_eager_fallback(boxes: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV2_T], scores: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV2_T], max_output_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], iou_threshold: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV2_T_threshold], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def non_max_suppression_v3(boxes: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV3_T], scores: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV3_T], max_output_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], iou_threshold: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV3_T_threshold], score_threshold: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV3_T_threshold], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  r"""Greedily selects a subset of bounding boxes in descending order of score,
...
def non_max_suppression_v4(boxes: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV4_T], scores: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV4_T], max_output_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], iou_threshold: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV4_T_threshold], score_threshold: _atypes.TensorFuzzingAnnotation[TV_NonMaxSuppressionV4_T_threshold], pad_to_max_output_size:bool=False, name=None):
  r"""Greedily selects a subset of bounding boxes in descending order of score,
...
def quantized_resize_bilinear(images: _atypes.TensorFuzzingAnnotation[TV_QuantizedResizeBilinear_T], size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], min: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max: _atypes.TensorFuzzingAnnotation[_atypes.Float32], align_corners:bool=False, half_pixel_centers:bool=False, name=None):
...
def rgb_to_hsv_eager_fallback(images: _atypes.TensorFuzzingAnnotation[TV_RGBToHSV_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RGBToHSV_T]:
  _attr_T, (images,) = _execute.args_to_matching_eager([images], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, ], _dtypes.float32)
  _inputs_flat = [images]
  _attrs = ("T", _attr_T)
...
def random_crop_eager_fallback(image: _atypes.TensorFuzzingAnnotation[TV_RandomCrop_T], size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed: int, seed2: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RandomCrop_T]:
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
  if seed2 is None:
...
def resize_area_eager_fallback(images: _atypes.TensorFuzzingAnnotation[TV_ResizeArea_T], size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], align_corners: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  if align_corners is None:
    align_corners = False
  align_corners = _execute.make_bool(align_corners, "align_corners")
...
def resize_bicubic_eager_fallback(images: _atypes.TensorFuzzingAnnotation[TV_ResizeBicubic_T], size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], align_corners: bool, half_pixel_centers: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  if align_corners is None:
    align_corners = False
  align_corners = _execute.make_bool(align_corners, "align_corners")
  if half_pixel_centers is None:
...
def resize_bicubic_grad_eager_fallback(grads: _atypes.TensorFuzzingAnnotation[_atypes.Float32], original_image: _atypes.TensorFuzzingAnnotation[TV_ResizeBicubicGrad_T], align_corners: bool, half_pixel_centers: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ResizeBicubicGrad_T]:
  if align_corners is None:
    align_corners = False
  align_corners = _execute.make_bool(align_corners, "align_corners")
  if half_pixel_centers is None:
...
def resize_bilinear(images: _atypes.TensorFuzzingAnnotation[TV_ResizeBilinear_T], size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], align_corners:bool=False, half_pixel_centers:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
...
def resize_bilinear_grad(grads: _atypes.TensorFuzzingAnnotation[_atypes.Float32], original_image: _atypes.TensorFuzzingAnnotation[TV_ResizeBilinearGrad_T], align_corners:bool=False, half_pixel_centers:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ResizeBilinearGrad_T]:
...
def resize_nearest_neighbor(images: _atypes.TensorFuzzingAnnotation[TV_ResizeNearestNeighbor_T], size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], align_corners:bool=False, half_pixel_centers:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ResizeNearestNeighbor_T]:
...
def resize_nearest_neighbor_eager_fallback(images: _atypes.TensorFuzzingAnnotation[TV_ResizeNearestNeighbor_T], size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], align_corners: bool, half_pixel_centers: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ResizeNearestNeighbor_T]:
  if align_corners is None:
    align_corners = False
  align_corners = _execute.make_bool(align_corners, "align_corners")
  if half_pixel_centers is None:
...
def sample_distorted_bounding_box_v2(image_size: _atypes.TensorFuzzingAnnotation[TV_SampleDistortedBoundingBoxV2_T], bounding_boxes: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_object_covered: _atypes.TensorFuzzingAnnotation[_atypes.Float32], seed:int=0, seed2:int=0, aspect_ratio_range=[0.75, 1.33], area_range=[0.05, 1], max_attempts:int=100, use_image_if_no_bounding_boxes:bool=False, name=None):
  r"""Generate a single randomly distorted bounding box for an image.
...
def sample_distorted_bounding_box_v2_eager_fallback(image_size: _atypes.TensorFuzzingAnnotation[TV_SampleDistortedBoundingBoxV2_T], bounding_boxes: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_object_covered: _atypes.TensorFuzzingAnnotation[_atypes.Float32], seed: int, seed2: int, aspect_ratio_range, area_range, max_attempts: int, use_image_if_no_bounding_boxes: bool, name, ctx):
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
  if seed2 is None:
