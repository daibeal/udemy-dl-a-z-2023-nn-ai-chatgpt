...
TV_Assign_T = TypeVar("TV_Assign_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def assign(ref: _atypes.TensorFuzzingAnnotation[TV_Assign_T], value: _atypes.TensorFuzzingAnnotation[TV_Assign_T], validate_shape:bool=True, use_locking:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Assign_T]:
...
def assign_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_Assign_T], value: _atypes.TensorFuzzingAnnotation[TV_Assign_T], validate_shape: bool, use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Assign_T]:
  raise RuntimeError("assign op does not support eager execution. Arg 'output_ref' is a ref.")
...
def assign_add(ref: _atypes.TensorFuzzingAnnotation[TV_AssignAdd_T], value: _atypes.TensorFuzzingAnnotation[TV_AssignAdd_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_AssignAdd_T]:
...
def assign_add_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_AssignAdd_T], value: _atypes.TensorFuzzingAnnotation[TV_AssignAdd_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_AssignAdd_T]:
  raise RuntimeError("assign_add op does not support eager execution. Arg 'output_ref' is a ref.")
...
def assign_sub(ref: _atypes.TensorFuzzingAnnotation[TV_AssignSub_T], value: _atypes.TensorFuzzingAnnotation[TV_AssignSub_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_AssignSub_T]:
...
def assign_sub_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_AssignSub_T], value: _atypes.TensorFuzzingAnnotation[TV_AssignSub_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_AssignSub_T]:
  raise RuntimeError("assign_sub op does not support eager execution. Arg 'output_ref' is a ref.")

TV_CountUpTo_T = TypeVar("TV_CountUpTo_T", _atypes.Int32, _atypes.Int64)

def count_up_to(ref: _atypes.TensorFuzzingAnnotation[TV_CountUpTo_T], limit: int, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CountUpTo_T]:
...
def count_up_to_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_CountUpTo_T], limit: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CountUpTo_T]:
  raise RuntimeError("count_up_to op does not support eager execution. Arg 'ref' is a ref.")
...
def destroy_temporary_variable_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_DestroyTemporaryVariable_T], var_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_DestroyTemporaryVariable_T]:
  raise RuntimeError("destroy_temporary_variable op does not support eager execution. Arg 'ref' is a ref.")

TV_IsVariableInitialized_dtype = TypeVar("TV_IsVariableInitialized_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def is_variable_initialized(ref: _atypes.TensorFuzzingAnnotation[TV_IsVariableInitialized_dtype], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def is_variable_initialized_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_IsVariableInitialized_dtype], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  raise RuntimeError("is_variable_initialized op does not support eager execution. Arg 'ref' is a ref.")
...
def resource_count_up_to_eager_fallback(resource: _atypes.TensorFuzzingAnnotation[_atypes.Resource], limit: int, T: TV_ResourceCountUpTo_T, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ResourceCountUpTo_T]:
  limit = _execute.make_int(limit, "limit")
  T = _execute.make_type(T, "T")
...
def resource_scatter_nd_add(ref: _atypes.TensorFuzzingAnnotation[_atypes.Resource], indices: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdAdd_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdAdd_T], use_locking:bool=True, name=None):
...
def resource_scatter_nd_add_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[_atypes.Resource], indices: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdAdd_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdAdd_T], use_locking: bool, name, ctx):
  if use_locking is None:
    use_locking = True
  use_locking = _execute.make_bool(use_locking, "use_locking")
...
TV_ResourceScatterNdMax_T = TypeVar("TV_ResourceScatterNdMax_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
TV_ResourceScatterNdMax_Tindices = TypeVar("TV_ResourceScatterNdMax_Tindices", _atypes.Int32, _atypes.Int64)

def resource_scatter_nd_max(ref: _atypes.TensorFuzzingAnnotation[_atypes.Resource], indices: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdMax_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdMax_T], use_locking:bool=True, name=None):
  r"""TODO: add doc.
...
TV_ResourceScatterNdMin_T = TypeVar("TV_ResourceScatterNdMin_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def resource_scatter_nd_min_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[_atypes.Resource], indices: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdMin_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdMin_T], use_locking: bool, name, ctx):
  if use_locking is None:
    use_locking = True
  use_locking = _execute.make_bool(use_locking, "use_locking")
  _attr_T, (updates,) = _execute.args_to_matching_eager([updates], ctx, [])
...
TV_ResourceScatterNdSub_T = TypeVar("TV_ResourceScatterNdSub_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
TV_ResourceScatterNdSub_Tindices = TypeVar("TV_ResourceScatterNdSub_Tindices", _atypes.Int32, _atypes.Int64)

def resource_scatter_nd_sub(ref: _atypes.TensorFuzzingAnnotation[_atypes.Resource], indices: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdSub_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdSub_T], use_locking:bool=True, name=None):
...
def resource_scatter_nd_sub_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[_atypes.Resource], indices: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdSub_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdSub_T], use_locking: bool, name, ctx):
  if use_locking is None:
    use_locking = True
  use_locking = _execute.make_bool(use_locking, "use_locking")
  _attr_T, (updates,) = _execute.args_to_matching_eager([updates], ctx, [])
...
TV_ResourceScatterNdUpdate_T = TypeVar("TV_ResourceScatterNdUpdate_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def resource_scatter_nd_update_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[_atypes.Resource], indices: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdUpdate_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ResourceScatterNdUpdate_T], use_locking: bool, name, ctx):
  if use_locking is None:
    use_locking = True
  use_locking = _execute.make_bool(use_locking, "use_locking")
  _attr_T, (updates,) = _execute.args_to_matching_eager([updates], ctx, [])
...
def scatter_add(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterAdd_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterAdd_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterAdd_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterAdd_T]:
...
def scatter_add_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterAdd_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterAdd_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterAdd_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterAdd_T]:
  raise RuntimeError("scatter_add op does not support eager execution. Arg 'output_ref' is a ref.")
...
def scatter_div(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterDiv_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterDiv_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterDiv_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterDiv_T]:
...
def scatter_div_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterDiv_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterDiv_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterDiv_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterDiv_T]:
  raise RuntimeError("scatter_div op does not support eager execution. Arg 'output_ref' is a ref.")
...
def scatter_max(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterMax_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterMax_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterMax_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterMax_T]:
...
def scatter_max_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterMax_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterMax_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterMax_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterMax_T]:
  raise RuntimeError("scatter_max op does not support eager execution. Arg 'output_ref' is a ref.")
...
def scatter_min(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterMin_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterMin_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterMin_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterMin_T]:
...
def scatter_min_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterMin_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterMin_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterMin_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterMin_T]:
  raise RuntimeError("scatter_min op does not support eager execution. Arg 'output_ref' is a ref.")
...
def scatter_mul(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterMul_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterMul_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterMul_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterMul_T]:
...
def scatter_mul_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterMul_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterMul_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterMul_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterMul_T]:
  raise RuntimeError("scatter_mul op does not support eager execution. Arg 'output_ref' is a ref.")
...
def scatter_nd_add(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterNdAdd_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterNdAdd_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterNdAdd_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterNdAdd_T]:
  r"""Applies sparse addition to individual values or slices in a Variable.
...
def scatter_nd_add_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterNdAdd_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterNdAdd_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterNdAdd_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterNdAdd_T]:
  raise RuntimeError("scatter_nd_add op does not support eager execution. Arg 'output_ref' is a ref.")
...
def scatter_nd_max(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMax_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMax_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMax_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterNdMax_T]:
...
def scatter_nd_max_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMax_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMax_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMax_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterNdMax_T]:
  raise RuntimeError("scatter_nd_max op does not support eager execution. Arg 'output_ref' is a ref.")
...
def scatter_nd_min(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMin_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMin_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMin_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterNdMin_T]:
...
def scatter_nd_min_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMin_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMin_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterNdMin_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterNdMin_T]:
  raise RuntimeError("scatter_nd_min op does not support eager execution. Arg 'output_ref' is a ref.")
...
def scatter_nd_sub(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterNdSub_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterNdSub_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterNdSub_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterNdSub_T]:
  r"""Applies sparse subtraction to individual values or slices in a Variable.
...
def scatter_nd_sub_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterNdSub_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterNdSub_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterNdSub_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterNdSub_T]:
  raise RuntimeError("scatter_nd_sub op does not support eager execution. Arg 'output_ref' is a ref.")

TV_ScatterNdUpdate_T = TypeVar("TV_ScatterNdUpdate_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
TV_ScatterNdUpdate_Tindices = TypeVar("TV_ScatterNdUpdate_Tindices", _atypes.Int32, _atypes.Int64)

def scatter_nd_update(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterNdUpdate_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterNdUpdate_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterNdUpdate_T], use_locking:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterNdUpdate_T]:
  r"""Applies sparse `updates` to individual values or slices within a given
...
def scatter_nd_update_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterNdUpdate_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterNdUpdate_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterNdUpdate_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterNdUpdate_T]:
  raise RuntimeError("scatter_nd_update op does not support eager execution. Arg 'output_ref' is a ref.")
...
def scatter_sub(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterSub_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterSub_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterSub_T], use_locking:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterSub_T]:
...
def scatter_sub_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterSub_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterSub_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterSub_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterSub_T]:
  raise RuntimeError("scatter_sub op does not support eager execution. Arg 'output_ref' is a ref.")

TV_ScatterUpdate_T = TypeVar("TV_ScatterUpdate_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
TV_ScatterUpdate_Tindices = TypeVar("TV_ScatterUpdate_Tindices", _atypes.Int32, _atypes.Int64)

def scatter_update(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterUpdate_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterUpdate_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterUpdate_T], use_locking:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ScatterUpdate_T]:
...
def scatter_update_eager_fallback(ref: _atypes.TensorFuzzingAnnotation[TV_ScatterUpdate_T], indices: _atypes.TensorFuzzingAnnotation[TV_ScatterUpdate_Tindices], updates: _atypes.TensorFuzzingAnnotation[TV_ScatterUpdate_T], use_locking: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ScatterUpdate_T]:
  raise RuntimeError("scatter_update op does not support eager execution. Arg 'output_ref' is a ref.")
...
def temporary_variable_eager_fallback(shape, dtype: TV_TemporaryVariable_dtype, var_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TemporaryVariable_dtype]:
  raise RuntimeError("temporary_variable op does not support eager execution. Arg 'ref' is a ref.")

TV_Variable_dtype = TypeVar("TV_Variable_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def variable(shape, dtype: TV_Variable_dtype, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[TV_Variable_dtype]:
...
def variable_eager_fallback(shape, dtype: TV_Variable_dtype, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Variable_dtype]:
  raise RuntimeError("variable op does not support eager execution. Arg 'ref' is a ref.")

TV_VariableV2_dtype = TypeVar("TV_VariableV2_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def variable_v2_eager_fallback(shape, dtype: TV_VariableV2_dtype, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_VariableV2_dtype]:
  raise RuntimeError("variable_v2 op does not support eager execution. Arg 'ref' is a ref.")
