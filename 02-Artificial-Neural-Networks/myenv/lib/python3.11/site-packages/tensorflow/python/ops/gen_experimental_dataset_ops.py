...
def assert_cardinality_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], cardinality: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def assert_cardinality_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], cardinality: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'assert_cardinality_dataset' Op, not %r." % output_types)
...
def assert_next_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], transformations: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def assert_next_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], transformations: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'assert_next_dataset' Op, not %r." % output_types)
...
def assert_prev_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], transformations: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def assert_prev_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], transformations: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'assert_prev_dataset' Op, not %r." % output_types)
...
def auto_shard_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_workers: _atypes.TensorFuzzingAnnotation[_atypes.Int64], index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, auto_shard_policy:int=0, num_replicas:int=0, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def auto_shard_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_workers: _atypes.TensorFuzzingAnnotation[_atypes.Int64], index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, auto_shard_policy: int, num_replicas: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'auto_shard_dataset' Op, not %r." % output_types)
...
def bytes_produced_stats_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def bytes_produced_stats_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'bytes_produced_stats_dataset' Op, not %r." % output_types)
...
def csv_dataset_v2(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], compression_type: _atypes.TensorFuzzingAnnotation[_atypes.String], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], header: _atypes.TensorFuzzingAnnotation[_atypes.Bool], field_delim: _atypes.TensorFuzzingAnnotation[_atypes.String], use_quote_delim: _atypes.TensorFuzzingAnnotation[_atypes.Bool], na_value: _atypes.TensorFuzzingAnnotation[_atypes.String], select_cols: _atypes.TensorFuzzingAnnotation[_atypes.Int64], record_defaults, exclude_cols: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def csv_dataset_v2_eager_fallback(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], compression_type: _atypes.TensorFuzzingAnnotation[_atypes.String], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], header: _atypes.TensorFuzzingAnnotation[_atypes.Bool], field_delim: _atypes.TensorFuzzingAnnotation[_atypes.String], use_quote_delim: _atypes.TensorFuzzingAnnotation[_atypes.Bool], na_value: _atypes.TensorFuzzingAnnotation[_atypes.String], select_cols: _atypes.TensorFuzzingAnnotation[_atypes.Int64], record_defaults, exclude_cols: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_shapes, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_shapes' argument to "
        "'csv_dataset_v2' Op, not %r." % output_shapes)
...
def choose_fastest_branch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], ratio_numerator: _atypes.TensorFuzzingAnnotation[_atypes.Int64], ratio_denominator: _atypes.TensorFuzzingAnnotation[_atypes.Int64], other_arguments, num_elements_per_branch: int, branches, other_arguments_lengths, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def choose_fastest_dataset(input_datasets: List[_atypes.TensorFuzzingAnnotation[_atypes.Variant]], num_experiments: int, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def choose_fastest_dataset_eager_fallback(input_datasets: List[_atypes.TensorFuzzingAnnotation[_atypes.Variant]], num_experiments: int, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(input_datasets, (list, tuple)):
    raise TypeError(
        "Expected list for 'input_datasets' argument to "
        "'choose_fastest_dataset' Op, not %r." % input_datasets)
...
def compress_element(components, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def compute_batch_size(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
...
def compute_batch_size_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
  input_dataset = _ops.convert_to_tensor(input_dataset, _dtypes.variant)
...
def data_service_dataset_v3(dataset_id: _atypes.TensorFuzzingAnnotation[_atypes.Int64], processing_mode: _atypes.TensorFuzzingAnnotation[_atypes.String], address: _atypes.TensorFuzzingAnnotation[_atypes.String], protocol: _atypes.TensorFuzzingAnnotation[_atypes.String], job_name: _atypes.TensorFuzzingAnnotation[_atypes.String], consumer_index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_consumers: _atypes.TensorFuzzingAnnotation[_atypes.Int64], max_outstanding_requests: _atypes.TensorFuzzingAnnotation[_atypes.Int64], iteration_counter: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, uncompress_fn, task_refresh_interval_hint_ms:int=-1, data_transfer_protocol:str="", target_workers:str="AUTO", uncompress:bool=False, cross_trainer_cache_options:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that reads data from the tf.data service.
...
def data_service_dataset_v3_eager_fallback(dataset_id: _atypes.TensorFuzzingAnnotation[_atypes.Int64], processing_mode: _atypes.TensorFuzzingAnnotation[_atypes.String], address: _atypes.TensorFuzzingAnnotation[_atypes.String], protocol: _atypes.TensorFuzzingAnnotation[_atypes.String], job_name: _atypes.TensorFuzzingAnnotation[_atypes.String], consumer_index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_consumers: _atypes.TensorFuzzingAnnotation[_atypes.Int64], max_outstanding_requests: _atypes.TensorFuzzingAnnotation[_atypes.Int64], iteration_counter: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, uncompress_fn, task_refresh_interval_hint_ms: int, data_transfer_protocol: str, target_workers: str, uncompress: bool, cross_trainer_cache_options: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'data_service_dataset_v3' Op, not %r." % output_types)
...
def data_service_dataset_v4(dataset_id: _atypes.TensorFuzzingAnnotation[_atypes.String], processing_mode: _atypes.TensorFuzzingAnnotation[_atypes.String], address: _atypes.TensorFuzzingAnnotation[_atypes.String], protocol: _atypes.TensorFuzzingAnnotation[_atypes.String], job_name: _atypes.TensorFuzzingAnnotation[_atypes.String], consumer_index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_consumers: _atypes.TensorFuzzingAnnotation[_atypes.Int64], max_outstanding_requests: _atypes.TensorFuzzingAnnotation[_atypes.Int64], iteration_counter: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, uncompress_fn, task_refresh_interval_hint_ms:int=-1, data_transfer_protocol:str="", target_workers:str="AUTO", uncompress:bool=False, cross_trainer_cache_options:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that reads data from the tf.data service.
...
def data_service_dataset_v4_eager_fallback(dataset_id: _atypes.TensorFuzzingAnnotation[_atypes.String], processing_mode: _atypes.TensorFuzzingAnnotation[_atypes.String], address: _atypes.TensorFuzzingAnnotation[_atypes.String], protocol: _atypes.TensorFuzzingAnnotation[_atypes.String], job_name: _atypes.TensorFuzzingAnnotation[_atypes.String], consumer_index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_consumers: _atypes.TensorFuzzingAnnotation[_atypes.Int64], max_outstanding_requests: _atypes.TensorFuzzingAnnotation[_atypes.Int64], iteration_counter: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, uncompress_fn, task_refresh_interval_hint_ms: int, data_transfer_protocol: str, target_workers: str, uncompress: bool, cross_trainer_cache_options: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'data_service_dataset_v4' Op, not %r." % output_types)
...
def dataset_from_graph_eager_fallback(graph_def: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def dense_to_sparse_batch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], row_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def dense_to_sparse_batch_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], row_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'dense_to_sparse_batch_dataset' Op, not %r." % output_types)
...
def directed_interleave_dataset(selector_input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], data_input_datasets: List[_atypes.TensorFuzzingAnnotation[_atypes.Variant]], output_types, output_shapes, stop_on_empty_dataset:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def distributed_save(dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], directory: _atypes.TensorFuzzingAnnotation[_atypes.String], address: _atypes.TensorFuzzingAnnotation[_atypes.String], metadata:str="", name=None):
  r"""TODO: add doc.
...
def dummy_iteration_counter(name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""TODO: add doc.
...
def dummy_iteration_counter_eager_fallback(name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  _inputs_flat = []
  _attrs = None
...
def experimental_assert_next_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], transformations: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def experimental_assert_next_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], transformations: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_assert_next_dataset' Op, not %r." % output_types)
...
def experimental_auto_shard_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_workers: _atypes.TensorFuzzingAnnotation[_atypes.Int64], index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, auto_shard_policy:int=0, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that shards the input dataset.
...
def experimental_bytes_produced_stats_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Records the bytes size of each element of `input_dataset` in a StatsAggregator.
...
def experimental_bytes_produced_stats_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_bytes_produced_stats_dataset' Op, not %r." % output_types)
...
def experimental_csv_dataset_eager_fallback(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], compression_type: _atypes.TensorFuzzingAnnotation[_atypes.String], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], header: _atypes.TensorFuzzingAnnotation[_atypes.Bool], field_delim: _atypes.TensorFuzzingAnnotation[_atypes.String], use_quote_delim: _atypes.TensorFuzzingAnnotation[_atypes.Bool], na_value: _atypes.TensorFuzzingAnnotation[_atypes.String], select_cols: _atypes.TensorFuzzingAnnotation[_atypes.Int64], record_defaults, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_shapes, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_shapes' argument to "
        "'experimental_csv_dataset' Op, not %r." % output_shapes)
...
def experimental_choose_fastest_dataset(input_datasets: List[_atypes.TensorFuzzingAnnotation[_atypes.Variant]], num_experiments: int, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def experimental_choose_fastest_dataset_eager_fallback(input_datasets: List[_atypes.TensorFuzzingAnnotation[_atypes.Variant]], num_experiments: int, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(input_datasets, (list, tuple)):
    raise TypeError(
        "Expected list for 'input_datasets' argument to "
        "'experimental_choose_fastest_dataset' Op, not %r." % input_datasets)
...
def experimental_dataset_cardinality(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
...
def experimental_dataset_cardinality_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
  input_dataset = _ops.convert_to_tensor(input_dataset, _dtypes.variant)
  _inputs_flat = [input_dataset]
  _attrs = None
...
def experimental_dataset_to_tf_record(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], filename: _atypes.TensorFuzzingAnnotation[_atypes.String], compression_type: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None):
  r"""Writes the given dataset to the given file using the TFRecord format.
...
def experimental_dataset_to_tf_record_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], filename: _atypes.TensorFuzzingAnnotation[_atypes.String], compression_type: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  input_dataset = _ops.convert_to_tensor(input_dataset, _dtypes.variant)
  filename = _ops.convert_to_tensor(filename, _dtypes.string)
  compression_type = _ops.convert_to_tensor(compression_type, _dtypes.string)
  _inputs_flat = [input_dataset, filename, compression_type]
...
def experimental_dense_to_sparse_batch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], row_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that batches input elements into a SparseTensor.
...
def experimental_directed_interleave_dataset_eager_fallback(selector_input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], data_input_datasets: List[_atypes.TensorFuzzingAnnotation[_atypes.Variant]], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(data_input_datasets, (list, tuple)):
    raise TypeError(
        "Expected list for 'data_input_datasets' argument to "
        "'experimental_directed_interleave_dataset' Op, not %r." % data_input_datasets)
...
def experimental_group_by_reducer_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key_func_other_arguments, init_func_other_arguments, reduce_func_other_arguments, finalize_func_other_arguments, key_func, init_func, reduce_func, finalize_func, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_group_by_reducer_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key_func_other_arguments, init_func_other_arguments, reduce_func_other_arguments, finalize_func_other_arguments, key_func, init_func, reduce_func, finalize_func, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_group_by_reducer_dataset' Op, not %r." % output_types)
...
def experimental_group_by_window_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key_func_other_arguments, reduce_func_other_arguments, window_size_func_other_arguments, key_func, reduce_func, window_size_func, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_group_by_window_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key_func_other_arguments, reduce_func_other_arguments, window_size_func_other_arguments, key_func, reduce_func, window_size_func, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_group_by_window_dataset' Op, not %r." % output_types)
...
def experimental_ignore_errors_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, log_warning:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_ignore_errors_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, log_warning: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_ignore_errors_dataset' Op, not %r." % output_types)
...
def experimental_iterator_get_device(resource: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def experimental_iterator_get_device_eager_fallback(resource: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def experimental_lmdb_dataset(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def experimental_lmdb_dataset_eager_fallback(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_lmdb_dataset' Op, not %r." % output_types)
...
def experimental_latency_stats_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_latency_stats_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_latency_stats_dataset' Op, not %r." % output_types)
...
def experimental_map_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, f, output_types, output_shapes, use_inter_op_parallelism:bool=True, preserve_cardinality:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_map_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, f, output_types, output_shapes, use_inter_op_parallelism: bool, preserve_cardinality: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_map_dataset' Op, not %r." % output_types)
...
def experimental_matching_files_dataset(patterns: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def experimental_matching_files_dataset_eager_fallback(patterns: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_max_intra_op_parallelism_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], max_intra_op_parallelism: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_max_intra_op_parallelism_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], max_intra_op_parallelism: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_max_intra_op_parallelism_dataset' Op, not %r." % output_types)
...
def experimental_non_serializable_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def experimental_non_serializable_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_non_serializable_dataset' Op, not %r." % output_types)
...
def experimental_parallel_interleave_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, cycle_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], block_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sloppy: _atypes.TensorFuzzingAnnotation[_atypes.Bool], buffer_output_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int64], prefetch_input_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that applies `f` to the outputs of `input_dataset`.
...
def experimental_parallel_interleave_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, cycle_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], block_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sloppy: _atypes.TensorFuzzingAnnotation[_atypes.Bool], buffer_output_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int64], prefetch_input_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_parallel_interleave_dataset' Op, not %r." % output_types)
...
def experimental_parse_example_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], dense_defaults, sparse_keys, dense_keys, sparse_types, dense_shapes, output_types, output_shapes, sloppy: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(sparse_keys, (list, tuple)):
    raise TypeError(
        "Expected list for 'sparse_keys' argument to "
        "'experimental_parse_example_dataset' Op, not %r." % sparse_keys)
...
def experimental_private_thread_pool_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_threads: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_private_thread_pool_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_threads: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_private_thread_pool_dataset' Op, not %r." % output_types)
...
def experimental_random_dataset(seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_random_dataset_eager_fallback(seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_random_dataset' Op, not %r." % output_types)
...
def experimental_rebatch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_replicas: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, use_fallback:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_rebatch_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_replicas: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, use_fallback: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_rebatch_dataset' Op, not %r." % output_types)
...
def experimental_scan_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], initial_state, other_arguments, f, output_types, output_shapes, preserve_cardinality:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_scan_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], initial_state, other_arguments, f, output_types, output_shapes, preserve_cardinality: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_scan_dataset' Op, not %r." % output_types)
...
def experimental_set_stats_aggregator_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], stats_aggregator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], counter_prefix: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def experimental_set_stats_aggregator_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], stats_aggregator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], counter_prefix: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_set_stats_aggregator_dataset' Op, not %r." % output_types)
...
def experimental_sleep_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], sleep_microseconds: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def experimental_sleep_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], sleep_microseconds: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_sleep_dataset' Op, not %r." % output_types)
...
def experimental_sliding_window_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], window_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], window_shift: _atypes.TensorFuzzingAnnotation[_atypes.Int64], window_stride: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_sliding_window_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], window_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], window_shift: _atypes.TensorFuzzingAnnotation[_atypes.Int64], window_stride: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_sliding_window_dataset' Op, not %r." % output_types)
...
def experimental_sql_dataset(driver_name: _atypes.TensorFuzzingAnnotation[_atypes.String], data_source_name: _atypes.TensorFuzzingAnnotation[_atypes.String], query: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_stats_aggregator_handle(container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
...
def experimental_stats_aggregator_handle_eager_fallback(container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if container is None:
    container = ""
  container = _execute.make_str(container, "container")
  if shared_name is None:
...
def experimental_stats_aggregator_summary(iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def experimental_stats_aggregator_summary_eager_fallback(iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def experimental_take_while_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, predicate, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_take_while_dataset' Op, not %r." % output_types)
...
def experimental_thread_pool_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], thread_pool: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that uses a custom thread pool to compute `input_dataset`.
...
def experimental_thread_pool_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], thread_pool: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_thread_pool_dataset' Op, not %r." % output_types)
...
def experimental_unbatch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_unbatch_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_unbatch_dataset' Op, not %r." % output_types)
...
def experimental_unique_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def experimental_unique_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'experimental_unique_dataset' Op, not %r." % output_types)
...
def get_element_at_index(dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None):
...
def group_by_reducer_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key_func_other_arguments, init_func_other_arguments, reduce_func_other_arguments, finalize_func_other_arguments, key_func, init_func, reduce_func, finalize_func, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that computes a group-by on `input_dataset`.
...
def group_by_reducer_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key_func_other_arguments, init_func_other_arguments, reduce_func_other_arguments, finalize_func_other_arguments, key_func, init_func, reduce_func, finalize_func, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'group_by_reducer_dataset' Op, not %r." % output_types)
...
def ignore_errors_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, log_warning:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that contains the elements of `input_dataset` ignoring errors.
...
def ignore_errors_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, log_warning: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'ignore_errors_dataset' Op, not %r." % output_types)
...
def iterator_get_device_eager_fallback(resource: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  resource = _ops.convert_to_tensor(resource, _dtypes.resource)
  _inputs_flat = [resource]
  _attrs = None
...
def lmdb_dataset(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def lmdb_dataset_eager_fallback(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'lmdb_dataset' Op, not %r." % output_types)
...
def latency_stats_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Records the latency of producing `input_dataset` elements in a StatsAggregator.
...
def latency_stats_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'latency_stats_dataset' Op, not %r." % output_types)
...
def legacy_parallel_interleave_dataset_v2_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, cycle_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], block_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], buffer_output_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int64], prefetch_input_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, deterministic: str, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'legacy_parallel_interleave_dataset_v2' Op, not %r." % output_types)
...
def list_dataset(tensors, output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def list_dataset_eager_fallback(tensors, output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'list_dataset' Op, not %r." % output_types)
...
def map_and_batch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], drop_remainder: _atypes.TensorFuzzingAnnotation[_atypes.Bool], f, output_types, output_shapes, preserve_cardinality:bool=False, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that fuses mapping with batching.
...
def map_and_batch_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], drop_remainder: _atypes.TensorFuzzingAnnotation[_atypes.Bool], f, output_types, output_shapes, preserve_cardinality: bool, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'map_and_batch_dataset' Op, not %r." % output_types)
...
def matching_files_dataset_eager_fallback(patterns: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  patterns = _ops.convert_to_tensor(patterns, _dtypes.string)
  _inputs_flat = [patterns]
  _attrs = None
...
def max_intra_op_parallelism_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], max_intra_op_parallelism: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that overrides the maximum intra-op parallelism.
...
def max_intra_op_parallelism_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], max_intra_op_parallelism: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'max_intra_op_parallelism_dataset' Op, not %r." % output_types)
...
def non_serializable_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def non_serializable_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'non_serializable_dataset' Op, not %r." % output_types)
...
def parallel_interleave_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, cycle_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], block_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sloppy: _atypes.TensorFuzzingAnnotation[_atypes.Bool], buffer_output_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int64], prefetch_input_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'parallel_interleave_dataset' Op, not %r." % output_types)
...
def parse_example_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], dense_defaults, sparse_keys, dense_keys, sparse_types, dense_shapes, output_types, output_shapes, sloppy: bool, ragged_keys, ragged_value_types, ragged_split_types, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(sparse_keys, (list, tuple)):
    raise TypeError(
        "Expected list for 'sparse_keys' argument to "
        "'parse_example_dataset' Op, not %r." % sparse_keys)
...
def private_thread_pool_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_threads: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that uses a custom thread pool to compute `input_dataset`.
...
def private_thread_pool_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_threads: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'private_thread_pool_dataset' Op, not %r." % output_types)
...
def random_dataset_eager_fallback(seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'random_dataset' Op, not %r." % output_types)
...
def random_dataset_v2(seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed_generator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, rerandomize_each_iteration:bool=False, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a Dataset that returns pseudorandom numbers.
...
def rebatch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_replicas: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, use_fallback:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that changes the batch size.
...
def rebatch_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_replicas: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, use_fallback: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'rebatch_dataset' Op, not %r." % output_types)
...
def rebatch_dataset_v2(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], drop_remainder: _atypes.TensorFuzzingAnnotation[_atypes.Bool], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that changes the batch size.
...
def rebatch_dataset_v2_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], drop_remainder: _atypes.TensorFuzzingAnnotation[_atypes.Bool], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'rebatch_dataset_v2' Op, not %r." % output_types)
...
def register_dataset(dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], address: _atypes.TensorFuzzingAnnotation[_atypes.String], protocol: _atypes.TensorFuzzingAnnotation[_atypes.String], external_state_policy: int, element_spec:str="", metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
...
def sampling_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], rate: _atypes.TensorFuzzingAnnotation[_atypes.Float32], seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def sampling_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], rate: _atypes.TensorFuzzingAnnotation[_atypes.Float32], seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'sampling_dataset' Op, not %r." % output_types)
...
def scan_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], initial_state, other_arguments, f, output_types, output_shapes, preserve_cardinality: bool, use_default_device: bool, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'scan_dataset' Op, not %r." % output_types)
...
def set_stats_aggregator_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], stats_aggregator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], counter_prefix: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def sleep_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], sleep_microseconds: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def sleep_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], sleep_microseconds: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'sleep_dataset' Op, not %r." % output_types)
...
def snapshot_dataset_reader(shard_dir: _atypes.TensorFuzzingAnnotation[_atypes.String], start_index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, version: int, compression:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def snapshot_dataset_reader_eager_fallback(shard_dir: _atypes.TensorFuzzingAnnotation[_atypes.String], start_index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, version: int, compression: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'snapshot_dataset_reader' Op, not %r." % output_types)
...
def snapshot_nested_dataset_reader(inputs: List[_atypes.TensorFuzzingAnnotation[_atypes.Variant]], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def snapshot_nested_dataset_reader_eager_fallback(inputs: List[_atypes.TensorFuzzingAnnotation[_atypes.Variant]], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(inputs, (list, tuple)):
    raise TypeError(
        "Expected list for 'inputs' argument to "
        "'snapshot_nested_dataset_reader' Op, not %r." % inputs)
...
def sql_dataset(driver_name: _atypes.TensorFuzzingAnnotation[_atypes.String], data_source_name: _atypes.TensorFuzzingAnnotation[_atypes.String], query: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that executes a SQL query and emits rows of the result set.
...
def sql_dataset_eager_fallback(driver_name: _atypes.TensorFuzzingAnnotation[_atypes.String], data_source_name: _atypes.TensorFuzzingAnnotation[_atypes.String], query: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'sql_dataset' Op, not %r." % output_types)
...
def stats_aggregator_handle(container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""Creates a statistics manager resource.
...
def stats_aggregator_handle_eager_fallback(container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if container is None:
    container = ""
  container = _execute.make_str(container, "container")
  if shared_name is None:
...
def stats_aggregator_handle_v2(container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""TODO: add doc.
...
def stats_aggregator_handle_v2_eager_fallback(container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if container is None:
    container = ""
  container = _execute.make_str(container, "container")
  if shared_name is None:
...
def stats_aggregator_set_summary_writer(stats_aggregator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], summary: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None):
...
def stats_aggregator_summary(iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  r"""Produces a summary of any statistics recorded by the given statistics manager.
...
def stats_aggregator_summary_eager_fallback(iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  iterator = _ops.convert_to_tensor(iterator, _dtypes.resource)
  _inputs_flat = [iterator]
  _attrs = None
...
def take_while_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, predicate, output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that stops iteration when predicate` is false.
...
def take_while_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, predicate, output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'take_while_dataset' Op, not %r." % output_types)
...
def thread_pool_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], thread_pool: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that uses a custom thread pool to compute `input_dataset`.
...
def thread_pool_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], thread_pool: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'thread_pool_dataset' Op, not %r." % output_types)
...
def thread_pool_handle(num_threads: int, display_name: str, max_intra_op_parallelism:int=1, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""Creates a dataset that uses a custom thread pool to compute `input_dataset`.
...
def thread_pool_handle_eager_fallback(num_threads: int, display_name: str, max_intra_op_parallelism: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  num_threads = _execute.make_int(num_threads, "num_threads")
  display_name = _execute.make_str(display_name, "display_name")
  if max_intra_op_parallelism is None:
    max_intra_op_parallelism = 1
...
def unbatch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""A dataset that splits the elements of its input into multiple elements.
...
def unbatch_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'unbatch_dataset' Op, not %r." % output_types)
...
def uncompress_element(compressed: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name=None):
...
def uncompress_element_eager_fallback(compressed: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name, ctx):
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'uncompress_element' Op, not %r." % output_types)
...
def unique_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that contains the unique elements of `input_dataset`.
...
def unique_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'unique_dataset' Op, not %r." % output_types)
