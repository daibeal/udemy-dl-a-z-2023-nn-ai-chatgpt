...
def recv(tensor_type: TV_Recv_tensor_type, tensor_name: str, send_device: str, send_device_incarnation: int, recv_device: str, client_terminated:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Recv_tensor_type]:
...
def send(tensor: _atypes.TensorFuzzingAnnotation[TV_Send_T], tensor_name: str, send_device: str, send_device_incarnation: int, recv_device: str, client_terminated:bool=False, name=None):
