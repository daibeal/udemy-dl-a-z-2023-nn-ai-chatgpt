...
def all_candidate_sampler(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, num_sampled: int, unique: bool, seed:int=0, seed2:int=0, name=None):
...
def all_candidate_sampler_eager_fallback(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, num_sampled: int, unique: bool, seed: int, seed2: int, name, ctx):
  num_true = _execute.make_int(num_true, "num_true")
  num_sampled = _execute.make_int(num_sampled, "num_sampled")
  unique = _execute.make_bool(unique, "unique")
  if seed is None:
...
def compute_accidental_hits(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sampled_candidates: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, seed:int=0, seed2:int=0, name=None):
...
def fixed_unigram_candidate_sampler(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, num_sampled: int, unique: bool, range_max: int, vocab_file:str="", distortion:float=1, num_reserved_ids:int=0, num_shards:int=1, shard:int=0, unigrams=[], seed:int=0, seed2:int=0, name=None):
  r"""Generates labels for candidate sampling with a learned unigram distribution.
...
def learned_unigram_candidate_sampler(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, num_sampled: int, unique: bool, range_max: int, seed:int=0, seed2:int=0, name=None):
  r"""Generates labels for candidate sampling with a learned unigram distribution.
...
def learned_unigram_candidate_sampler_eager_fallback(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, num_sampled: int, unique: bool, range_max: int, seed: int, seed2: int, name, ctx):
  num_true = _execute.make_int(num_true, "num_true")
  num_sampled = _execute.make_int(num_sampled, "num_sampled")
  unique = _execute.make_bool(unique, "unique")
  range_max = _execute.make_int(range_max, "range_max")
...
def log_uniform_candidate_sampler(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, num_sampled: int, unique: bool, range_max: int, seed:int=0, seed2:int=0, name=None):
...
def log_uniform_candidate_sampler_eager_fallback(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, num_sampled: int, unique: bool, range_max: int, seed: int, seed2: int, name, ctx):
  num_true = _execute.make_int(num_true, "num_true")
  num_sampled = _execute.make_int(num_sampled, "num_sampled")
  unique = _execute.make_bool(unique, "unique")
  range_max = _execute.make_int(range_max, "range_max")
...
def thread_unsafe_unigram_candidate_sampler_eager_fallback(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, num_sampled: int, unique: bool, range_max: int, seed: int, seed2: int, name, ctx):
  num_true = _execute.make_int(num_true, "num_true")
  num_sampled = _execute.make_int(num_sampled, "num_sampled")
  unique = _execute.make_bool(unique, "unique")
  range_max = _execute.make_int(range_max, "range_max")
...
def uniform_candidate_sampler(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, num_sampled: int, unique: bool, range_max: int, seed:int=0, seed2:int=0, name=None):
...
def uniform_candidate_sampler_eager_fallback(true_classes: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_true: int, num_sampled: int, unique: bool, range_max: int, seed: int, seed2: int, name, ctx):
  num_true = _execute.make_int(num_true, "num_true")
  num_sampled = _execute.make_int(num_sampled, "num_sampled")
  unique = _execute.make_bool(unique, "unique")
  range_max = _execute.make_int(range_max, "range_max")
