...
def dense_count_sparse_output(values: _atypes.TensorFuzzingAnnotation[TV_DenseCountSparseOutput_T], weights: _atypes.TensorFuzzingAnnotation[TV_DenseCountSparseOutput_output_type], binary_output: bool, minlength:int=-1, maxlength:int=-1, name=None):
...
def dense_count_sparse_output_eager_fallback(values: _atypes.TensorFuzzingAnnotation[TV_DenseCountSparseOutput_T], weights: _atypes.TensorFuzzingAnnotation[TV_DenseCountSparseOutput_output_type], binary_output: bool, minlength: int, maxlength: int, name, ctx):
  binary_output = _execute.make_bool(binary_output, "binary_output")
  if minlength is None:
    minlength = -1
  minlength = _execute.make_int(minlength, "minlength")
...
def sparse_count_sparse_output(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_SparseCountSparseOutput_T], dense_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], weights: _atypes.TensorFuzzingAnnotation[TV_SparseCountSparseOutput_output_type], binary_output: bool, minlength:int=-1, maxlength:int=-1, name=None):
...
def sparse_count_sparse_output_eager_fallback(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_SparseCountSparseOutput_T], dense_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], weights: _atypes.TensorFuzzingAnnotation[TV_SparseCountSparseOutput_output_type], binary_output: bool, minlength: int, maxlength: int, name, ctx):
  binary_output = _execute.make_bool(binary_output, "binary_output")
  if minlength is None:
    minlength = -1
  minlength = _execute.make_int(minlength, "minlength")
