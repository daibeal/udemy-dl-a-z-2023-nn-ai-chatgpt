...
def stateless_multinomial(logits: _atypes.TensorFuzzingAnnotation[TV_StatelessMultinomial_T], num_samples: _atypes.TensorFuzzingAnnotation[_atypes.Int32], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessMultinomial_Tseed], output_dtype:TV_StatelessMultinomial_output_dtype=_dtypes.int64, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessMultinomial_output_dtype]:
...
def stateless_parameterized_truncated_normal(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_S], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_Tseed], means: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_dtype], stddevs: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_dtype], minvals: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_dtype], maxvals: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_dtype], name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_dtype]:
  r"""TODO: add doc.
...
def stateless_parameterized_truncated_normal_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_S], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_Tseed], means: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_dtype], stddevs: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_dtype], minvals: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_dtype], maxvals: _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_dtype], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessParameterizedTruncatedNormal_dtype]:
...
def stateless_random_binomial(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomBinomial_S], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomBinomial_Tseed], counts: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomBinomial_T], probs: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomBinomial_T], dtype:TV_StatelessRandomBinomial_dtype=_dtypes.int64, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomBinomial_dtype]:
...
def stateless_random_binomial_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomBinomial_S], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomBinomial_Tseed], counts: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomBinomial_T], probs: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomBinomial_T], dtype: TV_StatelessRandomBinomial_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomBinomial_dtype]:
  if dtype is None:
    dtype = _dtypes.int64
  dtype = _execute.make_type(dtype, "dtype")
  _attr_S, (shape,) = _execute.args_to_matching_eager([shape], ctx, [_dtypes.int32, _dtypes.int64, ])
...
def stateless_random_gamma_v2_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomGammaV2_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomGammaV2_Tseed], alpha: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomGammaV2_dtype], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomGammaV2_dtype]:
...
def stateless_random_normal(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomNormal_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomNormal_Tseed], dtype:TV_StatelessRandomNormal_dtype=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomNormal_dtype]:
...
def stateless_random_normal_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomNormal_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomNormal_Tseed], dtype: TV_StatelessRandomNormal_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomNormal_dtype]:
  if dtype is None:
    dtype = _dtypes.float32
  dtype = _execute.make_type(dtype, "dtype")
...
def stateless_random_poisson(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomPoisson_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomPoisson_Tseed], lam: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomPoisson_Rtype], dtype: TV_StatelessRandomPoisson_dtype, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomPoisson_dtype]:
...
def stateless_random_poisson_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomPoisson_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomPoisson_Tseed], lam: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomPoisson_Rtype], dtype: TV_StatelessRandomPoisson_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomPoisson_dtype]:
  dtype = _execute.make_type(dtype, "dtype")
...
def stateless_random_uniform(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniform_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniform_Tseed], dtype:TV_StatelessRandomUniform_dtype=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniform_dtype]:
...
def stateless_random_uniform_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniform_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniform_Tseed], dtype: TV_StatelessRandomUniform_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniform_dtype]:
  if dtype is None:
    dtype = _dtypes.float32
  dtype = _execute.make_type(dtype, "dtype")
  _attr_T, (shape,) = _execute.args_to_matching_eager([shape], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
...
def stateless_random_uniform_full_int(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformFullInt_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformFullInt_Tseed], dtype:TV_StatelessRandomUniformFullInt_dtype=_dtypes.uint64, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformFullInt_dtype]:
...
def stateless_random_uniform_int_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformInt_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformInt_Tseed], minval: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformInt_dtype], maxval: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformInt_dtype], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformInt_dtype]:
...
def stateless_truncated_normal(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessTruncatedNormal_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessTruncatedNormal_Tseed], dtype:TV_StatelessTruncatedNormal_dtype=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessTruncatedNormal_dtype]:
...
def stateless_truncated_normal_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessTruncatedNormal_T], seed: _atypes.TensorFuzzingAnnotation[TV_StatelessTruncatedNormal_Tseed], dtype: TV_StatelessTruncatedNormal_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessTruncatedNormal_dtype]:
  if dtype is None:
    dtype = _dtypes.float32
  dtype = _execute.make_type(dtype, "dtype")
  _attr_T, (shape,) = _execute.args_to_matching_eager([shape], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
