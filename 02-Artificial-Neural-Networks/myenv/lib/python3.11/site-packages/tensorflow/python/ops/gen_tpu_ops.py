...
def all_to_all(input: _atypes.TensorFuzzingAnnotation[TV_AllToAll_T], group_assignment: _atypes.TensorFuzzingAnnotation[_atypes.Int32], concat_dimension: int, split_dimension: int, split_count: int, name=None) -> _atypes.TensorFuzzingAnnotation[TV_AllToAll_T]:
...
TV_AssignVariableXlaConcatND_T = TypeVar("TV_AssignVariableXlaConcatND_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def collective_permute(input: _atypes.TensorFuzzingAnnotation[TV_CollectivePermute_T], source_target_pairs: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None) -> _atypes.TensorFuzzingAnnotation[TV_CollectivePermute_T]:
...
def collective_permute_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CollectivePermute_T], source_target_pairs: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CollectivePermute_T]:
...
def cross_replica_sum(input: _atypes.TensorFuzzingAnnotation[TV_CrossReplicaSum_T], group_assignment: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None) -> _atypes.TensorFuzzingAnnotation[TV_CrossReplicaSum_T]:
...
def enqueue_tpu_embedding_arbitrary_tensor_batch(sample_indices_or_row_splits: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingArbitraryTensorBatch_T1]], embedding_indices: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingArbitraryTensorBatch_T2]], aggregation_weights: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingArbitraryTensorBatch_T3]], mode_override: _atypes.TensorFuzzingAnnotation[_atypes.String], device_ordinal:int=-1, combiners=[], name=None):
  r"""Eases the porting of code that uses tf.nn.embedding_lookup_sparse().
...
def enqueue_tpu_embedding_arbitrary_tensor_batch_eager_fallback(sample_indices_or_row_splits: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingArbitraryTensorBatch_T1]], embedding_indices: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingArbitraryTensorBatch_T2]], aggregation_weights: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingArbitraryTensorBatch_T3]], mode_override: _atypes.TensorFuzzingAnnotation[_atypes.String], device_ordinal: int, combiners, name, ctx):
  if not isinstance(sample_indices_or_row_splits, (list, tuple)):
    raise TypeError(
        "Expected list for 'sample_indices_or_row_splits' argument to "
        "'enqueue_tpu_embedding_arbitrary_tensor_batch' Op, not %r." % sample_indices_or_row_splits)
...
def enqueue_tpu_embedding_integer_batch(batch: List[_atypes.TensorFuzzingAnnotation[_atypes.Int32]], mode_override: _atypes.TensorFuzzingAnnotation[_atypes.String], device_ordinal:int=-1, name=None):
...
def enqueue_tpu_embedding_integer_batch_eager_fallback(batch: List[_atypes.TensorFuzzingAnnotation[_atypes.Int32]], mode_override: _atypes.TensorFuzzingAnnotation[_atypes.String], device_ordinal: int, name, ctx):
  if not isinstance(batch, (list, tuple)):
    raise TypeError(
        "Expected list for 'batch' argument to "
        "'enqueue_tpu_embedding_integer_batch' Op, not %r." % batch)
...
def enqueue_tpu_embedding_ragged_tensor_batch(sample_splits: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingRaggedTensorBatch_T1]], embedding_indices: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingRaggedTensorBatch_T2]], aggregation_weights: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingRaggedTensorBatch_T3]], mode_override: _atypes.TensorFuzzingAnnotation[_atypes.String], table_ids, device_ordinal:int=-1, combiners=[], max_sequence_lengths=[], num_features=[], name=None):
...
def enqueue_tpu_embedding_sparse_tensor_batch(sample_indices: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingSparseTensorBatch_T1]], embedding_indices: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingSparseTensorBatch_T2]], aggregation_weights: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingSparseTensorBatch_T3]], mode_override: _atypes.TensorFuzzingAnnotation[_atypes.String], table_ids, device_ordinal:int=-1, combiners=[], max_sequence_lengths=[], num_features=[], name=None):
  r"""Eases the porting of code that uses tf.nn.embedding_lookup_sparse().
...
def enqueue_tpu_embedding_sparse_tensor_batch_eager_fallback(sample_indices: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingSparseTensorBatch_T1]], embedding_indices: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingSparseTensorBatch_T2]], aggregation_weights: List[_atypes.TensorFuzzingAnnotation[TV_EnqueueTPUEmbeddingSparseTensorBatch_T3]], mode_override: _atypes.TensorFuzzingAnnotation[_atypes.String], table_ids, device_ordinal: int, combiners, max_sequence_lengths, num_features, name, ctx):
  if not isinstance(sample_indices, (list, tuple)):
    raise TypeError(
        "Expected list for 'sample_indices' argument to "
        "'enqueue_tpu_embedding_sparse_tensor_batch' Op, not %r." % sample_indices)
...
TV_InfeedDequeue_dtype = TypeVar("TV_InfeedDequeue_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def infeed_dequeue(dtype: TV_InfeedDequeue_dtype, shape, name=None) -> _atypes.TensorFuzzingAnnotation[TV_InfeedDequeue_dtype]:
...
def infeed_dequeue_eager_fallback(dtype: TV_InfeedDequeue_dtype, shape, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_InfeedDequeue_dtype]:
  dtype = _execute.make_type(dtype, "dtype")
  shape = _execute.make_shape(shape, "shape")
  _inputs_flat = []
...
TV_InfeedEnqueue_dtype = TypeVar("TV_InfeedEnqueue_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def is_tpu_embedding_initialized_eager_fallback(config: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  if config is None:
    config = ""
  config = _execute.make_str(config, "config")
  _inputs_flat = []
...
def load_tpu_embedding_adam_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], momenta: _atypes.TensorFuzzingAnnotation[_atypes.Float32], velocities: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_adam_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], momenta: _atypes.TensorFuzzingAnnotation[_atypes.Float32], velocities: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_adadelta_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], updates: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_adadelta_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], updates: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_adagrad_momentum_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], momenta: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_adagrad_momentum_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], momenta: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_adagrad_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_centered_rms_prop_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], ms: _atypes.TensorFuzzingAnnotation[_atypes.Float32], mom: _atypes.TensorFuzzingAnnotation[_atypes.Float32], mg: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_centered_rms_prop_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], ms: _atypes.TensorFuzzingAnnotation[_atypes.Float32], mom: _atypes.TensorFuzzingAnnotation[_atypes.Float32], mg: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_ftrl_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], linears: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_ftrl_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], linears: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_frequency_estimator_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], last_hit_step: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_frequency_estimator_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], last_hit_step: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_mdl_adagrad_light_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], weights: _atypes.TensorFuzzingAnnotation[_atypes.Float32], benefits: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_mdl_adagrad_light_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], weights: _atypes.TensorFuzzingAnnotation[_atypes.Float32], benefits: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_momentum_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], momenta: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_momentum_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], momenta: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_proximal_adagrad_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_proximal_adagrad_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], accumulators: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_proximal_yogi_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], v: _atypes.TensorFuzzingAnnotation[_atypes.Float32], m: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
  r"""TODO: add doc.
...
def load_tpu_embedding_proximal_yogi_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], v: _atypes.TensorFuzzingAnnotation[_atypes.Float32], m: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_rms_prop_parameters(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], ms: _atypes.TensorFuzzingAnnotation[_atypes.Float32], mom: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None):
...
def load_tpu_embedding_rms_prop_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], ms: _atypes.TensorFuzzingAnnotation[_atypes.Float32], mom: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def load_tpu_embedding_stochastic_gradient_descent_parameters_eager_fallback(parameters: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx):
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
TV_OutfeedDequeue_dtype = TypeVar("TV_OutfeedDequeue_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def outfeed_dequeue(dtype: TV_OutfeedDequeue_dtype, shape, device_ordinal:int=-1, name=None) -> _atypes.TensorFuzzingAnnotation[TV_OutfeedDequeue_dtype]:
...
def outfeed_dequeue_eager_fallback(dtype: TV_OutfeedDequeue_dtype, shape, device_ordinal: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_OutfeedDequeue_dtype]:
  dtype = _execute.make_type(dtype, "dtype")
  shape = _execute.make_shape(shape, "shape")
  if device_ordinal is None:
    device_ordinal = -1
...
def outfeed_dequeue_tuple_v2_eager_fallback(device_ordinal: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, shapes, name, ctx):
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'outfeed_dequeue_tuple_v2' Op, not %r." % dtypes)
...
TV_OutfeedDequeueV2_dtype = TypeVar("TV_OutfeedDequeueV2_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
TV_OutfeedEnqueue_dtype = TypeVar("TV_OutfeedEnqueue_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def outfeed_enqueue(input: _atypes.TensorFuzzingAnnotation[TV_OutfeedEnqueue_dtype], name=None):
...
def outfeed_enqueue_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_OutfeedEnqueue_dtype], name, ctx):
  _attr_dtype, (input,) = _execute.args_to_matching_eager([input], ctx, [])
  _inputs_flat = [input]
...
def prelinearize(input: _atypes.TensorFuzzingAnnotation[TV_Prelinearize_dtype], shape=[], layout=[], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def prelinearize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Prelinearize_dtype], shape, layout, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if shape is None:
    shape = []
  shape = _execute.make_shape(shape, "shape")
  if layout is None:
...
def read_variable_xla_split_nd(resource: _atypes.TensorFuzzingAnnotation[_atypes.Resource], T: TV_ReadVariableXlaSplitND_T, N: int, num_splits, paddings=[], name=None):
...
def retrieve_tpu_embedding_stochastic_gradient_descent_parameters(num_shards: int, shard_id: int, table_id:int=-1, table_name:str="", config:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
...
def retrieve_tpu_embedding_stochastic_gradient_descent_parameters_eager_fallback(num_shards: int, shard_id: int, table_id: int, table_name: str, config: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  num_shards = _execute.make_int(num_shards, "num_shards")
  shard_id = _execute.make_int(shard_id, "shard_id")
  if table_id is None:
    table_id = -1
...
def send_tpu_embedding_gradients(inputs: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], learning_rates: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], config: str, name=None):
...
def tpu_compilation_result(name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def tpu_compilation_result_eager_fallback(name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  _inputs_flat = []
  _attrs = None
...
def tpu_ordinal_selector_eager_fallback(name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  _inputs_flat = []
  _attrs = None
...
def tpu_partitioned_call(args, device_ordinal: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tout, f, autotuner_thresh:int=0, name=None):
...
TV_TPUReplicatedInput_T = TypeVar("TV_TPUReplicatedInput_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
TV_TPUReplicatedOutput_T = TypeVar("TV_TPUReplicatedOutput_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def worker_heartbeat(request: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def worker_heartbeat_eager_fallback(request: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
TV_XlaConcatND_T = TypeVar("TV_XlaConcatND_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def xla_concat_nd(inputs: List[_atypes.TensorFuzzingAnnotation[TV_XlaConcatND_T]], num_concats, paddings=[], name=None) -> _atypes.TensorFuzzingAnnotation[TV_XlaConcatND_T]:
  r"""Concats input tensor across all dimensions.
...
TV_XlaSplitND_T = TypeVar("TV_XlaSplitND_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
