...
def fixed_length_record_reader_eager_fallback(record_bytes: int, header_bytes: int, footer_bytes: int, hop_bytes: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("fixed_length_record_reader op does not support eager execution. Arg 'reader_handle' is a ref.")

def fixed_length_record_reader_v2(record_bytes: int, header_bytes:int=0, footer_bytes:int=0, hop_bytes:int=0, container:str="", shared_name:str="", encoding:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""A Reader that outputs fixed-length records from a file.
...
def identity_reader(container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def identity_reader_eager_fallback(container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("identity_reader op does not support eager execution. Arg 'reader_handle' is a ref.")

def identity_reader_v2(container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""A Reader that outputs the queued work as both the key and value.
...
def identity_reader_v2_eager_fallback(container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if container is None:
    container = ""
  container = _execute.make_str(container, "container")
  if shared_name is None:
...
def lmdb_reader(container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def lmdb_reader_eager_fallback(container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("lmdb_reader op does not support eager execution. Arg 'reader_handle' is a ref.")
...
def matching_files(pattern: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def matching_files_eager_fallback(pattern: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def read_file(filename: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def read_file_eager_fallback(filename: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def reader_num_records_produced(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
...
def reader_num_records_produced_eager_fallback(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
  raise RuntimeError("reader_num_records_produced op does not support eager execution. Arg 'reader_handle' is a ref.")

def reader_num_records_produced_v2(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
  r"""Returns the number of records this Reader has produced.
...
def reader_num_records_produced_v2_eager_fallback(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
...
def reader_num_work_units_completed(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
...
def reader_num_work_units_completed_eager_fallback(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
  raise RuntimeError("reader_num_work_units_completed op does not support eager execution. Arg 'reader_handle' is a ref.")

def reader_num_work_units_completed_v2(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
  r"""Returns the number of work units this Reader has finished processing.
...
def reader_num_work_units_completed_v2_eager_fallback(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
  reader_handle = _ops.convert_to_tensor(reader_handle, _dtypes.resource)
  _inputs_flat = [reader_handle]
  _attrs = None
...
def reader_read_eager_fallback(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], queue_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  raise RuntimeError("reader_read op does not support eager execution. Arg 'queue_handle' is a ref.")
...
def reader_read_up_to_eager_fallback(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], queue_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], num_records: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx):
  raise RuntimeError("reader_read_up_to op does not support eager execution. Arg 'queue_handle' is a ref.")
...
def reader_reset_eager_fallback(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  raise RuntimeError("reader_reset op does not support eager execution. Arg 'reader_handle' is a ref.")

def reader_reset_v2(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None):
  r"""Restore a Reader to its initial clean state.
...
def reader_reset_v2_eager_fallback(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx):
  reader_handle = _ops.convert_to_tensor(reader_handle, _dtypes.resource)
  _inputs_flat = [reader_handle]
  _attrs = None
...
def reader_serialize_state(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def reader_serialize_state_eager_fallback(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("reader_serialize_state op does not support eager execution. Arg 'reader_handle' is a ref.")

def reader_serialize_state_v2(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  r"""Produce a string tensor that encodes the state of a Reader.
...
def reader_serialize_state_v2_eager_fallback(reader_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  reader_handle = _ops.convert_to_tensor(reader_handle, _dtypes.resource)
  _inputs_flat = [reader_handle]
  _attrs = None
...
def restore(file_pattern: _atypes.TensorFuzzingAnnotation[_atypes.String], tensor_name: _atypes.TensorFuzzingAnnotation[_atypes.String], dt: TV_Restore_dt, preferred_shard:int=-1, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Restore_dt]:
...
def restore_eager_fallback(file_pattern: _atypes.TensorFuzzingAnnotation[_atypes.String], tensor_name: _atypes.TensorFuzzingAnnotation[_atypes.String], dt: TV_Restore_dt, preferred_shard: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Restore_dt]:
  dt = _execute.make_type(dt, "dt")
  if preferred_shard is None:
    preferred_shard = -1
  preferred_shard = _execute.make_int(preferred_shard, "preferred_shard")
...
TV_RestoreSlice_dt = TypeVar("TV_RestoreSlice_dt", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def restore_slice_eager_fallback(file_pattern: _atypes.TensorFuzzingAnnotation[_atypes.String], tensor_name: _atypes.TensorFuzzingAnnotation[_atypes.String], shape_and_slice: _atypes.TensorFuzzingAnnotation[_atypes.String], dt: TV_RestoreSlice_dt, preferred_shard: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RestoreSlice_dt]:
  dt = _execute.make_type(dt, "dt")
  if preferred_shard is None:
    preferred_shard = -1
  preferred_shard = _execute.make_int(preferred_shard, "preferred_shard")
...
def save(filename: _atypes.TensorFuzzingAnnotation[_atypes.String], tensor_names: _atypes.TensorFuzzingAnnotation[_atypes.String], data, name=None):
...
def save_eager_fallback(filename: _atypes.TensorFuzzingAnnotation[_atypes.String], tensor_names: _atypes.TensorFuzzingAnnotation[_atypes.String], data, name, ctx):
...
def sharded_filename(basename: _atypes.TensorFuzzingAnnotation[_atypes.String], shard: _atypes.TensorFuzzingAnnotation[_atypes.Int32], num_shards: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def sharded_filename_eager_fallback(basename: _atypes.TensorFuzzingAnnotation[_atypes.String], shard: _atypes.TensorFuzzingAnnotation[_atypes.Int32], num_shards: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def sharded_filespec(basename: _atypes.TensorFuzzingAnnotation[_atypes.String], num_shards: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def sharded_filespec_eager_fallback(basename: _atypes.TensorFuzzingAnnotation[_atypes.String], num_shards: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  basename = _ops.convert_to_tensor(basename, _dtypes.string)
  num_shards = _ops.convert_to_tensor(num_shards, _dtypes.int32)
...
def tf_record_reader_eager_fallback(container: str, shared_name: str, compression_type: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("tf_record_reader op does not support eager execution. Arg 'reader_handle' is a ref.")
...
def tf_record_reader_v2_eager_fallback(container: str, shared_name: str, compression_type: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if container is None:
    container = ""
  container = _execute.make_str(container, "container")
  if shared_name is None:
...
def text_line_reader(skip_header_lines:int=0, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def text_line_reader_eager_fallback(skip_header_lines: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("text_line_reader op does not support eager execution. Arg 'reader_handle' is a ref.")
...
def whole_file_reader_eager_fallback(container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("whole_file_reader op does not support eager execution. Arg 'reader_handle' is a ref.")

def whole_file_reader_v2(container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""A Reader that outputs the entire contents of a file as a value.
...
def write_file(filename: _atypes.TensorFuzzingAnnotation[_atypes.String], contents: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None):
...
def write_file_eager_fallback(filename: _atypes.TensorFuzzingAnnotation[_atypes.String], contents: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  filename = _ops.convert_to_tensor(filename, _dtypes.string)
