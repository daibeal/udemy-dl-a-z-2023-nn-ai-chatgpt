...
def audio_summary(tag: _atypes.TensorFuzzingAnnotation[_atypes.String], tensor: _atypes.TensorFuzzingAnnotation[_atypes.Float32], sample_rate: float, max_outputs:int=3, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def audio_summary_v2(tag: _atypes.TensorFuzzingAnnotation[_atypes.String], tensor: _atypes.TensorFuzzingAnnotation[_atypes.Float32], sample_rate: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_outputs:int=3, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  r"""Outputs a `Summary` protocol buffer with audio.
...
def audio_summary_v2_eager_fallback(tag: _atypes.TensorFuzzingAnnotation[_atypes.String], tensor: _atypes.TensorFuzzingAnnotation[_atypes.Float32], sample_rate: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_outputs: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  if max_outputs is None:
    max_outputs = 3
  max_outputs = _execute.make_int(max_outputs, "max_outputs")
  tag = _ops.convert_to_tensor(tag, _dtypes.string)
...
def histogram_summary(tag: _atypes.TensorFuzzingAnnotation[_atypes.String], values: _atypes.TensorFuzzingAnnotation[TV_HistogramSummary_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def histogram_summary_eager_fallback(tag: _atypes.TensorFuzzingAnnotation[_atypes.String], values: _atypes.TensorFuzzingAnnotation[TV_HistogramSummary_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def image_summary(tag: _atypes.TensorFuzzingAnnotation[_atypes.String], tensor: _atypes.TensorFuzzingAnnotation[TV_ImageSummary_T], max_images:int=3, bad_color=_execute.make_tensor("""dtype: DT_UINT8 tensor_shape { dim { size: 4 } } int_val: 255 int_val: 0 int_val: 0 int_val: 255 """, "bad_color"), name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def merge_summary(inputs: List[_atypes.TensorFuzzingAnnotation[_atypes.String]], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  r"""Merges summaries.
...
TV_Print_T = TypeVar("TV_Print_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def _print(input: _atypes.TensorFuzzingAnnotation[TV_Print_T], data, message:str="", first_n:int=-1, summarize:int=3, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Print_T]:
...
def _print_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Print_T], data, message: str, first_n: int, summarize: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Print_T]:
  if message is None:
    message = ""
  message = _execute.make_str(message, "message")
  if first_n is None:
...
def print_v2(input: _atypes.TensorFuzzingAnnotation[_atypes.String], output_stream:str="stderr", end:str="\n", name=None):
...
def scalar_summary(tags: _atypes.TensorFuzzingAnnotation[_atypes.String], values: _atypes.TensorFuzzingAnnotation[TV_ScalarSummary_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def scalar_summary_eager_fallback(tags: _atypes.TensorFuzzingAnnotation[_atypes.String], values: _atypes.TensorFuzzingAnnotation[TV_ScalarSummary_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
TV_TensorSummary_T = TypeVar("TV_TensorSummary_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
TV_TensorSummaryV2_T = TypeVar("TV_TensorSummaryV2_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def tensor_summary_v2_eager_fallback(tag: _atypes.TensorFuzzingAnnotation[_atypes.String], tensor: _atypes.TensorFuzzingAnnotation[TV_TensorSummaryV2_T], serialized_summary_metadata: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  _attr_T, (tensor,) = _execute.args_to_matching_eager([tensor], ctx, [])
  tag = _ops.convert_to_tensor(tag, _dtypes.string)
...
@tf_export('timestamp')
def timestamp(name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float64]:
...
def timestamp_eager_fallback(name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float64]:
  _inputs_flat = []
  _attrs = None
