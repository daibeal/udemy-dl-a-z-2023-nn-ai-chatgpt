...
def random_index_shuffle(index: _atypes.TensorFuzzingAnnotation[TV_RandomIndexShuffle_dtype], seed: _atypes.TensorFuzzingAnnotation[TV_RandomIndexShuffle_Tseed], max_index: _atypes.TensorFuzzingAnnotation[TV_RandomIndexShuffle_dtype], rounds:int=4, name=None) -> _atypes.TensorFuzzingAnnotation[TV_RandomIndexShuffle_dtype]:
...
def random_index_shuffle_eager_fallback(index: _atypes.TensorFuzzingAnnotation[TV_RandomIndexShuffle_dtype], seed: _atypes.TensorFuzzingAnnotation[TV_RandomIndexShuffle_Tseed], max_index: _atypes.TensorFuzzingAnnotation[TV_RandomIndexShuffle_dtype], rounds: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RandomIndexShuffle_dtype]:
  if rounds is None:
    rounds = 4
  rounds = _execute.make_int(rounds, "rounds")
