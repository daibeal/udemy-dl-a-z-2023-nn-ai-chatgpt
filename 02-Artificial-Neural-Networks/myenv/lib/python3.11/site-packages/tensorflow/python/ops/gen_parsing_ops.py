...
def decode_csv(records: _atypes.TensorFuzzingAnnotation[_atypes.String], record_defaults, field_delim:str=",", use_quote_delim:bool=True, na_value:str="", select_cols=[], name=None):
...
def decode_compressed_eager_fallback(bytes: _atypes.TensorFuzzingAnnotation[_atypes.String], compression_type: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  if compression_type is None:
    compression_type = ""
  compression_type = _execute.make_str(compression_type, "compression_type")
...
def decode_json_example(json_examples: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def decode_json_example_eager_fallback(json_examples: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def decode_raw(bytes: _atypes.TensorFuzzingAnnotation[_atypes.String], out_type: TV_DecodeRaw_out_type, little_endian:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[TV_DecodeRaw_out_type]:
  r"""Reinterpret the bytes of a string as a vector of numbers.
...
def parse_single_example(serialized: _atypes.TensorFuzzingAnnotation[_atypes.String], dense_defaults, num_sparse: int, sparse_keys, dense_keys, sparse_types, dense_shapes, name=None):
...
TV_ParseTensor_out_type = TypeVar("TV_ParseTensor_out_type", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def parse_tensor_eager_fallback(serialized: _atypes.TensorFuzzingAnnotation[_atypes.String], out_type: TV_ParseTensor_out_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ParseTensor_out_type]:
  out_type = _execute.make_type(out_type, "out_type")
  serialized = _ops.convert_to_tensor(serialized, _dtypes.string)
...
TV_SerializeTensor_T = TypeVar("TV_SerializeTensor_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def serialize_tensor(tensor: _atypes.TensorFuzzingAnnotation[TV_SerializeTensor_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def serialize_tensor_eager_fallback(tensor: _atypes.TensorFuzzingAnnotation[TV_SerializeTensor_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
TV_StringToNumber_out_type = TypeVar("TV_StringToNumber_out_type", _atypes.Float32, _atypes.Float64, _atypes.Int32, _atypes.Int64)

def string_to_number(string_tensor: _atypes.TensorFuzzingAnnotation[_atypes.String], out_type:TV_StringToNumber_out_type=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StringToNumber_out_type]:
