...
def accumulator_apply_gradient(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], local_step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], gradient: _atypes.TensorFuzzingAnnotation[TV_AccumulatorApplyGradient_dtype], name=None):
...
def accumulator_apply_gradient_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], local_step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], gradient: _atypes.TensorFuzzingAnnotation[TV_AccumulatorApplyGradient_dtype], name, ctx):
  raise RuntimeError("accumulator_apply_gradient op does not support eager execution. Arg 'handle' is a ref.")

def accumulator_num_accumulated(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def accumulator_num_accumulated_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  raise RuntimeError("accumulator_num_accumulated op does not support eager execution. Arg 'handle' is a ref.")

def accumulator_set_global_step(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], new_global_step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name=None):
...
def accumulator_set_global_step_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], new_global_step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx):
  raise RuntimeError("accumulator_set_global_step op does not support eager execution. Arg 'handle' is a ref.")
...
def barrier(component_types, shapes=[], capacity:int=-1, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def barrier_eager_fallback(component_types, shapes, capacity: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("barrier op does not support eager execution. Arg 'handle' is a ref.")
...
def barrier_close_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], cancel_pending_enqueues: bool, name, ctx):
  raise RuntimeError("barrier_close op does not support eager execution. Arg 'handle' is a ref.")

def barrier_incomplete_size(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def barrier_incomplete_size_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  raise RuntimeError("barrier_incomplete_size op does not support eager execution. Arg 'handle' is a ref.")

TV_BarrierInsertMany_T = TypeVar("TV_BarrierInsertMany_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def barrier_insert_many_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], keys: _atypes.TensorFuzzingAnnotation[_atypes.String], values: _atypes.TensorFuzzingAnnotation[TV_BarrierInsertMany_T], component_index: int, name, ctx):
  raise RuntimeError("barrier_insert_many op does not support eager execution. Arg 'handle' is a ref.")

def barrier_ready_size(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def barrier_ready_size_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  raise RuntimeError("barrier_ready_size op does not support eager execution. Arg 'handle' is a ref.")
...
def barrier_take_many_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], num_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int32], component_types, allow_small_batch: bool, wait_for_incomplete: bool, timeout_ms: int, name, ctx):
  raise RuntimeError("barrier_take_many op does not support eager execution. Arg 'handle' is a ref.")
...
def conditional_accumulator(dtype: TV_ConditionalAccumulator_dtype, shape, container:str="", shared_name:str="", reduction_type:str="MEAN", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def conditional_accumulator_eager_fallback(dtype: TV_ConditionalAccumulator_dtype, shape, container: str, shared_name: str, reduction_type: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("conditional_accumulator op does not support eager execution. Arg 'handle' is a ref.")

def delete_session_tensor(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None):
...
def delete_session_tensor_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
...
TV_DynamicPartition_T = TypeVar("TV_DynamicPartition_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('dynamic_partition')
def dynamic_partition(data: _atypes.TensorFuzzingAnnotation[TV_DynamicPartition_T], partitions: _atypes.TensorFuzzingAnnotation[_atypes.Int32], num_partitions: int, name=None):
...
def dynamic_partition_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_DynamicPartition_T], partitions: _atypes.TensorFuzzingAnnotation[_atypes.Int32], num_partitions: int, name, ctx):
  num_partitions = _execute.make_int(num_partitions, "num_partitions")
...
TV_DynamicStitch_T = TypeVar("TV_DynamicStitch_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def dynamic_stitch_eager_fallback(indices: List[_atypes.TensorFuzzingAnnotation[_atypes.Int32]], data: List[_atypes.TensorFuzzingAnnotation[TV_DynamicStitch_T]], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_DynamicStitch_T]:
  if not isinstance(indices, (list, tuple)):
    raise TypeError(
        "Expected list for 'indices' argument to "
        "'dynamic_stitch' Op, not %r." % indices)
...
def fifo_queue(component_types, shapes=[], capacity:int=-1, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def fifo_queue_eager_fallback(component_types, shapes, capacity: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("fifo_queue op does not support eager execution. Arg 'handle' is a ref.")

def fifo_queue_v2(component_types, shapes=[], capacity:int=-1, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""A queue that produces elements in first-in first-out order.
...
def fake_queue(resource: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def fake_queue_eager_fallback(resource: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("fake_queue op does not support eager execution. Arg 'handle' is a ref.")

TV_GetSessionHandle_T = TypeVar("TV_GetSessionHandle_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def get_session_handle(value: _atypes.TensorFuzzingAnnotation[TV_GetSessionHandle_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def get_session_handle_eager_fallback(value: _atypes.TensorFuzzingAnnotation[TV_GetSessionHandle_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def get_session_handle_v2_eager_fallback(value: _atypes.TensorFuzzingAnnotation[TV_GetSessionHandleV2_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  _attr_T, (value,) = _execute.args_to_matching_eager([value], ctx, [])
  _inputs_flat = [value]
  _attrs = ("T", _attr_T)
...
def get_session_tensor_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], dtype: TV_GetSessionTensor_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_GetSessionTensor_dtype]:
  dtype = _execute.make_type(dtype, "dtype")
  handle = _ops.convert_to_tensor(handle, _dtypes.string)
  _inputs_flat = [handle]
  _attrs = ("dtype", dtype)
...
def map_incomplete_size(dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def map_incomplete_size_eager_fallback(dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'map_incomplete_size' Op, not %r." % dtypes)
...
def map_peek(key: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None):
...
def map_peek_eager_fallback(key: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx):
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'map_peek' Op, not %r." % dtypes)
...
def map_size(dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def map_size_eager_fallback(dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'map_size' Op, not %r." % dtypes)
...
def map_stage(key: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], values, dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None):
...
def map_stage_eager_fallback(key: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], values, dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx):
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'map_stage' Op, not %r." % dtypes)
...
def map_unstage_eager_fallback(key: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx):
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'map_unstage' Op, not %r." % dtypes)
...
def map_unstage_no_key(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None):
...
def map_unstage_no_key_eager_fallback(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx):
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'map_unstage_no_key' Op, not %r." % dtypes)
...
def ordered_map_incomplete_size(dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  r"""Op returns the number of incomplete elements in the underlying container.
...
def ordered_map_incomplete_size_eager_fallback(dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'ordered_map_incomplete_size' Op, not %r." % dtypes)
...
def ordered_map_peek(key: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None):
  r"""Op peeks at the values at the specified key.  If the
...
def ordered_map_peek_eager_fallback(key: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx):
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'ordered_map_peek' Op, not %r." % dtypes)
...
def ordered_map_size(dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  r"""Op returns the number of elements in the underlying container.
...
def ordered_map_size_eager_fallback(dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'ordered_map_size' Op, not %r." % dtypes)
...
def ordered_map_stage_eager_fallback(key: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], values, dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx):
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'ordered_map_stage' Op, not %r." % dtypes)
...
def ordered_map_unstage(key: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None):
  r"""Op removes and returns the values associated with the key
...
def ordered_map_unstage_eager_fallback(key: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx):
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'ordered_map_unstage' Op, not %r." % dtypes)
...
def ordered_map_unstage_no_key(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None):
...
def padding_fifo_queue_eager_fallback(component_types, shapes, capacity: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("padding_fifo_queue op does not support eager execution. Arg 'handle' is a ref.")

def padding_fifo_queue_v2(component_types, shapes=[], capacity:int=-1, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""A queue that produces elements in first-in first-out order.
...
def padding_fifo_queue_v2_eager_fallback(component_types, shapes, capacity: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if not isinstance(component_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'component_types' argument to "
        "'padding_fifo_queue_v2' Op, not %r." % component_types)
...
TV_ParallelDynamicStitch_T = TypeVar("TV_ParallelDynamicStitch_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def parallel_dynamic_stitch(indices: List[_atypes.TensorFuzzingAnnotation[_atypes.Int32]], data: List[_atypes.TensorFuzzingAnnotation[TV_ParallelDynamicStitch_T]], name=None) -> _atypes.TensorFuzzingAnnotation[TV_ParallelDynamicStitch_T]:
  r"""Interleave the values from the `data` tensors into a single tensor.
...
def priority_queue(shapes, component_types=[], capacity:int=-1, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def priority_queue_eager_fallback(shapes, component_types, capacity: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("priority_queue op does not support eager execution. Arg 'handle' is a ref.")
...
def priority_queue_v2_eager_fallback(shapes, component_types, capacity: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if not isinstance(shapes, (list, tuple)):
    raise TypeError(
        "Expected list for 'shapes' argument to "
        "'priority_queue_v2' Op, not %r." % shapes)
...
def queue_close_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], cancel_pending_enqueues: bool, name, ctx):
  raise RuntimeError("queue_close op does not support eager execution. Arg 'handle' is a ref.")
...
def queue_close_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], cancel_pending_enqueues: bool, name, ctx):
  if cancel_pending_enqueues is None:
    cancel_pending_enqueues = False
  cancel_pending_enqueues = _execute.make_bool(cancel_pending_enqueues, "cancel_pending_enqueues")
...
def queue_dequeue_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], component_types, timeout_ms: int, name, ctx):
  raise RuntimeError("queue_dequeue op does not support eager execution. Arg 'handle' is a ref.")

def queue_dequeue_many(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], n: _atypes.TensorFuzzingAnnotation[_atypes.Int32], component_types, timeout_ms:int=-1, name=None):
...
def queue_dequeue_many_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], n: _atypes.TensorFuzzingAnnotation[_atypes.Int32], component_types, timeout_ms: int, name, ctx):
  raise RuntimeError("queue_dequeue_many op does not support eager execution. Arg 'handle' is a ref.")

def queue_dequeue_many_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], n: _atypes.TensorFuzzingAnnotation[_atypes.Int32], component_types, timeout_ms:int=-1, name=None):
  r"""Dequeues `n` tuples of one or more tensors from the given queue.
...
def queue_dequeue_many_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], n: _atypes.TensorFuzzingAnnotation[_atypes.Int32], component_types, timeout_ms: int, name, ctx):
  if not isinstance(component_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'component_types' argument to "
        "'queue_dequeue_many_v2' Op, not %r." % component_types)
...
def queue_dequeue_up_to(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], n: _atypes.TensorFuzzingAnnotation[_atypes.Int32], component_types, timeout_ms:int=-1, name=None):
  r"""Dequeues `n` tuples of one or more tensors from the given queue.
...
def queue_dequeue_up_to_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], n: _atypes.TensorFuzzingAnnotation[_atypes.Int32], component_types, timeout_ms: int, name, ctx):
  raise RuntimeError("queue_dequeue_up_to op does not support eager execution. Arg 'handle' is a ref.")
...
def queue_dequeue_up_to_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], n: _atypes.TensorFuzzingAnnotation[_atypes.Int32], component_types, timeout_ms: int, name, ctx):
  if not isinstance(component_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'component_types' argument to "
        "'queue_dequeue_up_to_v2' Op, not %r." % component_types)
...
def queue_dequeue_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], component_types, timeout_ms:int=-1, name=None):
  r"""Dequeues a tuple of one or more tensors from the given queue.
...
def queue_enqueue(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], components, timeout_ms:int=-1, name=None):
...
def queue_enqueue_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], components, timeout_ms: int, name, ctx):
  raise RuntimeError("queue_enqueue op does not support eager execution. Arg 'handle' is a ref.")

def queue_enqueue_many(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], components, timeout_ms:int=-1, name=None):
...
def queue_enqueue_many_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], components, timeout_ms: int, name, ctx):
  raise RuntimeError("queue_enqueue_many op does not support eager execution. Arg 'handle' is a ref.")

def queue_enqueue_many_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], components, timeout_ms:int=-1, name=None):
  r"""Enqueues zero or more tuples of one or more tensors in the given queue.
...
def queue_enqueue_many_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], components, timeout_ms: int, name, ctx):
  if timeout_ms is None:
    timeout_ms = -1
  timeout_ms = _execute.make_int(timeout_ms, "timeout_ms")
...
def queue_enqueue_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], components, timeout_ms:int=-1, name=None):
  r"""Enqueues a tuple of one or more tensors in the given queue.
...
def queue_is_closed(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def queue_is_closed_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  raise RuntimeError("queue_is_closed op does not support eager execution. Arg 'handle' is a ref.")

def queue_is_closed_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  r"""Returns true if queue is closed.
...
def queue_is_closed_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  _inputs_flat = [handle]
  _attrs = None
...
def queue_size_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  raise RuntimeError("queue_size op does not support eager execution. Arg 'handle' is a ref.")

def queue_size_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  r"""Computes the number of elements in the given queue.
...
def queue_size_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  _inputs_flat = [handle]
  _attrs = None
...
def random_shuffle_queue_eager_fallback(component_types, shapes, capacity: int, min_after_dequeue: int, seed: int, seed2: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("random_shuffle_queue op does not support eager execution. Arg 'handle' is a ref.")

def random_shuffle_queue_v2(component_types, shapes=[], capacity:int=-1, min_after_dequeue:int=0, seed:int=0, seed2:int=0, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""A queue that randomizes the order of elements.
...
def random_shuffle_queue_v2_eager_fallback(component_types, shapes, capacity: int, min_after_dequeue: int, seed: int, seed2: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if not isinstance(component_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'component_types' argument to "
        "'random_shuffle_queue_v2' Op, not %r." % component_types)
...
def record_input_eager_fallback(file_pattern: str, file_random_seed: int, file_shuffle_shift_ratio: float, file_buffer_size: int, file_parallelism: int, batch_size: int, compression_type: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  file_pattern = _execute.make_str(file_pattern, "file_pattern")
  if file_random_seed is None:
    file_random_seed = 301
  file_random_seed = _execute.make_int(file_random_seed, "file_random_seed")
...
def resource_accumulator_num_accumulated(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  r"""Returns the number of gradients aggregated in the given accumulators.
...
def resource_accumulator_num_accumulated_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  _inputs_flat = [handle]
  _attrs = None
...
def resource_accumulator_set_global_step_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], new_global_step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx):
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
...
def resource_accumulator_take_gradient(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], num_required: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype: TV_ResourceAccumulatorTakeGradient_dtype, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ResourceAccumulatorTakeGradient_dtype]:
  r"""Extracts the average gradient in the given ConditionalAccumulator.
...
def resource_conditional_accumulator(dtype: TV_ResourceConditionalAccumulator_dtype, shape, container:str="", shared_name:str="", reduction_type:str="MEAN", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""A conditional accumulator for aggregating gradients.
...
def resource_conditional_accumulator_eager_fallback(dtype: TV_ResourceConditionalAccumulator_dtype, shape, container: str, shared_name: str, reduction_type: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  dtype = _execute.make_type(dtype, "dtype")
  shape = _execute.make_shape(shape, "shape")
  if container is None:
    container = ""
...
def sparse_accumulator_apply_gradient_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], local_step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], gradient_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], gradient_values: _atypes.TensorFuzzingAnnotation[TV_SparseAccumulatorApplyGradient_dtype], gradient_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], has_known_shape: bool, name, ctx):
  raise RuntimeError("sparse_accumulator_apply_gradient op does not support eager execution. Arg 'handle' is a ref.")
...
def sparse_accumulator_take_gradient_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], num_required: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype: TV_SparseAccumulatorTakeGradient_dtype, name, ctx):
  raise RuntimeError("sparse_accumulator_take_gradient op does not support eager execution. Arg 'handle' is a ref.")
...
def sparse_conditional_accumulator_eager_fallback(dtype: TV_SparseConditionalAccumulator_dtype, shape, container: str, shared_name: str, reduction_type: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("sparse_conditional_accumulator op does not support eager execution. Arg 'handle' is a ref.")

TV_Stack_elem_type = TypeVar("TV_Stack_elem_type", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def _stack(elem_type: TV_Stack_elem_type, stack_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def _stack_eager_fallback(elem_type: TV_Stack_elem_type, stack_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("stack op does not support eager execution. Arg 'handle' is a ref.")

def stack_close(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None):
...
def stack_close_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  raise RuntimeError("stack_close op does not support eager execution. Arg 'handle' is a ref.")

def stack_close_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None):
...
TV_StackPop_elem_type = TypeVar("TV_StackPop_elem_type", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def stack_pop_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], elem_type: TV_StackPop_elem_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StackPop_elem_type]:
  raise RuntimeError("stack_pop op does not support eager execution. Arg 'handle' is a ref.")

TV_StackPopV2_elem_type = TypeVar("TV_StackPopV2_elem_type", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def stack_pop_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], elem_type: TV_StackPopV2_elem_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StackPopV2_elem_type]:
  elem_type = _execute.make_type(elem_type, "elem_type")
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  _inputs_flat = [handle]
...
TV_StackPush_T = TypeVar("TV_StackPush_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def stack_push(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], elem: _atypes.TensorFuzzingAnnotation[TV_StackPush_T], swap_memory:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StackPush_T]:
...
def stack_push_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], elem: _atypes.TensorFuzzingAnnotation[TV_StackPush_T], swap_memory: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StackPush_T]:
  raise RuntimeError("stack_push op does not support eager execution. Arg 'handle' is a ref.")

TV_StackPushV2_T = TypeVar("TV_StackPushV2_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def stack_push_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], elem: _atypes.TensorFuzzingAnnotation[TV_StackPushV2_T], swap_memory: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StackPushV2_T]:
  if swap_memory is None:
    swap_memory = False
  swap_memory = _execute.make_bool(swap_memory, "swap_memory")
...
TV_StackV2_elem_type = TypeVar("TV_StackV2_elem_type", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def stage_peek(index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None):
...
def stage_peek_eager_fallback(index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx):
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'stage_peek' Op, not %r." % dtypes)
...
def stage_size(dtypes, capacity:int=0, memory_limit:int=0, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  r"""Op returns the number of elements in the underlying container.
...
def stage_size_eager_fallback(dtypes, capacity: int, memory_limit: int, container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  if not isinstance(dtypes, (list, tuple)):
    raise TypeError(
        "Expected list for 'dtypes' argument to "
        "'stage_size' Op, not %r." % dtypes)
...
TV_TensorArray_dtype = TypeVar("TV_TensorArray_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def tensor_array_close_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  raise RuntimeError("tensor_array_close op does not support eager execution. Arg 'handle' is a ref.")
...
def tensor_array_close_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  handle = _ops.convert_to_tensor(handle, _dtypes.string)
  _inputs_flat = [handle]
  _attrs = None
...
def tensor_array_close_v3(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None):
...
def tensor_array_close_v3_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx):
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  _inputs_flat = [handle]
  _attrs = None
...
TV_TensorArrayConcat_dtype = TypeVar("TV_TensorArrayConcat_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def tensor_array_concat_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayConcat_dtype, element_shape_except0, name, ctx):
  raise RuntimeError("tensor_array_concat op does not support eager execution. Arg 'handle' is a ref.")
...
TV_TensorArrayConcatV2_dtype = TypeVar("TV_TensorArrayConcatV2_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_concat_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayConcatV2_dtype, element_shape_except0=None, name=None):
...
TV_TensorArrayConcatV3_dtype = TypeVar("TV_TensorArrayConcatV3_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def tensor_array_concat_v3_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayConcatV3_dtype, element_shape_except0, name, ctx):
  dtype = _execute.make_type(dtype, "dtype")
  if element_shape_except0 is None:
    element_shape_except0 = None
  element_shape_except0 = _execute.make_shape(element_shape_except0, "element_shape_except0")
...
TV_TensorArrayGather_dtype = TypeVar("TV_TensorArrayGather_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_gather(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayGather_dtype, element_shape=None, name=None) -> _atypes.TensorFuzzingAnnotation[TV_TensorArrayGather_dtype]:
  r"""TODO: add doc.
...
def tensor_array_gather_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayGatherV2_dtype, element_shape, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TensorArrayGatherV2_dtype]:
  dtype = _execute.make_type(dtype, "dtype")
  if element_shape is None:
    element_shape = None
  element_shape = _execute.make_shape(element_shape, "element_shape")
...
TV_TensorArrayGatherV3_dtype = TypeVar("TV_TensorArrayGatherV3_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def tensor_array_grad(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], source: str, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  r"""TODO: add doc.
...
def tensor_array_grad_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], source: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  raise RuntimeError("tensor_array_grad op does not support eager execution. Arg 'grad_handle' is a ref.")

def tensor_array_grad_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], source: str, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def tensor_array_grad_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], source: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  source = _execute.make_str(source, "source")
  handle = _ops.convert_to_tensor(handle, _dtypes.string)
  flow_in = _ops.convert_to_tensor(flow_in, _dtypes.float32)
  _inputs_flat = [handle, flow_in]
...
def tensor_array_grad_v3_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], source: str, name, ctx):
  source = _execute.make_str(source, "source")
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  flow_in = _ops.convert_to_tensor(flow_in, _dtypes.float32)
  _inputs_flat = [handle, flow_in]
...
TV_TensorArrayPack_dtype = TypeVar("TV_TensorArrayPack_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_pack(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayPack_dtype, element_shape=None, name=None) -> _atypes.TensorFuzzingAnnotation[TV_TensorArrayPack_dtype]:
  r"""TODO: add doc.
...
TV_TensorArrayRead_dtype = TypeVar("TV_TensorArrayRead_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_read(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayRead_dtype, name=None) -> _atypes.TensorFuzzingAnnotation[TV_TensorArrayRead_dtype]:
  r"""TODO: add doc.
...
def tensor_array_read_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayRead_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TensorArrayRead_dtype]:
  raise RuntimeError("tensor_array_read op does not support eager execution. Arg 'handle' is a ref.")

TV_TensorArrayReadV2_dtype = TypeVar("TV_TensorArrayReadV2_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_read_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayReadV2_dtype, name=None) -> _atypes.TensorFuzzingAnnotation[TV_TensorArrayReadV2_dtype]:
...
def tensor_array_read_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayReadV2_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TensorArrayReadV2_dtype]:
  dtype = _execute.make_type(dtype, "dtype")
  handle = _ops.convert_to_tensor(handle, _dtypes.string)
  index = _ops.convert_to_tensor(index, _dtypes.int32)
  flow_in = _ops.convert_to_tensor(flow_in, _dtypes.float32)
...
TV_TensorArrayReadV3_dtype = TypeVar("TV_TensorArrayReadV3_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_read_v3(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], dtype: TV_TensorArrayReadV3_dtype, name=None) -> _atypes.TensorFuzzingAnnotation[TV_TensorArrayReadV3_dtype]:
...
def tensor_array_scatter(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayScatter_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  r"""TODO: add doc.
...
def tensor_array_scatter_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayScatter_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  raise RuntimeError("tensor_array_scatter op does not support eager execution. Arg 'handle' is a ref.")

TV_TensorArrayScatterV2_T = TypeVar("TV_TensorArrayScatterV2_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_scatter_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayScatterV2_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
...
def tensor_array_scatter_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayScatterV2_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  _attr_T, (value,) = _execute.args_to_matching_eager([value], ctx, [])
  handle = _ops.convert_to_tensor(handle, _dtypes.string)
  indices = _ops.convert_to_tensor(indices, _dtypes.int32)
  flow_in = _ops.convert_to_tensor(flow_in, _dtypes.float32)
...
TV_TensorArrayScatterV3_T = TypeVar("TV_TensorArrayScatterV3_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def tensor_array_scatter_v3_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayScatterV3_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  _attr_T, (value,) = _execute.args_to_matching_eager([value], ctx, [])
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  indices = _ops.convert_to_tensor(indices, _dtypes.int32)
  flow_in = _ops.convert_to_tensor(flow_in, _dtypes.float32)
...
def tensor_array_size_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  raise RuntimeError("tensor_array_size op does not support eager execution. Arg 'handle' is a ref.")

def tensor_array_size_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def tensor_array_size_v3(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def tensor_array_size_v3_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  flow_in = _ops.convert_to_tensor(flow_in, _dtypes.float32)
  _inputs_flat = [handle, flow_in]
  _attrs = None
...
TV_TensorArraySplit_T = TypeVar("TV_TensorArraySplit_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_split(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], value: _atypes.TensorFuzzingAnnotation[TV_TensorArraySplit_T], lengths: _atypes.TensorFuzzingAnnotation[_atypes.Int64], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  r"""TODO: add doc.
...
TV_TensorArraySplitV2_T = TypeVar("TV_TensorArraySplitV2_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_split_v2(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], value: _atypes.TensorFuzzingAnnotation[TV_TensorArraySplitV2_T], lengths: _atypes.TensorFuzzingAnnotation[_atypes.Int64], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
...
TV_TensorArraySplitV3_T = TypeVar("TV_TensorArraySplitV3_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
TV_TensorArrayUnpack_T = TypeVar("TV_TensorArrayUnpack_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_unpack(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayUnpack_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  r"""TODO: add doc.
...
def tensor_array_unpack_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayUnpack_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  raise RuntimeError("tensor_array_unpack op does not support eager execution. Arg 'handle' is a ref.")

TV_TensorArrayV2_dtype = TypeVar("TV_TensorArrayV2_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def tensor_array_v3_eager_fallback(size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype: TV_TensorArrayV3_dtype, element_shape, dynamic_size: bool, clear_after_read: bool, identical_element_shapes: bool, tensor_array_name: str, name, ctx):
  dtype = _execute.make_type(dtype, "dtype")
  if element_shape is None:
    element_shape = None
  element_shape = _execute.make_shape(element_shape, "element_shape")
...
TV_TensorArrayWrite_T = TypeVar("TV_TensorArrayWrite_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_write(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayWrite_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  r"""TODO: add doc.
...
def tensor_array_write_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayWrite_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  raise RuntimeError("tensor_array_write op does not support eager execution. Arg 'handle' is a ref.")

TV_TensorArrayWriteV2_T = TypeVar("TV_TensorArrayWriteV2_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def tensor_array_write_v2_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.String], index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayWriteV2_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  _attr_T, (value,) = _execute.args_to_matching_eager([value], ctx, [])
  handle = _ops.convert_to_tensor(handle, _dtypes.string)
  index = _ops.convert_to_tensor(index, _dtypes.int32)
  flow_in = _ops.convert_to_tensor(flow_in, _dtypes.float32)
...
TV_TensorArrayWriteV3_T = TypeVar("TV_TensorArrayWriteV3_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def tensor_array_write_v3(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayWriteV3_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
...
def tensor_array_write_v3_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], value: _atypes.TensorFuzzingAnnotation[TV_TensorArrayWriteV3_T], flow_in: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  _attr_T, (value,) = _execute.args_to_matching_eager([value], ctx, [])
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  index = _ops.convert_to_tensor(index, _dtypes.int32)
  flow_in = _ops.convert_to_tensor(flow_in, _dtypes.float32)
