...
def uniform_dequantize(input: _atypes.TensorFuzzingAnnotation[TV_UniformDequantize_Tin], scales: _atypes.TensorFuzzingAnnotation[_atypes.Float32], zero_points: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tout: TV_UniformDequantize_Tout, quantization_min_val: int, quantization_max_val: int, quantization_axis:int=-1, name=None) -> _atypes.TensorFuzzingAnnotation[TV_UniformDequantize_Tout]:
...
def uniform_dequantize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_UniformDequantize_Tin], scales: _atypes.TensorFuzzingAnnotation[_atypes.Float32], zero_points: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tout: TV_UniformDequantize_Tout, quantization_min_val: int, quantization_max_val: int, quantization_axis: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_UniformDequantize_Tout]:
  Tout = _execute.make_type(Tout, "Tout")
  quantization_min_val = _execute.make_int(quantization_min_val, "quantization_min_val")
  quantization_max_val = _execute.make_int(quantization_max_val, "quantization_max_val")
  if quantization_axis is None:
...
def uniform_quantize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_UniformQuantize_Tin], scales: _atypes.TensorFuzzingAnnotation[_atypes.Float32], zero_points: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tout: TV_UniformQuantize_Tout, quantization_min_val: int, quantization_max_val: int, quantization_axis: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_UniformQuantize_Tout]:
  Tout = _execute.make_type(Tout, "Tout")
  quantization_min_val = _execute.make_int(quantization_min_val, "quantization_min_val")
  quantization_max_val = _execute.make_int(quantization_max_val, "quantization_max_val")
  if quantization_axis is None:
...
def uniform_quantized_add_eager_fallback(lhs: _atypes.TensorFuzzingAnnotation[TV_UniformQuantizedAdd_T], rhs: _atypes.TensorFuzzingAnnotation[TV_UniformQuantizedAdd_T], lhs_scales: _atypes.TensorFuzzingAnnotation[_atypes.Float32], lhs_zero_points: _atypes.TensorFuzzingAnnotation[_atypes.Int32], rhs_scales: _atypes.TensorFuzzingAnnotation[_atypes.Float32], rhs_zero_points: _atypes.TensorFuzzingAnnotation[_atypes.Int32], output_scales: _atypes.TensorFuzzingAnnotation[_atypes.Float32], output_zero_points: _atypes.TensorFuzzingAnnotation[_atypes.Int32], lhs_quantization_min_val: int, lhs_quantization_max_val: int, rhs_quantization_min_val: int, rhs_quantization_max_val: int, output_quantization_min_val: int, output_quantization_max_val: int, lhs_quantization_axis: int, rhs_quantization_axis: int, output_quantization_axis: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_UniformQuantizedAdd_T]:
  lhs_quantization_min_val = _execute.make_int(lhs_quantization_min_val, "lhs_quantization_min_val")
  lhs_quantization_max_val = _execute.make_int(lhs_quantization_max_val, "lhs_quantization_max_val")
  rhs_quantization_min_val = _execute.make_int(rhs_quantization_min_val, "rhs_quantization_min_val")
  rhs_quantization_max_val = _execute.make_int(rhs_quantization_max_val, "rhs_quantization_max_val")
...
def uniform_requantize(input: _atypes.TensorFuzzingAnnotation[TV_UniformRequantize_Tin], input_scales: _atypes.TensorFuzzingAnnotation[_atypes.Float32], input_zero_points: _atypes.TensorFuzzingAnnotation[_atypes.Int32], output_scales: _atypes.TensorFuzzingAnnotation[_atypes.Float32], output_zero_points: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tout: TV_UniformRequantize_Tout, input_quantization_min_val: int, input_quantization_max_val: int, output_quantization_min_val: int, output_quantization_max_val: int, input_quantization_axis:int=-1, output_quantization_axis:int=-1, name=None) -> _atypes.TensorFuzzingAnnotation[TV_UniformRequantize_Tout]:
...
def uniform_requantize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_UniformRequantize_Tin], input_scales: _atypes.TensorFuzzingAnnotation[_atypes.Float32], input_zero_points: _atypes.TensorFuzzingAnnotation[_atypes.Int32], output_scales: _atypes.TensorFuzzingAnnotation[_atypes.Float32], output_zero_points: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tout: TV_UniformRequantize_Tout, input_quantization_min_val: int, input_quantization_max_val: int, output_quantization_min_val: int, output_quantization_max_val: int, input_quantization_axis: int, output_quantization_axis: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_UniformRequantize_Tout]:
  Tout = _execute.make_type(Tout, "Tout")
  input_quantization_min_val = _execute.make_int(input_quantization_min_val, "input_quantization_min_val")
  input_quantization_max_val = _execute.make_int(input_quantization_max_val, "input_quantization_max_val")
  output_quantization_min_val = _execute.make_int(output_quantization_min_val, "output_quantization_min_val")
