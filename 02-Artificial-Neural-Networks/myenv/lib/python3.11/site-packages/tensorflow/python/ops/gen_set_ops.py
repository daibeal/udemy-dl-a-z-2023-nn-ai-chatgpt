...
def dense_to_dense_set_operation_eager_fallback(set1: _atypes.TensorFuzzingAnnotation[TV_DenseToDenseSetOperation_T], set2: _atypes.TensorFuzzingAnnotation[TV_DenseToDenseSetOperation_T], set_operation: str, validate_indices: bool, name, ctx):
  set_operation = _execute.make_str(set_operation, "set_operation")
  if validate_indices is None:
    validate_indices = True
  validate_indices = _execute.make_bool(validate_indices, "validate_indices")
...
def dense_to_sparse_set_operation_eager_fallback(set1: _atypes.TensorFuzzingAnnotation[TV_DenseToSparseSetOperation_T], set2_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], set2_values: _atypes.TensorFuzzingAnnotation[TV_DenseToSparseSetOperation_T], set2_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], set_operation: str, validate_indices: bool, name, ctx):
  set_operation = _execute.make_str(set_operation, "set_operation")
  if validate_indices is None:
    validate_indices = True
  validate_indices = _execute.make_bool(validate_indices, "validate_indices")
...
def set_size(set_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], set_values: _atypes.TensorFuzzingAnnotation[TV_SetSize_T], set_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], validate_indices:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
