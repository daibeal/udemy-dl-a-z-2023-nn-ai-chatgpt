...
def cudnn_rnn_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CudnnRNN_T], input_h: _atypes.TensorFuzzingAnnotation[TV_CudnnRNN_T], input_c: _atypes.TensorFuzzingAnnotation[TV_CudnnRNN_T], params: _atypes.TensorFuzzingAnnotation[TV_CudnnRNN_T], rnn_mode: str, input_mode: str, direction: str, dropout: float, seed: int, seed2: int, is_training: bool, name, ctx):
  if rnn_mode is None:
    rnn_mode = "lstm"
  rnn_mode = _execute.make_str(rnn_mode, "rnn_mode")
  if input_mode is None:
...
def cudnn_rnn_backprop(input: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], input_h: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], input_c: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], params: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output_h: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output_c: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output_backprop: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output_h_backprop: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output_c_backprop: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], reserve_space: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], rnn_mode:str="lstm", input_mode:str="linear_input", direction:str="unidirectional", dropout:float=0, seed:int=0, seed2:int=0, name=None):
...
def cudnn_rnn_backprop_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], input_h: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], input_c: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], params: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output_h: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output_c: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output_backprop: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output_h_backprop: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], output_c_backprop: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], reserve_space: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNBackprop_T], rnn_mode: str, input_mode: str, direction: str, dropout: float, seed: int, seed2: int, name, ctx):
  if rnn_mode is None:
    rnn_mode = "lstm"
  rnn_mode = _execute.make_str(rnn_mode, "rnn_mode")
  if input_mode is None:
...
def cudnn_rnn_canonical_to_params_v2(num_layers: _atypes.TensorFuzzingAnnotation[_atypes.Int32], num_units: _atypes.TensorFuzzingAnnotation[_atypes.Int32], input_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], weights: List[_atypes.TensorFuzzingAnnotation[TV_CudnnRNNCanonicalToParamsV2_T]], biases: List[_atypes.TensorFuzzingAnnotation[TV_CudnnRNNCanonicalToParamsV2_T]], rnn_mode:str="lstm", input_mode:str="linear_input", direction:str="unidirectional", dropout:float=0, seed:int=0, seed2:int=0, num_proj:int=0, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CudnnRNNCanonicalToParamsV2_T]:
...
def cudnn_rnn_canonical_to_params_v2_eager_fallback(num_layers: _atypes.TensorFuzzingAnnotation[_atypes.Int32], num_units: _atypes.TensorFuzzingAnnotation[_atypes.Int32], input_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], weights: List[_atypes.TensorFuzzingAnnotation[TV_CudnnRNNCanonicalToParamsV2_T]], biases: List[_atypes.TensorFuzzingAnnotation[TV_CudnnRNNCanonicalToParamsV2_T]], rnn_mode: str, input_mode: str, direction: str, dropout: float, seed: int, seed2: int, num_proj: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CudnnRNNCanonicalToParamsV2_T]:
  if not isinstance(weights, (list, tuple)):
    raise TypeError(
        "Expected list for 'weights' argument to "
        "'cudnn_rnn_canonical_to_params_v2' Op, not %r." % weights)
...
def cudnn_rnn_params_size_eager_fallback(num_layers: _atypes.TensorFuzzingAnnotation[_atypes.Int32], num_units: _atypes.TensorFuzzingAnnotation[_atypes.Int32], input_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], T: TV_CudnnRNNParamsSize_T, S: TV_CudnnRNNParamsSize_S, rnn_mode: str, input_mode: str, direction: str, dropout: float, seed: int, seed2: int, num_proj: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CudnnRNNParamsSize_S]:
  T = _execute.make_type(T, "T")
  S = _execute.make_type(S, "S")
  if rnn_mode is None:
    rnn_mode = "lstm"
...
def cudnn_rnn_params_to_canonical(num_layers: _atypes.TensorFuzzingAnnotation[_atypes.Int32], num_units: _atypes.TensorFuzzingAnnotation[_atypes.Int32], input_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], params: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNParamsToCanonical_T], num_params: int, rnn_mode:str="lstm", input_mode:str="linear_input", direction:str="unidirectional", dropout:float=0, seed:int=0, seed2:int=0, name=None):
...
def cudnn_rnnv2(input: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV2_T], input_h: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV2_T], input_c: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV2_T], params: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV2_T], rnn_mode:str="lstm", input_mode:str="linear_input", direction:str="unidirectional", dropout:float=0, seed:int=0, seed2:int=0, is_training:bool=True, name=None):
  r"""A RNN backed by cuDNN.
...
def cudnn_rnnv3(input: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV3_T], input_h: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV3_T], input_c: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV3_T], params: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV3_T], sequence_lengths: _atypes.TensorFuzzingAnnotation[_atypes.Int32], rnn_mode:str="lstm", input_mode:str="linear_input", direction:str="unidirectional", dropout:float=0, seed:int=0, seed2:int=0, num_proj:int=0, is_training:bool=True, time_major:bool=True, name=None):
  r"""A RNN backed by cuDNN.
...
def cudnn_rnnv3_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV3_T], input_h: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV3_T], input_c: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV3_T], params: _atypes.TensorFuzzingAnnotation[TV_CudnnRNNV3_T], sequence_lengths: _atypes.TensorFuzzingAnnotation[_atypes.Int32], rnn_mode: str, input_mode: str, direction: str, dropout: float, seed: int, seed2: int, num_proj: int, is_training: bool, time_major: bool, name, ctx):
  if rnn_mode is None:
    rnn_mode = "lstm"
  rnn_mode = _execute.make_str(rnn_mode, "rnn_mode")
  if input_mode is None:
