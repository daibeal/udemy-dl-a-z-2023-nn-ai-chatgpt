...
TV_Enter_T = TypeVar("TV_Enter_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def enter(data: _atypes.TensorFuzzingAnnotation[TV_Enter_T], frame_name: str, is_constant:bool=False, parallel_iterations:int=10, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Enter_T]:
...
def enter_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_Enter_T], frame_name: str, is_constant: bool, parallel_iterations: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Enter_T]:
  frame_name = _execute.make_str(frame_name, "frame_name")
  if is_constant is None:
    is_constant = False
  is_constant = _execute.make_bool(is_constant, "is_constant")
...
TV_Exit_T = TypeVar("TV_Exit_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def _exit(data: _atypes.TensorFuzzingAnnotation[TV_Exit_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Exit_T]:
...
def _exit_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_Exit_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Exit_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [])
  _inputs_flat = [data]
  _attrs = ("T", _attr_T)
...
def loop_cond(input: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def loop_cond_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
TV_Merge_T = TypeVar("TV_Merge_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def merge(inputs: List[_atypes.TensorFuzzingAnnotation[TV_Merge_T]], name=None):
...
def next_iteration(data: _atypes.TensorFuzzingAnnotation[TV_NextIteration_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_NextIteration_T]:
...
def next_iteration_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_NextIteration_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_NextIteration_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [])
  _inputs_flat = [data]
  _attrs = ("T", _attr_T)
...
def ref_enter_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_RefEnter_T], frame_name: str, is_constant: bool, parallel_iterations: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RefEnter_T]:
  raise RuntimeError("ref_enter op does not support eager execution. Arg 'output' is a ref.")

TV_RefExit_T = TypeVar("TV_RefExit_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def ref_exit(data: _atypes.TensorFuzzingAnnotation[TV_RefExit_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_RefExit_T]:
  r"""Exits the current frame to its parent frame.
...
def ref_exit_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_RefExit_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RefExit_T]:
  raise RuntimeError("ref_exit op does not support eager execution. Arg 'output' is a ref.")
...
TV_RefMerge_T = TypeVar("TV_RefMerge_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def ref_merge_eager_fallback(inputs: List[_atypes.TensorFuzzingAnnotation[TV_RefMerge_T]], name, ctx):
  raise RuntimeError("ref_merge op does not support eager execution. Arg 'output' is a ref.")

TV_RefNextIteration_T = TypeVar("TV_RefNextIteration_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def ref_next_iteration(data: _atypes.TensorFuzzingAnnotation[TV_RefNextIteration_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_RefNextIteration_T]:
  r"""Makes its input available to the next iteration.
...
def ref_next_iteration_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_RefNextIteration_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RefNextIteration_T]:
  raise RuntimeError("ref_next_iteration op does not support eager execution. Arg 'output' is a ref.")

TV_RefSelect_T = TypeVar("TV_RefSelect_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def ref_select_eager_fallback(index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], inputs: List[_atypes.TensorFuzzingAnnotation[TV_RefSelect_T]], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RefSelect_T]:
  raise RuntimeError("ref_select op does not support eager execution. Arg 'output' is a ref.")
...
TV_RefSwitch_T = TypeVar("TV_RefSwitch_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def ref_switch(data: _atypes.TensorFuzzingAnnotation[TV_RefSwitch_T], pred: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name=None):
...
def ref_switch_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_RefSwitch_T], pred: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name, ctx):
  raise RuntimeError("ref_switch op does not support eager execution. Arg 'output_true' is a ref.")
...
TV_Switch_T = TypeVar("TV_Switch_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def switch(data: _atypes.TensorFuzzingAnnotation[TV_Switch_T], pred: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name=None):
...
def switch_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_Switch_T], pred: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name, ctx):
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [])
