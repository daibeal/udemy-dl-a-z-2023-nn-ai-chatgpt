...
TV_Unbatch_T = TypeVar("TV_Unbatch_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def unbatch(batched_tensor: _atypes.TensorFuzzingAnnotation[TV_Unbatch_T], batch_index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], id: _atypes.TensorFuzzingAnnotation[_atypes.Int64], timeout_micros: int, container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[TV_Unbatch_T]:
...
def unbatch_grad_eager_fallback(original_input: _atypes.TensorFuzzingAnnotation[TV_UnbatchGrad_T], batch_index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], grad: _atypes.TensorFuzzingAnnotation[TV_UnbatchGrad_T], id: _atypes.TensorFuzzingAnnotation[_atypes.Int64], container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_UnbatchGrad_T]:
  if container is None:
    container = ""
  container = _execute.make_str(container, "container")
  if shared_name is None:
