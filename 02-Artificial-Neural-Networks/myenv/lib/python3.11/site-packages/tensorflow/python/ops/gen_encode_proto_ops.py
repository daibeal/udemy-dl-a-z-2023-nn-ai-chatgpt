...
def encode_proto(sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], values, field_names, message_type: str, descriptor_source:str="local://", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
