...
def boosted_trees_calculate_best_feature_split(node_id_range: _atypes.TensorFuzzingAnnotation[_atypes.Int32], stats_summary: _atypes.TensorFuzzingAnnotation[_atypes.Float32], l1: _atypes.TensorFuzzingAnnotation[_atypes.Float32], l2: _atypes.TensorFuzzingAnnotation[_atypes.Float32], tree_complexity: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_node_weight: _atypes.TensorFuzzingAnnotation[_atypes.Float32], logits_dimension: int, split_type:str="inequality", name=None):
...
def boosted_trees_calculate_best_feature_split_eager_fallback(node_id_range: _atypes.TensorFuzzingAnnotation[_atypes.Int32], stats_summary: _atypes.TensorFuzzingAnnotation[_atypes.Float32], l1: _atypes.TensorFuzzingAnnotation[_atypes.Float32], l2: _atypes.TensorFuzzingAnnotation[_atypes.Float32], tree_complexity: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_node_weight: _atypes.TensorFuzzingAnnotation[_atypes.Float32], logits_dimension: int, split_type: str, name, ctx):
  logits_dimension = _execute.make_int(logits_dimension, "logits_dimension")
  if split_type is None:
    split_type = "inequality"
  split_type = _execute.make_str(split_type, "split_type")
...
def boosted_trees_create_ensemble_eager_fallback(tree_ensemble_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], stamp_token: _atypes.TensorFuzzingAnnotation[_atypes.Int64], tree_ensemble_serialized: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  tree_ensemble_handle = _ops.convert_to_tensor(tree_ensemble_handle, _dtypes.resource)
...
def boosted_trees_deserialize_ensemble(tree_ensemble_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], stamp_token: _atypes.TensorFuzzingAnnotation[_atypes.Int64], tree_ensemble_serialized: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None):
...
def boosted_trees_ensemble_resource_handle_op(container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
...
def boosted_trees_ensemble_resource_handle_op_eager_fallback(container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if container is None:
    container = ""
  container = _execute.make_str(container, "container")
  if shared_name is None:
...
def boosted_trees_flush_quantile_summaries_eager_fallback(quantile_stream_resource_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], num_features: int, name, ctx):
  num_features = _execute.make_int(num_features, "num_features")
  quantile_stream_resource_handle = _ops.convert_to_tensor(quantile_stream_resource_handle, _dtypes.resource)
...
def boosted_trees_get_ensemble_states(tree_ensemble_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None):
...
def boosted_trees_get_ensemble_states_eager_fallback(tree_ensemble_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx):
  tree_ensemble_handle = _ops.convert_to_tensor(tree_ensemble_handle, _dtypes.resource)
...
def boosted_trees_make_stats_summary_eager_fallback(node_ids: _atypes.TensorFuzzingAnnotation[_atypes.Int32], gradients: _atypes.TensorFuzzingAnnotation[_atypes.Float32], hessians: _atypes.TensorFuzzingAnnotation[_atypes.Float32], bucketized_features_list: List[_atypes.TensorFuzzingAnnotation[_atypes.Int32]], max_splits: int, num_buckets: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  if not isinstance(bucketized_features_list, (list, tuple)):
    raise TypeError(
        "Expected list for 'bucketized_features_list' argument to "
        "'boosted_trees_make_stats_summary' Op, not %r." % bucketized_features_list)
...
def boosted_trees_predict_eager_fallback(tree_ensemble_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], bucketized_features: List[_atypes.TensorFuzzingAnnotation[_atypes.Int32]], logits_dimension: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
  if not isinstance(bucketized_features, (list, tuple)):
    raise TypeError(
        "Expected list for 'bucketized_features' argument to "
        "'boosted_trees_predict' Op, not %r." % bucketized_features)
...
def boosted_trees_quantile_stream_resource_deserialize(quantile_stream_resource_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], bucket_boundaries: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], name=None):
...
def boosted_trees_quantile_stream_resource_flush(quantile_stream_resource_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], num_buckets: _atypes.TensorFuzzingAnnotation[_atypes.Int64], generate_quantiles:bool=False, name=None):
...
def boosted_trees_quantile_stream_resource_handle_op(container:str="", shared_name:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
...
def boosted_trees_quantile_stream_resource_handle_op_eager_fallback(container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if container is None:
    container = ""
  container = _execute.make_str(container, "container")
  if shared_name is None:
...
def boosted_trees_serialize_ensemble_eager_fallback(tree_ensemble_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx):
  tree_ensemble_handle = _ops.convert_to_tensor(tree_ensemble_handle, _dtypes.resource)
  _inputs_flat = [tree_ensemble_handle]
  _attrs = None
...
def boosted_trees_sparse_aggregate_stats_eager_fallback(node_ids: _atypes.TensorFuzzingAnnotation[_atypes.Int32], gradients: _atypes.TensorFuzzingAnnotation[_atypes.Float32], hessians: _atypes.TensorFuzzingAnnotation[_atypes.Float32], feature_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], feature_values: _atypes.TensorFuzzingAnnotation[_atypes.Int32], feature_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int32], max_splits: int, num_buckets: int, name, ctx):
  max_splits = _execute.make_int(max_splits, "max_splits")
  num_buckets = _execute.make_int(num_buckets, "num_buckets")
  node_ids = _ops.convert_to_tensor(node_ids, _dtypes.int32)
  gradients = _ops.convert_to_tensor(gradients, _dtypes.float32)
...
def boosted_trees_update_ensemble_v2(tree_ensemble_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], feature_ids: List[_atypes.TensorFuzzingAnnotation[_atypes.Int32]], dimension_ids: List[_atypes.TensorFuzzingAnnotation[_atypes.Int32]], node_ids: List[_atypes.TensorFuzzingAnnotation[_atypes.Int32]], gains: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], thresholds: List[_atypes.TensorFuzzingAnnotation[_atypes.Int32]], left_node_contribs: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], right_node_contribs: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], split_types: List[_atypes.TensorFuzzingAnnotation[_atypes.String]], max_depth: _atypes.TensorFuzzingAnnotation[_atypes.Int32], learning_rate: _atypes.TensorFuzzingAnnotation[_atypes.Float32], pruning_mode: _atypes.TensorFuzzingAnnotation[_atypes.Int32], logits_dimension:int=1, name=None):
...
def is_boosted_trees_ensemble_initialized(tree_ensemble_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def is_boosted_trees_ensemble_initialized_eager_fallback(tree_ensemble_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  tree_ensemble_handle = _ops.convert_to_tensor(tree_ensemble_handle, _dtypes.resource)
  _inputs_flat = [tree_ensemble_handle]
  _attrs = None
...
def is_boosted_trees_quantile_stream_resource_initialized_eager_fallback(quantile_stream_resource_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  quantile_stream_resource_handle = _ops.convert_to_tensor(quantile_stream_resource_handle, _dtypes.resource)
  _inputs_flat = [quantile_stream_resource_handle]
  _attrs = None
