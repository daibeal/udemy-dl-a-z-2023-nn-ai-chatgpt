...
def block_lstm_eager_fallback(seq_len_max: _atypes.TensorFuzzingAnnotation[_atypes.Int64], x: _atypes.TensorFuzzingAnnotation[TV_BlockLSTM_T], cs_prev: _atypes.TensorFuzzingAnnotation[TV_BlockLSTM_T], h_prev: _atypes.TensorFuzzingAnnotation[TV_BlockLSTM_T], w: _atypes.TensorFuzzingAnnotation[TV_BlockLSTM_T], wci: _atypes.TensorFuzzingAnnotation[TV_BlockLSTM_T], wcf: _atypes.TensorFuzzingAnnotation[TV_BlockLSTM_T], wco: _atypes.TensorFuzzingAnnotation[TV_BlockLSTM_T], b: _atypes.TensorFuzzingAnnotation[TV_BlockLSTM_T], forget_bias: float, cell_clip: float, use_peephole: bool, name, ctx):
  if forget_bias is None:
    forget_bias = 1
  forget_bias = _execute.make_float(forget_bias, "forget_bias")
  if cell_clip is None:
...
def block_lstm_grad_v2_eager_fallback(seq_len_max: _atypes.TensorFuzzingAnnotation[_atypes.Int64], x: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], cs_prev: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], h_prev: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], w: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], wci: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], wcf: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], wco: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], b: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], i: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], cs: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], f: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], o: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], ci: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], co: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], h: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], cs_grad: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], h_grad: _atypes.TensorFuzzingAnnotation[TV_BlockLSTMGradV2_T], use_peephole: bool, name, ctx):
  use_peephole = _execute.make_bool(use_peephole, "use_peephole")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, h, cs_grad, h_grad], ctx, [_dtypes.half, _dtypes.float32, ])
  (x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, h, cs_grad, h_grad) = _inputs_T
  seq_len_max = _ops.convert_to_tensor(seq_len_max, _dtypes.int64)
...
def gru_block_cell_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_GRUBlockCell_T], h_prev: _atypes.TensorFuzzingAnnotation[TV_GRUBlockCell_T], w_ru: _atypes.TensorFuzzingAnnotation[TV_GRUBlockCell_T], w_c: _atypes.TensorFuzzingAnnotation[TV_GRUBlockCell_T], b_ru: _atypes.TensorFuzzingAnnotation[TV_GRUBlockCell_T], b_c: _atypes.TensorFuzzingAnnotation[TV_GRUBlockCell_T], name, ctx):
