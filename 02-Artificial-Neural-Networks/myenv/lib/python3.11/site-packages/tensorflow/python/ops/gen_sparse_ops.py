...
TV_AddManySparseToTensorsMap_T = TypeVar("TV_AddManySparseToTensorsMap_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def add_many_sparse_to_tensors_map_eager_fallback(sparse_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sparse_values: _atypes.TensorFuzzingAnnotation[TV_AddManySparseToTensorsMap_T], sparse_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], container: str, shared_name: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
  if container is None:
    container = ""
  container = _execute.make_str(container, "container")
  if shared_name is None:
...
TV_AddSparseToTensorsMap_T = TypeVar("TV_AddSparseToTensorsMap_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def deserialize_many_sparse(serialized_sparse: _atypes.TensorFuzzingAnnotation[_atypes.String], dtype: TV_DeserializeManySparse_dtype, name=None):
...
def deserialize_many_sparse_eager_fallback(serialized_sparse: _atypes.TensorFuzzingAnnotation[_atypes.String], dtype: TV_DeserializeManySparse_dtype, name, ctx):
  dtype = _execute.make_type(dtype, "dtype")
...
TV_DeserializeSparse_dtype = TypeVar("TV_DeserializeSparse_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
TV_DeserializeSparse_Tserialized = TypeVar("TV_DeserializeSparse_Tserialized", _atypes.String, _atypes.Variant)

def deserialize_sparse(serialized_sparse: _atypes.TensorFuzzingAnnotation[TV_DeserializeSparse_Tserialized], dtype: TV_DeserializeSparse_dtype, name=None):
...
def deserialize_sparse_eager_fallback(serialized_sparse: _atypes.TensorFuzzingAnnotation[TV_DeserializeSparse_Tserialized], dtype: TV_DeserializeSparse_dtype, name, ctx):
  dtype = _execute.make_type(dtype, "dtype")
...
def serialize_many_sparse(sparse_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sparse_values: _atypes.TensorFuzzingAnnotation[TV_SerializeManySparse_T], sparse_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], out_type:TV_SerializeManySparse_out_type=_dtypes.string, name=None) -> _atypes.TensorFuzzingAnnotation[TV_SerializeManySparse_out_type]:
...
TV_SerializeSparse_T = TypeVar("TV_SerializeSparse_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
TV_SerializeSparse_out_type = TypeVar("TV_SerializeSparse_out_type", _atypes.String, _atypes.Variant)

def serialize_sparse(sparse_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sparse_values: _atypes.TensorFuzzingAnnotation[TV_SerializeSparse_T], sparse_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], out_type:TV_SerializeSparse_out_type=_dtypes.string, name=None) -> _atypes.TensorFuzzingAnnotation[TV_SerializeSparse_out_type]:
...
def serialize_sparse_eager_fallback(sparse_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sparse_values: _atypes.TensorFuzzingAnnotation[TV_SerializeSparse_T], sparse_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], out_type: TV_SerializeSparse_out_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SerializeSparse_out_type]:
  if out_type is None:
    out_type = _dtypes.string
  out_type = _execute.make_type(out_type, "out_type")
  _attr_T, (sparse_values,) = _execute.args_to_matching_eager([sparse_values], ctx, [])
...
def sparse_add(a_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], a_values: _atypes.TensorFuzzingAnnotation[TV_SparseAdd_T], a_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], b_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], b_values: _atypes.TensorFuzzingAnnotation[TV_SparseAdd_T], b_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], thresh: _atypes.TensorFuzzingAnnotation[TV_SparseAdd_Treal], name=None):
...
TV_SparseConcat_T = TypeVar("TV_SparseConcat_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def sparse_concat(indices: List[_atypes.TensorFuzzingAnnotation[_atypes.Int64]], values: List[_atypes.TensorFuzzingAnnotation[TV_SparseConcat_T]], shapes: List[_atypes.TensorFuzzingAnnotation[_atypes.Int64]], concat_dim: int, name=None):
...
def sparse_cross(indices: List[_atypes.TensorFuzzingAnnotation[_atypes.Int64]], values, shapes: List[_atypes.TensorFuzzingAnnotation[_atypes.Int64]], dense_inputs, hashed_output: bool, num_buckets: int, hash_key: int, out_type: TV_SparseCross_out_type, internal_type: TV_SparseCross_internal_type, name=None):
...
def sparse_cross_hashed(indices: List[_atypes.TensorFuzzingAnnotation[_atypes.Int64]], values, shapes: List[_atypes.TensorFuzzingAnnotation[_atypes.Int64]], dense_inputs, num_buckets: _atypes.TensorFuzzingAnnotation[_atypes.Int64], strong_hash: _atypes.TensorFuzzingAnnotation[_atypes.Bool], salt: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name=None):
  r"""Generates sparse cross from a list of sparse and dense tensors.
...
def sparse_dense_cwise_add(sp_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sp_values: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseAdd_T], sp_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], dense: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseAdd_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseAdd_T]:
...
def sparse_dense_cwise_add_eager_fallback(sp_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sp_values: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseAdd_T], sp_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], dense: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseAdd_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseAdd_T]:
...
def sparse_dense_cwise_div(sp_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sp_values: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseDiv_T], sp_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], dense: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseDiv_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseDiv_T]:
...
def sparse_dense_cwise_div_eager_fallback(sp_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sp_values: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseDiv_T], sp_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], dense: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseDiv_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseDiv_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([sp_values, dense], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  (sp_values, dense) = _inputs_T
  sp_indices = _ops.convert_to_tensor(sp_indices, _dtypes.int64)
  sp_shape = _ops.convert_to_tensor(sp_shape, _dtypes.int64)
...
def sparse_dense_cwise_mul(sp_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sp_values: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseMul_T], sp_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], dense: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseMul_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseMul_T]:
...
def sparse_dense_cwise_mul_eager_fallback(sp_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sp_values: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseMul_T], sp_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], dense: _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseMul_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseDenseCwiseMul_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([sp_values, dense], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  (sp_values, dense) = _inputs_T
  sp_indices = _ops.convert_to_tensor(sp_indices, _dtypes.int64)
  sp_shape = _ops.convert_to_tensor(sp_shape, _dtypes.int64)
...
TV_SparseFillEmptyRows_T = TypeVar("TV_SparseFillEmptyRows_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def sparse_fill_empty_rows(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_SparseFillEmptyRows_T], dense_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], default_value: _atypes.TensorFuzzingAnnotation[TV_SparseFillEmptyRows_T], name=None):
...
TV_SparseFillEmptyRowsGrad_T = TypeVar("TV_SparseFillEmptyRowsGrad_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def sparse_reduce_max(input_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], input_values: _atypes.TensorFuzzingAnnotation[TV_SparseReduceMax_T], input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], reduction_axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], keep_dims:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseReduceMax_T]:
...
def sparse_reduce_max_sparse(input_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], input_values: _atypes.TensorFuzzingAnnotation[TV_SparseReduceMaxSparse_T], input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], reduction_axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], keep_dims:bool=False, name=None):
  r"""Computes the max of elements across dimensions of a SparseTensor.
...
def sparse_reduce_max_sparse_eager_fallback(input_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], input_values: _atypes.TensorFuzzingAnnotation[TV_SparseReduceMaxSparse_T], input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], reduction_axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], keep_dims: bool, name, ctx):
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
  _attr_T, (input_values,) = _execute.args_to_matching_eager([input_values], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
...
def sparse_reduce_sum(input_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], input_values: _atypes.TensorFuzzingAnnotation[TV_SparseReduceSum_T], input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], reduction_axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], keep_dims:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseReduceSum_T]:
...
def sparse_reduce_sum_eager_fallback(input_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], input_values: _atypes.TensorFuzzingAnnotation[TV_SparseReduceSum_T], input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], reduction_axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], keep_dims: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseReduceSum_T]:
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
...
def sparse_reduce_sum_sparse(input_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], input_values: _atypes.TensorFuzzingAnnotation[TV_SparseReduceSumSparse_T], input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], reduction_axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], keep_dims:bool=False, name=None):
  r"""Computes the sum of elements across dimensions of a SparseTensor.
...
def sparse_reduce_sum_sparse_eager_fallback(input_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], input_values: _atypes.TensorFuzzingAnnotation[TV_SparseReduceSumSparse_T], input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], reduction_axes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], keep_dims: bool, name, ctx):
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
  _attr_T, (input_values,) = _execute.args_to_matching_eager([input_values], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
...
def sparse_reorder(input_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], input_values: _atypes.TensorFuzzingAnnotation[TV_SparseReorder_T], input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name=None):
...
def sparse_reorder_eager_fallback(input_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], input_values: _atypes.TensorFuzzingAnnotation[TV_SparseReorder_T], input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx):
...
def sparse_reshape(input_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], new_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name=None):
...
TV_SparseSlice_T = TypeVar("TV_SparseSlice_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def sparse_slice(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_SparseSlice_T], shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], start: _atypes.TensorFuzzingAnnotation[_atypes.Int64], size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name=None):
...
def sparse_softmax(sp_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sp_values: _atypes.TensorFuzzingAnnotation[TV_SparseSoftmax_T], sp_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseSoftmax_T]:
...
def sparse_softmax_eager_fallback(sp_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], sp_values: _atypes.TensorFuzzingAnnotation[TV_SparseSoftmax_T], sp_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseSoftmax_T]:
...
def sparse_sparse_maximum(a_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], a_values: _atypes.TensorFuzzingAnnotation[TV_SparseSparseMaximum_T], a_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], b_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], b_values: _atypes.TensorFuzzingAnnotation[TV_SparseSparseMaximum_T], b_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name=None):
...
def sparse_sparse_maximum_eager_fallback(a_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], a_values: _atypes.TensorFuzzingAnnotation[TV_SparseSparseMaximum_T], a_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], b_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], b_values: _atypes.TensorFuzzingAnnotation[TV_SparseSparseMaximum_T], b_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx):
...
def sparse_sparse_minimum_eager_fallback(a_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], a_values: _atypes.TensorFuzzingAnnotation[TV_SparseSparseMinimum_T], a_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], b_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], b_values: _atypes.TensorFuzzingAnnotation[TV_SparseSparseMinimum_T], b_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([a_values, b_values], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  (a_values, b_values) = _inputs_T
  a_indices = _ops.convert_to_tensor(a_indices, _dtypes.int64)
  a_shape = _ops.convert_to_tensor(a_shape, _dtypes.int64)
...
TV_SparseSplit_T = TypeVar("TV_SparseSplit_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def sparse_split(split_dim: _atypes.TensorFuzzingAnnotation[_atypes.Int64], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_SparseSplit_T], shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_split: int, name=None):
...
def sparse_tensor_dense_add(a_indices: _atypes.TensorFuzzingAnnotation[TV_SparseTensorDenseAdd_Tindices], a_values: _atypes.TensorFuzzingAnnotation[TV_SparseTensorDenseAdd_T], a_shape: _atypes.TensorFuzzingAnnotation[TV_SparseTensorDenseAdd_Tindices], b: _atypes.TensorFuzzingAnnotation[TV_SparseTensorDenseAdd_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseTensorDenseAdd_T]:
...
def sparse_tensor_dense_add_eager_fallback(a_indices: _atypes.TensorFuzzingAnnotation[TV_SparseTensorDenseAdd_Tindices], a_values: _atypes.TensorFuzzingAnnotation[TV_SparseTensorDenseAdd_T], a_shape: _atypes.TensorFuzzingAnnotation[TV_SparseTensorDenseAdd_Tindices], b: _atypes.TensorFuzzingAnnotation[TV_SparseTensorDenseAdd_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseTensorDenseAdd_T]:
...
TV_SparseTensorDenseMatMul_T = TypeVar("TV_SparseTensorDenseMatMul_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def sparse_to_dense(sparse_indices: _atypes.TensorFuzzingAnnotation[TV_SparseToDense_Tindices], output_shape: _atypes.TensorFuzzingAnnotation[TV_SparseToDense_Tindices], sparse_values: _atypes.TensorFuzzingAnnotation[TV_SparseToDense_T], default_value: _atypes.TensorFuzzingAnnotation[TV_SparseToDense_T], validate_indices:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseToDense_T]:
...
TV_TakeManySparseFromTensorsMap_dtype = TypeVar("TV_TakeManySparseFromTensorsMap_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
