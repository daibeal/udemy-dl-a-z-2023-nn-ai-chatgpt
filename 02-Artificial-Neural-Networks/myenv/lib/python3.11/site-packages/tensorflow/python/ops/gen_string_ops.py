...
def decode_base64_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def reduce_join(inputs: _atypes.TensorFuzzingAnnotation[_atypes.String], reduction_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int32], keep_dims:bool=False, separator:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def regex_full_match_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], pattern: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  input = _ops.convert_to_tensor(input, _dtypes.string)
...
def static_regex_full_match(input: _atypes.TensorFuzzingAnnotation[_atypes.String], pattern: str, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  r"""Check if the input matches the regex pattern.
...
def static_regex_full_match_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], pattern: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  pattern = _execute.make_str(pattern, "pattern")
  input = _ops.convert_to_tensor(input, _dtypes.string)
  _inputs_flat = [input]
...
def string_format(inputs, template:str="%s", placeholder:str="%s", summarize:int=3, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def string_join(inputs: List[_atypes.TensorFuzzingAnnotation[_atypes.String]], separator:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def string_join_eager_fallback(inputs: List[_atypes.TensorFuzzingAnnotation[_atypes.String]], separator: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  if not isinstance(inputs, (list, tuple)):
    raise TypeError(
        "Expected list for 'inputs' argument to "
        "'string_join' Op, not %r." % inputs)
...
def string_length_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], unit: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  if unit is None:
    unit = "BYTE"
  unit = _execute.make_str(unit, "unit")
  input = _ops.convert_to_tensor(input, _dtypes.string)
...
def string_lower_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], encoding: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  if encoding is None:
    encoding = ""
  encoding = _execute.make_str(encoding, "encoding")
  input = _ops.convert_to_tensor(input, _dtypes.string)
...
def string_split(input: _atypes.TensorFuzzingAnnotation[_atypes.String], delimiter: _atypes.TensorFuzzingAnnotation[_atypes.String], skip_empty:bool=True, name=None):
...
def string_split_v2(input: _atypes.TensorFuzzingAnnotation[_atypes.String], sep: _atypes.TensorFuzzingAnnotation[_atypes.String], maxsplit:int=-1, name=None):
...
def string_split_v2_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], sep: _atypes.TensorFuzzingAnnotation[_atypes.String], maxsplit: int, name, ctx):
  if maxsplit is None:
    maxsplit = -1
  maxsplit = _execute.make_int(maxsplit, "maxsplit")
  input = _ops.convert_to_tensor(input, _dtypes.string)
...
def string_strip(input: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def string_strip_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  input = _ops.convert_to_tensor(input, _dtypes.string)
  _inputs_flat = [input]
  _attrs = None
...
def string_to_hash_bucket_fast_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], num_buckets: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
  num_buckets = _execute.make_int(num_buckets, "num_buckets")
  input = _ops.convert_to_tensor(input, _dtypes.string)
  _inputs_flat = [input]
  _attrs = ("num_buckets", num_buckets)
...
def string_upper(input: _atypes.TensorFuzzingAnnotation[_atypes.String], encoding:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def string_upper_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], encoding: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  if encoding is None:
    encoding = ""
  encoding = _execute.make_str(encoding, "encoding")
  input = _ops.convert_to_tensor(input, _dtypes.string)
...
def substr_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], pos: _atypes.TensorFuzzingAnnotation[TV_Substr_T], len: _atypes.TensorFuzzingAnnotation[TV_Substr_T], unit: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  if unit is None:
    unit = "BYTE"
  unit = _execute.make_str(unit, "unit")
...
def unicode_decode(input: _atypes.TensorFuzzingAnnotation[_atypes.String], input_encoding: str, errors:str="replace", replacement_char:int=65533, replace_control_characters:bool=False, Tsplits:TV_UnicodeDecode_Tsplits=_dtypes.int64, name=None):
...
def unicode_decode_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], input_encoding: str, errors: str, replacement_char: int, replace_control_characters: bool, Tsplits: TV_UnicodeDecode_Tsplits, name, ctx):
  input_encoding = _execute.make_str(input_encoding, "input_encoding")
  if errors is None:
    errors = "replace"
  errors = _execute.make_str(errors, "errors")
...
def unicode_decode_with_offsets(input: _atypes.TensorFuzzingAnnotation[_atypes.String], input_encoding: str, errors:str="replace", replacement_char:int=65533, replace_control_characters:bool=False, Tsplits:TV_UnicodeDecodeWithOffsets_Tsplits=_dtypes.int64, name=None):
  r"""Decodes each string in `input` into a sequence of Unicode code points.
...
def unicode_decode_with_offsets_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], input_encoding: str, errors: str, replacement_char: int, replace_control_characters: bool, Tsplits: TV_UnicodeDecodeWithOffsets_Tsplits, name, ctx):
  input_encoding = _execute.make_str(input_encoding, "input_encoding")
  if errors is None:
    errors = "replace"
  errors = _execute.make_str(errors, "errors")
...
def unicode_encode(input_values: _atypes.TensorFuzzingAnnotation[_atypes.Int32], input_splits: _atypes.TensorFuzzingAnnotation[TV_UnicodeEncode_Tsplits], output_encoding: str, errors:str="replace", replacement_char:int=65533, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
...
def unicode_script(input: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def unicode_script_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def unsorted_segment_join(inputs: _atypes.TensorFuzzingAnnotation[_atypes.String], segment_ids: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentJoin_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentJoin_Tnumsegments], separator:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  r"""TODO: add doc.
