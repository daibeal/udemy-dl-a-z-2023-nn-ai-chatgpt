...
def stateless_random_get_alg(name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def stateless_random_get_alg_eager_fallback(name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  _inputs_flat = []
  _attrs = None
...
def stateless_random_get_key_counter(seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomGetKeyCounter_Tseed], name=None):
...
def stateless_random_get_key_counter_eager_fallback(seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomGetKeyCounter_Tseed], name, ctx):
...
def stateless_random_get_key_counter_alg_eager_fallback(seed: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomGetKeyCounterAlg_Tseed], name, ctx):
  _attr_Tseed, (seed,) = _execute.args_to_matching_eager([seed], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int64)
  _inputs_flat = [seed]
  _attrs = ("Tseed", _attr_Tseed)
...
def stateless_random_normal_v2(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomNormalV2_Tshape], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype:TV_StatelessRandomNormalV2_dtype=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomNormalV2_dtype]:
...
def stateless_random_normal_v2_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomNormalV2_Tshape], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype: TV_StatelessRandomNormalV2_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomNormalV2_dtype]:
  if dtype is None:
    dtype = _dtypes.float32
  dtype = _execute.make_type(dtype, "dtype")
...
def stateless_random_uniform_full_int_v2(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformFullIntV2_Tshape], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype:TV_StatelessRandomUniformFullIntV2_dtype=_dtypes.uint64, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformFullIntV2_dtype]:
...
def stateless_random_uniform_full_int_v2_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformFullIntV2_Tshape], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype: TV_StatelessRandomUniformFullIntV2_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformFullIntV2_dtype]:
  if dtype is None:
    dtype = _dtypes.uint64
  dtype = _execute.make_type(dtype, "dtype")
  _attr_Tshape, (shape,) = _execute.args_to_matching_eager([shape], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
...
def stateless_random_uniform_int_v2(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformIntV2_Tshape], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], minval: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformIntV2_dtype], maxval: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformIntV2_dtype], name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformIntV2_dtype]:
  r"""Outputs deterministic pseudorandom random integers from a uniform distribution.
...
def stateless_random_uniform_int_v2_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformIntV2_Tshape], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], minval: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformIntV2_dtype], maxval: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformIntV2_dtype], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformIntV2_dtype]:
...
def stateless_random_uniform_v2(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformV2_Tshape], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype:TV_StatelessRandomUniformV2_dtype=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformV2_dtype]:
...
def stateless_random_uniform_v2_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformV2_Tshape], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype: TV_StatelessRandomUniformV2_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessRandomUniformV2_dtype]:
  if dtype is None:
    dtype = _dtypes.float32
  dtype = _execute.make_type(dtype, "dtype")
  _attr_Tshape, (shape,) = _execute.args_to_matching_eager([shape], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
...
TV_StatelessShuffle_T = TypeVar("TV_StatelessShuffle_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def stateless_shuffle(value: _atypes.TensorFuzzingAnnotation[TV_StatelessShuffle_T], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None) -> _atypes.TensorFuzzingAnnotation[TV_StatelessShuffle_T]:
...
def stateless_shuffle_eager_fallback(value: _atypes.TensorFuzzingAnnotation[TV_StatelessShuffle_T], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessShuffle_T]:
...
def stateless_truncated_normal_v2_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_StatelessTruncatedNormalV2_Tshape], key: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], counter: _atypes.TensorFuzzingAnnotation[_atypes.UInt64], alg: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype: TV_StatelessTruncatedNormalV2_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_StatelessTruncatedNormalV2_dtype]:
  if dtype is None:
    dtype = _dtypes.float32
  dtype = _execute.make_type(dtype, "dtype")
  _attr_Tshape, (shape,) = _execute.args_to_matching_eager([shape], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
