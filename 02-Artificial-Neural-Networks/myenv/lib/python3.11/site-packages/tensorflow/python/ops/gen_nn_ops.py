...
def avg_pool(value: _atypes.TensorFuzzingAnnotation[TV_AvgPool_T], ksize, strides, padding: str, data_format:str="NHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_AvgPool_T]:
...
def avg_pool_eager_fallback(value: _atypes.TensorFuzzingAnnotation[TV_AvgPool_T], ksize, strides, padding: str, data_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_AvgPool_T]:
  if not isinstance(ksize, (list, tuple)):
    raise TypeError(
        "Expected list for 'ksize' argument to "
        "'avg_pool' Op, not %r." % ksize)
...
def avg_pool3d(input: _atypes.TensorFuzzingAnnotation[TV_AvgPool3D_T], ksize, strides, padding: str, data_format:str="NDHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_AvgPool3D_T]:
...
def avg_pool3d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_AvgPool3D_T], ksize, strides, padding: str, data_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_AvgPool3D_T]:
  if not isinstance(ksize, (list, tuple)):
    raise TypeError(
        "Expected list for 'ksize' argument to "
        "'avg_pool3d' Op, not %r." % ksize)
...
def avg_pool3d_grad(orig_input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int32], grad: _atypes.TensorFuzzingAnnotation[TV_AvgPool3DGrad_T], ksize, strides, padding: str, data_format:str="NDHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_AvgPool3DGrad_T]:
...
def avg_pool_grad_eager_fallback(orig_input_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int32], grad: _atypes.TensorFuzzingAnnotation[TV_AvgPoolGrad_T], ksize, strides, padding: str, data_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_AvgPoolGrad_T]:
  if not isinstance(ksize, (list, tuple)):
    raise TypeError(
        "Expected list for 'ksize' argument to "
        "'avg_pool_grad' Op, not %r." % ksize)
...
def _batch_norm_with_global_normalization(t: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T], m: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T], v: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T], beta: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T], gamma: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T], variance_epsilon: float, scale_after_normalization: bool, name=None) -> _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T]:
...
def _batch_norm_with_global_normalization_eager_fallback(t: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T], m: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T], v: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T], beta: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T], gamma: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T], variance_epsilon: float, scale_after_normalization: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalization_T]:
  variance_epsilon = _execute.make_float(variance_epsilon, "variance_epsilon")
  scale_after_normalization = _execute.make_bool(scale_after_normalization, "scale_after_normalization")
...
def batch_norm_with_global_normalization_grad_eager_fallback(t: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalizationGrad_T], m: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalizationGrad_T], v: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalizationGrad_T], gamma: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalizationGrad_T], backprop: _atypes.TensorFuzzingAnnotation[TV_BatchNormWithGlobalNormalizationGrad_T], variance_epsilon: float, scale_after_normalization: bool, name, ctx):
  variance_epsilon = _execute.make_float(variance_epsilon, "variance_epsilon")
  scale_after_normalization = _execute.make_bool(scale_after_normalization, "scale_after_normalization")
...
def bias_add(value: _atypes.TensorFuzzingAnnotation[TV_BiasAdd_T], bias: _atypes.TensorFuzzingAnnotation[TV_BiasAdd_T], data_format:str="NHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_BiasAdd_T]:
...
def bias_add_eager_fallback(value: _atypes.TensorFuzzingAnnotation[TV_BiasAdd_T], bias: _atypes.TensorFuzzingAnnotation[TV_BiasAdd_T], data_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BiasAdd_T]:
  if data_format is None:
    data_format = "NHWC"
  data_format = _execute.make_str(data_format, "data_format")
...
def bias_add_v1_eager_fallback(value: _atypes.TensorFuzzingAnnotation[TV_BiasAddV1_T], bias: _atypes.TensorFuzzingAnnotation[TV_BiasAddV1_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BiasAddV1_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([value, bias], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  (value, bias) = _inputs_T
  _inputs_flat = [value, bias]
  _attrs = ("T", _attr_T)
...
@_dispatch.add_type_based_api_dispatcher
@tf_export('conv')
def conv(input: _atypes.TensorFuzzingAnnotation[TV_Conv_T], filter: _atypes.TensorFuzzingAnnotation[TV_Conv_T], strides, padding: str, explicit_paddings=[], data_format:str="CHANNELS_LAST", dilations=[], batch_dims:int=1, groups:int=1, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Conv_T]:
...
def conv2d(input: _atypes.TensorFuzzingAnnotation[TV_Conv2D_T], filter: _atypes.TensorFuzzingAnnotation[TV_Conv2D_T], strides, padding: str, use_cudnn_on_gpu:bool=True, explicit_paddings=[], data_format:str="NHWC", dilations=[1, 1, 1, 1], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Conv2D_T]:
...
def conv2d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Conv2D_T], filter: _atypes.TensorFuzzingAnnotation[TV_Conv2D_T], strides, padding: str, use_cudnn_on_gpu: bool, explicit_paddings, data_format: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Conv2D_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'conv2d' Op, not %r." % strides)
...
def conv2d_backprop_filter(input: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropFilter_T], filter_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropFilter_T], strides, padding: str, use_cudnn_on_gpu:bool=True, explicit_paddings=[], data_format:str="NHWC", dilations=[1, 1, 1, 1], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropFilter_T]:
...
def conv2d_backprop_filter_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropFilter_T], filter_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropFilter_T], strides, padding: str, use_cudnn_on_gpu: bool, explicit_paddings, data_format: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropFilter_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'conv2d_backprop_filter' Op, not %r." % strides)
...
def conv2d_backprop_input(input_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], filter: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInput_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInput_T], strides, padding: str, use_cudnn_on_gpu:bool=True, explicit_paddings=[], data_format:str="NHWC", dilations=[1, 1, 1, 1], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInput_T]:
...
def conv2d_backprop_input_eager_fallback(input_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], filter: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInput_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInput_T], strides, padding: str, use_cudnn_on_gpu: bool, explicit_paddings, data_format: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInput_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'conv2d_backprop_input' Op, not %r." % strides)
...
def conv2d_backprop_input_v2(input: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInputV2_T], filter: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInputV2_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInputV2_T], strides, padding: str, use_cudnn_on_gpu:bool=True, explicit_paddings=[], data_format:str="NHWC", dilations=[1, 1, 1, 1], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInputV2_T]:
  r"""Computes the gradients of convolution with respect to the input.
...
def conv2d_backprop_input_v2_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInputV2_T], filter: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInputV2_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInputV2_T], strides, padding: str, use_cudnn_on_gpu: bool, explicit_paddings, data_format: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Conv2DBackpropInputV2_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'conv2d_backprop_input_v2' Op, not %r." % strides)
...
def conv3d(input: _atypes.TensorFuzzingAnnotation[TV_Conv3D_T], filter: _atypes.TensorFuzzingAnnotation[TV_Conv3D_T], strides, padding: str, data_format:str="NDHWC", dilations=[1, 1, 1, 1, 1], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Conv3D_T]:
...
def conv3d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Conv3D_T], filter: _atypes.TensorFuzzingAnnotation[TV_Conv3D_T], strides, padding: str, data_format: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Conv3D_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'conv3d' Op, not %r." % strides)
...
def conv3d_backprop_filter_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropFilter_T], filter: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropFilter_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropFilter_T], strides, padding: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropFilter_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'conv3d_backprop_filter' Op, not %r." % strides)
...
def conv3d_backprop_filter_v2(input: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropFilterV2_T], filter_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropFilterV2_T], strides, padding: str, data_format:str="NDHWC", dilations=[1, 1, 1, 1, 1], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropFilterV2_T]:
  r"""Computes the gradients of 3-D convolution with respect to the filter.
...
def conv3d_backprop_filter_v2_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropFilterV2_T], filter_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropFilterV2_T], strides, padding: str, data_format: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropFilterV2_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'conv3d_backprop_filter_v2' Op, not %r." % strides)
...
def conv3d_backprop_input(input: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInput_T], filter: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInput_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInput_T], strides, padding: str, dilations=[1, 1, 1, 1, 1], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInput_T]:
...
def conv3d_backprop_input_v2_eager_fallback(input_sizes: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInputV2_Tshape], filter: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInputV2_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInputV2_T], strides, padding: str, data_format: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Conv3DBackpropInputV2_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'conv3d_backprop_input_v2' Op, not %r." % strides)
...
def data_format_vec_permute(x: _atypes.TensorFuzzingAnnotation[TV_DataFormatVecPermute_T], src_format:str="NHWC", dst_format:str="NCHW", name=None) -> _atypes.TensorFuzzingAnnotation[TV_DataFormatVecPermute_T]:
...
def data_format_vec_permute_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_DataFormatVecPermute_T], src_format: str, dst_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_DataFormatVecPermute_T]:
  if src_format is None:
    src_format = "NHWC"
  src_format = _execute.make_str(src_format, "src_format")
  if dst_format is None:
...
def depthwise_conv2d_native_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNative_T], filter: _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNative_T], strides, padding: str, explicit_paddings, data_format: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNative_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'depthwise_conv2d_native' Op, not %r." % strides)
...
def depthwise_conv2d_native_backprop_filter(input: _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNativeBackpropFilter_T], filter_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], out_backprop: _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNativeBackpropFilter_T], strides, padding: str, explicit_paddings=[], data_format:str="NHWC", dilations=[1, 1, 1, 1], name=None) -> _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNativeBackpropFilter_T]:
...
def depthwise_conv2d_native_backprop_input(input_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], filter: _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNativeBackpropInput_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNativeBackpropInput_T], strides, padding: str, explicit_paddings=[], data_format:str="NHWC", dilations=[1, 1, 1, 1], name=None) -> _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNativeBackpropInput_T]:
...
def depthwise_conv2d_native_backprop_input_eager_fallback(input_sizes: _atypes.TensorFuzzingAnnotation[_atypes.Int32], filter: _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNativeBackpropInput_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNativeBackpropInput_T], strides, padding: str, explicit_paddings, data_format: str, dilations, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_DepthwiseConv2dNativeBackpropInput_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'depthwise_conv2d_native_backprop_input' Op, not %r." % strides)
...
def dilation2d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Dilation2D_T], filter: _atypes.TensorFuzzingAnnotation[TV_Dilation2D_T], strides, rates, padding: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Dilation2D_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'dilation2d' Op, not %r." % strides)
...
def dilation2d_backprop_filter_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Dilation2DBackpropFilter_T], filter: _atypes.TensorFuzzingAnnotation[TV_Dilation2DBackpropFilter_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Dilation2DBackpropFilter_T], strides, rates, padding: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Dilation2DBackpropFilter_T]:
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'dilation2d_backprop_filter' Op, not %r." % strides)
...
def dilation2d_backprop_input(input: _atypes.TensorFuzzingAnnotation[TV_Dilation2DBackpropInput_T], filter: _atypes.TensorFuzzingAnnotation[TV_Dilation2DBackpropInput_T], out_backprop: _atypes.TensorFuzzingAnnotation[TV_Dilation2DBackpropInput_T], strides, rates, padding: str, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Dilation2DBackpropInput_T]:
...
def elu_eager_fallback(features: _atypes.TensorFuzzingAnnotation[TV_Elu_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Elu_T]:
...
def elu_grad(gradients: _atypes.TensorFuzzingAnnotation[TV_EluGrad_T], outputs: _atypes.TensorFuzzingAnnotation[TV_EluGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_EluGrad_T]:
...
def fractional_avg_pool(value: _atypes.TensorFuzzingAnnotation[TV_FractionalAvgPool_T], pooling_ratio, pseudo_random:bool=False, overlapping:bool=False, deterministic:bool=False, seed:int=0, seed2:int=0, name=None):
...
def fractional_avg_pool_eager_fallback(value: _atypes.TensorFuzzingAnnotation[TV_FractionalAvgPool_T], pooling_ratio, pseudo_random: bool, overlapping: bool, deterministic: bool, seed: int, seed2: int, name, ctx):
  if not isinstance(pooling_ratio, (list, tuple)):
    raise TypeError(
        "Expected list for 'pooling_ratio' argument to "
        "'fractional_avg_pool' Op, not %r." % pooling_ratio)
...
def fractional_max_pool_eager_fallback(value: _atypes.TensorFuzzingAnnotation[TV_FractionalMaxPool_T], pooling_ratio, pseudo_random: bool, overlapping: bool, deterministic: bool, seed: int, seed2: int, name, ctx):
  if not isinstance(pooling_ratio, (list, tuple)):
    raise TypeError(
        "Expected list for 'pooling_ratio' argument to "
        "'fractional_max_pool' Op, not %r." % pooling_ratio)
...
def _fused_batch_norm(x: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNorm_T], scale: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNorm_T], offset: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNorm_T], mean: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNorm_T], variance: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNorm_T], epsilon:float=0.0001, exponential_avg_factor:float=1, data_format:str="NHWC", is_training:bool=True, name=None):
  r"""Batch normalization.
...
def fused_batch_norm_grad_v2(y_backprop: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_T], x: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_T], scale: _atypes.TensorFuzzingAnnotation[_atypes.Float32], reserve_space_1: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_U], reserve_space_2: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_U], epsilon:float=0.0001, data_format:str="NHWC", is_training:bool=True, name=None):
  r"""Gradient for batch normalization.
...
def fused_batch_norm_grad_v2_eager_fallback(y_backprop: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_T], x: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_T], scale: _atypes.TensorFuzzingAnnotation[_atypes.Float32], reserve_space_1: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_U], reserve_space_2: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV2_U], epsilon: float, data_format: str, is_training: bool, name, ctx):
  if epsilon is None:
    epsilon = 0.0001
  epsilon = _execute.make_float(epsilon, "epsilon")
  if data_format is None:
...
def fused_batch_norm_grad_v3(y_backprop: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV3_T], x: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV3_T], scale: _atypes.TensorFuzzingAnnotation[_atypes.Float32], reserve_space_1: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV3_U], reserve_space_2: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV3_U], reserve_space_3: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV3_U], epsilon:float=0.0001, data_format:str="NHWC", is_training:bool=True, name=None):
  r"""Gradient for batch normalization.
...
def fused_batch_norm_grad_v3_eager_fallback(y_backprop: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV3_T], x: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV3_T], scale: _atypes.TensorFuzzingAnnotation[_atypes.Float32], reserve_space_1: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV3_U], reserve_space_2: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV3_U], reserve_space_3: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormGradV3_U], epsilon: float, data_format: str, is_training: bool, name, ctx):
  if epsilon is None:
    epsilon = 0.0001
  epsilon = _execute.make_float(epsilon, "epsilon")
  if data_format is None:
...
def fused_batch_norm_v2_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV2_T], scale: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV2_U], offset: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV2_U], mean: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV2_U], variance: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV2_U], epsilon: float, exponential_avg_factor: float, data_format: str, is_training: bool, name, ctx):
  if epsilon is None:
    epsilon = 0.0001
  epsilon = _execute.make_float(epsilon, "epsilon")
  if exponential_avg_factor is None:
...
def fused_batch_norm_v3(x: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV3_T], scale: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV3_U], offset: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV3_U], mean: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV3_U], variance: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV3_U], epsilon:float=0.0001, exponential_avg_factor:float=1, data_format:str="NHWC", is_training:bool=True, name=None):
  r"""Batch normalization.
...
def fused_batch_norm_v3_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV3_T], scale: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV3_U], offset: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV3_U], mean: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV3_U], variance: _atypes.TensorFuzzingAnnotation[TV_FusedBatchNormV3_U], epsilon: float, exponential_avg_factor: float, data_format: str, is_training: bool, name, ctx):
  if epsilon is None:
    epsilon = 0.0001
  epsilon = _execute.make_float(epsilon, "epsilon")
  if exponential_avg_factor is None:
...
def fused_resize_and_pad_conv2d(input: _atypes.TensorFuzzingAnnotation[TV_FusedResizeAndPadConv2D_T], size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], paddings: _atypes.TensorFuzzingAnnotation[_atypes.Int32], filter: _atypes.TensorFuzzingAnnotation[TV_FusedResizeAndPadConv2D_T], mode: str, strides, padding: str, resize_align_corners:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_FusedResizeAndPadConv2D_T]:
...
def in_top_k(predictions: _atypes.TensorFuzzingAnnotation[_atypes.Float32], targets: _atypes.TensorFuzzingAnnotation[TV_InTopK_T], k: int, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def in_top_kv2_eager_fallback(predictions: _atypes.TensorFuzzingAnnotation[_atypes.Float32], targets: _atypes.TensorFuzzingAnnotation[TV_InTopKV2_T], k: _atypes.TensorFuzzingAnnotation[TV_InTopKV2_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def isotonic_regression(input: _atypes.TensorFuzzingAnnotation[TV_IsotonicRegression_T], output_dtype:TV_IsotonicRegression_output_dtype=_dtypes.float32, name=None):
...
def l2_loss_eager_fallback(t: _atypes.TensorFuzzingAnnotation[TV_L2Loss_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_L2Loss_T]:
...
def lrn_grad_eager_fallback(input_grads: _atypes.TensorFuzzingAnnotation[TV_LRNGrad_T], input_image: _atypes.TensorFuzzingAnnotation[TV_LRNGrad_T], output_image: _atypes.TensorFuzzingAnnotation[TV_LRNGrad_T], depth_radius: int, bias: float, alpha: float, beta: float, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_LRNGrad_T]:
  if depth_radius is None:
    depth_radius = 5
  depth_radius = _execute.make_int(depth_radius, "depth_radius")
  if bias is None:
...
def leaky_relu_eager_fallback(features: _atypes.TensorFuzzingAnnotation[TV_LeakyRelu_T], alpha: float, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_LeakyRelu_T]:
  if alpha is None:
    alpha = 0.2
  alpha = _execute.make_float(alpha, "alpha")
...
def leaky_relu_grad(gradients: _atypes.TensorFuzzingAnnotation[TV_LeakyReluGrad_T], features: _atypes.TensorFuzzingAnnotation[TV_LeakyReluGrad_T], alpha:float=0.2, name=None) -> _atypes.TensorFuzzingAnnotation[TV_LeakyReluGrad_T]:
...
def leaky_relu_grad_eager_fallback(gradients: _atypes.TensorFuzzingAnnotation[TV_LeakyReluGrad_T], features: _atypes.TensorFuzzingAnnotation[TV_LeakyReluGrad_T], alpha: float, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_LeakyReluGrad_T]:
  if alpha is None:
    alpha = 0.2
  alpha = _execute.make_float(alpha, "alpha")
...
def log_softmax_eager_fallback(logits: _atypes.TensorFuzzingAnnotation[TV_LogSoftmax_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_LogSoftmax_T]:
...
def max_pool(input: _atypes.TensorFuzzingAnnotation[TV_MaxPool_T], ksize, strides, padding: str, explicit_paddings=[], data_format:str="NHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_MaxPool_T]:
...
def max_pool3d(input: _atypes.TensorFuzzingAnnotation[TV_MaxPool3D_T], ksize, strides, padding: str, data_format:str="NDHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_MaxPool3D_T]:
...
def max_pool3d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_MaxPool3D_T], ksize, strides, padding: str, data_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MaxPool3D_T]:
  if not isinstance(ksize, (list, tuple)):
    raise TypeError(
        "Expected list for 'ksize' argument to "
        "'max_pool3d' Op, not %r." % ksize)
...
def max_pool3d_grad_grad(orig_input: _atypes.TensorFuzzingAnnotation[TV_MaxPool3DGradGrad_T], orig_output: _atypes.TensorFuzzingAnnotation[TV_MaxPool3DGradGrad_T], grad: _atypes.TensorFuzzingAnnotation[TV_MaxPool3DGradGrad_T], ksize, strides, padding: str, data_format:str="NDHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_MaxPool3DGradGrad_T]:
...
def max_pool_grad_eager_fallback(orig_input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGrad_T], orig_output: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGrad_T], grad: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGrad_T], ksize, strides, padding: str, explicit_paddings, data_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolGrad_T]:
  if not isinstance(ksize, (list, tuple)):
    raise TypeError(
        "Expected list for 'ksize' argument to "
        "'max_pool_grad' Op, not %r." % ksize)
...
def max_pool_grad_grad(orig_input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGrad_T], orig_output: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGrad_T], grad: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGrad_T], ksize, strides, padding: str, data_format:str="NHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGrad_T]:
  r"""Computes second-order gradients of the maxpooling function.
...
def max_pool_grad_grad_eager_fallback(orig_input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGrad_T], orig_output: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGrad_T], grad: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGrad_T], ksize, strides, padding: str, data_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGrad_T]:
  if not isinstance(ksize, (list, tuple)):
    raise TypeError(
        "Expected list for 'ksize' argument to "
        "'max_pool_grad_grad' Op, not %r." % ksize)
...
def max_pool_grad_grad_v2(orig_input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradV2_T], orig_output: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradV2_T], grad: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradV2_T], ksize: _atypes.TensorFuzzingAnnotation[_atypes.Int32], strides: _atypes.TensorFuzzingAnnotation[_atypes.Int32], padding: str, data_format:str="NHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradV2_T]:
  r"""Computes second-order gradients of the maxpooling function.
...
def max_pool_grad_grad_v2_eager_fallback(orig_input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradV2_T], orig_output: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradV2_T], grad: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradV2_T], ksize: _atypes.TensorFuzzingAnnotation[_atypes.Int32], strides: _atypes.TensorFuzzingAnnotation[_atypes.Int32], padding: str, data_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradV2_T]:
  padding = _execute.make_str(padding, "padding")
  if data_format is None:
    data_format = "NHWC"
  data_format = _execute.make_str(data_format, "data_format")
...
def max_pool_grad_grad_with_argmax_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradWithArgmax_T], grad: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradWithArgmax_T], argmax: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradWithArgmax_Targmax], ksize, strides, padding: str, include_batch_in_index: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradGradWithArgmax_T]:
  if not isinstance(ksize, (list, tuple)):
    raise TypeError(
        "Expected list for 'ksize' argument to "
        "'max_pool_grad_grad_with_argmax' Op, not %r." % ksize)
...
def max_pool_grad_v2(orig_input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradV2_T], orig_output: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradV2_T], grad: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradV2_T], ksize: _atypes.TensorFuzzingAnnotation[_atypes.Int32], strides: _atypes.TensorFuzzingAnnotation[_atypes.Int32], padding: str, data_format:str="NHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradV2_T]:
  r"""Computes gradients of the maxpooling function.
...
def max_pool_grad_v2_eager_fallback(orig_input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradV2_T], orig_output: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradV2_T], grad: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradV2_T], ksize: _atypes.TensorFuzzingAnnotation[_atypes.Int32], strides: _atypes.TensorFuzzingAnnotation[_atypes.Int32], padding: str, data_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradV2_T]:
  padding = _execute.make_str(padding, "padding")
  if data_format is None:
    data_format = "NHWC"
  data_format = _execute.make_str(data_format, "data_format")
...
def max_pool_grad_with_argmax(input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradWithArgmax_T], grad: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradWithArgmax_T], argmax: _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradWithArgmax_Targmax], ksize, strides, padding: str, include_batch_in_index:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolGradWithArgmax_T]:
  r"""Computes gradients of the maxpooling function.
...
def max_pool_v2(input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolV2_T], ksize: _atypes.TensorFuzzingAnnotation[_atypes.Int32], strides: _atypes.TensorFuzzingAnnotation[_atypes.Int32], padding: str, data_format:str="NHWC", name=None) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolV2_T]:
  r"""Performs max pooling on the input.
...
def max_pool_v2_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_MaxPoolV2_T], ksize: _atypes.TensorFuzzingAnnotation[_atypes.Int32], strides: _atypes.TensorFuzzingAnnotation[_atypes.Int32], padding: str, data_format: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MaxPoolV2_T]:
  padding = _execute.make_str(padding, "padding")
  if data_format is None:
    data_format = "NHWC"
  data_format = _execute.make_str(data_format, "data_format")
...
def quantized_avg_pool(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedAvgPool_T], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], ksize, strides, padding: str, name=None):
...
def quantized_bias_add_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedBiasAdd_T1], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedBiasAdd_T2], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], out_type: TV_QuantizedBiasAdd_out_type, name, ctx):
  out_type = _execute.make_type(out_type, "out_type")
...
def quantized_conv2d_and_relu(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndRelu_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndRelu_Tfilter], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedConv2DAndRelu_out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  r"""TODO: add doc.
...
def quantized_conv2d_and_relu_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndRelu_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndRelu_Tfilter], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedConv2DAndRelu_out_type, dilations, padding_list, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_conv2d_and_relu' Op, not %r." % strides)
...
def quantized_conv2d_and_relu_and_requantize(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndReluAndRequantize_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndReluAndRequantize_Tfilter], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedConv2DAndReluAndRequantize_out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  r"""TODO: add doc.
...
def quantized_conv2d_and_relu_and_requantize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndReluAndRequantize_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndReluAndRequantize_Tfilter], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedConv2DAndReluAndRequantize_out_type, dilations, padding_list, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_conv2d_and_relu_and_requantize' Op, not %r." % strides)
...
def quantized_conv2d_and_requantize(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndRequantize_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndRequantize_Tfilter], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedConv2DAndRequantize_out_type=_dtypes.qint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  r"""TODO: add doc.
...
def quantized_conv2d_and_requantize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndRequantize_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DAndRequantize_Tfilter], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedConv2DAndRequantize_out_type, dilations, padding_list, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_conv2d_and_requantize' Op, not %r." % strides)
...
def quantized_conv2d_per_channel_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DPerChannel_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DPerChannel_Tfilter], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedConv2DPerChannel_out_type, dilations, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_conv2d_per_channel' Op, not %r." % strides)
...
def quantized_conv2d_with_bias(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBias_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBias_Tfilter], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedConv2DWithBias_out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  r"""TODO: add doc.
...
def quantized_conv2d_with_bias_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBias_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBias_Tfilter], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedConv2DWithBias_out_type, dilations, padding_list, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_conv2d_with_bias' Op, not %r." % strides)
...
def quantized_conv2d_with_bias_and_relu(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndRelu_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndRelu_Tfilter], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedConv2DWithBiasAndRelu_out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  r"""TODO: add doc.
...
def quantized_conv2d_with_bias_and_relu_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndRelu_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndRelu_Tfilter], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedConv2DWithBiasAndRelu_out_type, dilations, padding_list, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_conv2d_with_bias_and_relu' Op, not %r." % strides)
...
def quantized_conv2d_with_bias_and_relu_and_requantize(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndReluAndRequantize_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndReluAndRequantize_Tfilter], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndReluAndRequantize_Tbias], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedConv2DWithBiasAndReluAndRequantize_out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  r"""TODO: add doc.
...
def quantized_conv2d_with_bias_and_relu_and_requantize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndReluAndRequantize_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndReluAndRequantize_Tfilter], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndReluAndRequantize_Tbias], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedConv2DWithBiasAndReluAndRequantize_out_type, dilations, padding_list, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_conv2d_with_bias_and_relu_and_requantize' Op, not %r." % strides)
...
def quantized_conv2d_with_bias_and_requantize(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndRequantize_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndRequantize_Tfilter], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndRequantize_Tbias], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedConv2DWithBiasAndRequantize_out_type=_dtypes.qint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  r"""TODO: add doc.
...
def quantized_conv2d_with_bias_and_requantize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndRequantize_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndRequantize_Tfilter], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasAndRequantize_Tbias], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedConv2DWithBiasAndRequantize_out_type, dilations, padding_list, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_conv2d_with_bias_and_requantize' Op, not %r." % strides)
...
def quantized_conv2d_with_bias_signed_sum_and_relu_and_requantize(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSignedSumAndReluAndRequantize_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSignedSumAndReluAndRequantize_Tfilter], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSignedSumAndReluAndRequantize_Tbias], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], summand: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSignedSumAndReluAndRequantize_Tsummand], min_summand: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_summand: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedConv2DWithBiasSignedSumAndReluAndRequantize_out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  r"""TODO: add doc.
...
def quantized_conv2d_with_bias_signed_sum_and_relu_and_requantize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSignedSumAndReluAndRequantize_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSignedSumAndReluAndRequantize_Tfilter], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSignedSumAndReluAndRequantize_Tbias], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], summand: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSignedSumAndReluAndRequantize_Tsummand], min_summand: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_summand: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedConv2DWithBiasSignedSumAndReluAndRequantize_out_type, dilations, padding_list, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_conv2d_with_bias_signed_sum_and_relu_and_requantize' Op, not %r." % strides)
...
def quantized_conv2d_with_bias_sum_and_relu(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSumAndRelu_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSumAndRelu_Tfilter], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], summand: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedConv2DWithBiasSumAndRelu_out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  r"""TODO: add doc.
...
def quantized_conv2d_with_bias_sum_and_relu_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSumAndRelu_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedConv2DWithBiasSumAndRelu_Tfilter], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], summand: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedConv2DWithBiasSumAndRelu_out_type, dilations, padding_list, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_conv2d_with_bias_sum_and_relu' Op, not %r." % strides)
...
def quantized_depthwise_conv2d(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2D_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2D_Tfilter], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedDepthwiseConv2D_out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
...
def quantized_depthwise_conv2d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2D_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2D_Tfilter], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedDepthwiseConv2D_out_type, dilations, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_depthwise_conv2d' Op, not %r." % strides)
...
def quantized_depthwise_conv2d_with_bias(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2DWithBias_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2DWithBias_Tfilter], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedDepthwiseConv2DWithBias_out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
...
def quantized_depthwise_conv2d_with_bias_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2DWithBias_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2DWithBias_Tfilter], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedDepthwiseConv2DWithBias_out_type, dilations, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_depthwise_conv2d_with_bias' Op, not %r." % strides)
...
def quantized_depthwise_conv2d_with_bias_and_relu(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2DWithBiasAndRelu_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2DWithBiasAndRelu_Tfilter], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type:TV_QuantizedDepthwiseConv2DWithBiasAndRelu_out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
...
def quantized_depthwise_conv2d_with_bias_and_relu_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2DWithBiasAndRelu_Tinput], filter: _atypes.TensorFuzzingAnnotation[TV_QuantizedDepthwiseConv2DWithBiasAndRelu_Tfilter], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_filter: _atypes.TensorFuzzingAnnotation[_atypes.Float32], strides, padding: str, out_type: TV_QuantizedDepthwiseConv2DWithBiasAndRelu_out_type, dilations, padding_list, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_depthwise_conv2d_with_bias_and_relu' Op, not %r." % strides)
...
def quantized_mat_mul_with_bias_and_dequantize_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndDequantize_T1], b: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndDequantize_T2], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndDequantize_Tbias], min_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput: TV_QuantizedMatMulWithBiasAndDequantize_Toutput, transpose_a: bool, transpose_b: bool, input_quant_mode: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndDequantize_Toutput]:
  Toutput = _execute.make_type(Toutput, "Toutput")
  if transpose_a is None:
    transpose_a = False
  transpose_a = _execute.make_bool(transpose_a, "transpose_a")
...
def quantized_mat_mul_with_bias_and_relu(a: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRelu_T1], b: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRelu_T2], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput:TV_QuantizedMatMulWithBiasAndRelu_Toutput=_dtypes.qint32, transpose_a:bool=False, transpose_b:bool=False, input_quant_mode:str="MIN_FIRST", name=None):
...
def quantized_mat_mul_with_bias_and_relu_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRelu_T1], b: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRelu_T2], bias: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput: TV_QuantizedMatMulWithBiasAndRelu_Toutput, transpose_a: bool, transpose_b: bool, input_quant_mode: str, name, ctx):
  if Toutput is None:
    Toutput = _dtypes.qint32
  Toutput = _execute.make_type(Toutput, "Toutput")
  if transpose_a is None:
...
def quantized_mat_mul_with_bias_and_relu_and_requantize(a: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndReluAndRequantize_T1], b: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndReluAndRequantize_T2], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndReluAndRequantize_Tbias], min_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput:TV_QuantizedMatMulWithBiasAndReluAndRequantize_Toutput=_dtypes.quint8, transpose_a:bool=False, transpose_b:bool=False, input_quant_mode:str="MIN_FIRST", name=None):
  r"""Perform a quantized matrix multiplication of  `a` by the matrix `b` with bias
...
def quantized_mat_mul_with_bias_and_requantize(a: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRequantize_T1], b: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRequantize_T2], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRequantize_Tbias], min_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput:TV_QuantizedMatMulWithBiasAndRequantize_Toutput=_dtypes.quint8, transpose_a:bool=False, transpose_b:bool=False, input_quant_mode:str="MIN_FIRST", name=None):
  r"""TODO: add doc.
...
def quantized_mat_mul_with_bias_and_requantize_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRequantize_T1], b: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRequantize_T2], bias: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMulWithBiasAndRequantize_Tbias], min_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_freezed_output: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput: TV_QuantizedMatMulWithBiasAndRequantize_Toutput, transpose_a: bool, transpose_b: bool, input_quant_mode: str, name, ctx):
  if Toutput is None:
    Toutput = _dtypes.quint8
  Toutput = _execute.make_type(Toutput, "Toutput")
  if transpose_a is None:
...
def quantized_max_pool_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_QuantizedMaxPool_T], min_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_input: _atypes.TensorFuzzingAnnotation[_atypes.Float32], ksize, strides, padding: str, name, ctx):
  if not isinstance(ksize, (list, tuple)):
    raise TypeError(
        "Expected list for 'ksize' argument to "
        "'quantized_max_pool' Op, not %r." % ksize)
...
def quantized_relu_eager_fallback(features: _atypes.TensorFuzzingAnnotation[TV_QuantizedRelu_Tinput], min_features: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_features: _atypes.TensorFuzzingAnnotation[_atypes.Float32], out_type: TV_QuantizedRelu_out_type, name, ctx):
  if out_type is None:
    out_type = _dtypes.quint8
  out_type = _execute.make_type(out_type, "out_type")
...
def quantized_relu6(features: _atypes.TensorFuzzingAnnotation[TV_QuantizedRelu6_Tinput], min_features: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_features: _atypes.TensorFuzzingAnnotation[_atypes.Float32], out_type:TV_QuantizedRelu6_out_type=_dtypes.quint8, name=None):
...
def quantized_relu_x_eager_fallback(features: _atypes.TensorFuzzingAnnotation[TV_QuantizedReluX_Tinput], max_value: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_features: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_features: _atypes.TensorFuzzingAnnotation[_atypes.Float32], out_type: TV_QuantizedReluX_out_type, name, ctx):
  if out_type is None:
    out_type = _dtypes.quint8
  out_type = _execute.make_type(out_type, "out_type")
  _attr_Tinput, (features,) = _execute.args_to_matching_eager([features], ctx, [_dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.qint16, _dtypes.quint16, ])
...
@_dispatch.add_type_based_api_dispatcher
@tf_export('nn.relu')
def relu(features: _atypes.TensorFuzzingAnnotation[TV_Relu_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Relu_T]:
...
def relu_eager_fallback(features: _atypes.TensorFuzzingAnnotation[TV_Relu_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Relu_T]:
...
def relu6(features: _atypes.TensorFuzzingAnnotation[TV_Relu6_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Relu6_T]:
...
def relu6_eager_fallback(features: _atypes.TensorFuzzingAnnotation[TV_Relu6_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Relu6_T]:
...
def relu6_grad_eager_fallback(gradients: _atypes.TensorFuzzingAnnotation[TV_Relu6Grad_T], features: _atypes.TensorFuzzingAnnotation[TV_Relu6Grad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Relu6Grad_T]:
...
def relu_grad(gradients: _atypes.TensorFuzzingAnnotation[TV_ReluGrad_T], features: _atypes.TensorFuzzingAnnotation[TV_ReluGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_ReluGrad_T]:
...
def relu_grad_eager_fallback(gradients: _atypes.TensorFuzzingAnnotation[TV_ReluGrad_T], features: _atypes.TensorFuzzingAnnotation[TV_ReluGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ReluGrad_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, features], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  (gradients, features) = _inputs_T
  _inputs_flat = [gradients, features]
  _attrs = ("T", _attr_T)
...
@_dispatch.add_type_based_api_dispatcher
@tf_export('nn.selu')
def selu(features: _atypes.TensorFuzzingAnnotation[TV_Selu_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Selu_T]:
...
def selu_eager_fallback(features: _atypes.TensorFuzzingAnnotation[TV_Selu_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Selu_T]:
  _attr_T, (features,) = _execute.args_to_matching_eager([features], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [features]
  _attrs = ("T", _attr_T)
...
def selu_grad_eager_fallback(gradients: _atypes.TensorFuzzingAnnotation[TV_SeluGrad_T], outputs: _atypes.TensorFuzzingAnnotation[TV_SeluGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SeluGrad_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, outputs], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, ])
  (gradients, outputs) = _inputs_T
  _inputs_flat = [gradients, outputs]
  _attrs = ("T", _attr_T)
...
def softmax(logits: _atypes.TensorFuzzingAnnotation[TV_Softmax_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Softmax_T]:
...
def softmax_eager_fallback(logits: _atypes.TensorFuzzingAnnotation[TV_Softmax_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Softmax_T]:
  _attr_T, (logits,) = _execute.args_to_matching_eager([logits], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [logits]
  _attrs = ("T", _attr_T)
...
def softplus(features: _atypes.TensorFuzzingAnnotation[TV_Softplus_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Softplus_T]:
  r"""TODO: add doc.
...
def softplus_eager_fallback(features: _atypes.TensorFuzzingAnnotation[TV_Softplus_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Softplus_T]:
  _attr_T, (features,) = _execute.args_to_matching_eager([features], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [features]
  _attrs = ("T", _attr_T)
...
def softplus_grad_eager_fallback(gradients: _atypes.TensorFuzzingAnnotation[TV_SoftplusGrad_T], features: _atypes.TensorFuzzingAnnotation[TV_SoftplusGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SoftplusGrad_T]:
...
def softsign(features: _atypes.TensorFuzzingAnnotation[TV_Softsign_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Softsign_T]:
...
def softsign_eager_fallback(features: _atypes.TensorFuzzingAnnotation[TV_Softsign_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Softsign_T]:
  _attr_T, (features,) = _execute.args_to_matching_eager([features], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [features]
  _attrs = ("T", _attr_T)
...
def softsign_grad(gradients: _atypes.TensorFuzzingAnnotation[TV_SoftsignGrad_T], features: _atypes.TensorFuzzingAnnotation[TV_SoftsignGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SoftsignGrad_T]:
...
def softsign_grad_eager_fallback(gradients: _atypes.TensorFuzzingAnnotation[TV_SoftsignGrad_T], features: _atypes.TensorFuzzingAnnotation[TV_SoftsignGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SoftsignGrad_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, features], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, ])
  (gradients, features) = _inputs_T
  _inputs_flat = [gradients, features]
  _attrs = ("T", _attr_T)
...
def top_k_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_TopK_T], k: int, sorted: bool, name, ctx):
  k = _execute.make_int(k, "k")
  if sorted is None:
    sorted = True
  sorted = _execute.make_bool(sorted, "sorted")
