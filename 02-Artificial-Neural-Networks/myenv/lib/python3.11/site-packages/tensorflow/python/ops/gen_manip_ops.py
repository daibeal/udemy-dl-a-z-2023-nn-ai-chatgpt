...
TV_Roll_T = TypeVar("TV_Roll_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def roll(input: _atypes.TensorFuzzingAnnotation[TV_Roll_T], shift: _atypes.TensorFuzzingAnnotation[TV_Roll_Tshift], axis: _atypes.TensorFuzzingAnnotation[TV_Roll_Taxis], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Roll_T]:
...
def roll_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Roll_T], shift: _atypes.TensorFuzzingAnnotation[TV_Roll_Tshift], axis: _atypes.TensorFuzzingAnnotation[TV_Roll_Taxis], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Roll_T]:
