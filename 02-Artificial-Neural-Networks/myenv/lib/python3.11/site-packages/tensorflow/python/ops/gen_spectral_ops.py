...
def batch_fft(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  r"""TODO: add doc.
...
def batch_fft_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
...
def batch_fft2d(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  r"""TODO: add doc.
...
def batch_fft2d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  input = _ops.convert_to_tensor(input, _dtypes.complex64)
  _inputs_flat = [input]
  _attrs = None
...
def batch_fft3d(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  r"""TODO: add doc.
...
def batch_fft3d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  input = _ops.convert_to_tensor(input, _dtypes.complex64)
  _inputs_flat = [input]
  _attrs = None
...
def batch_ifft(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  r"""TODO: add doc.
...
def batch_ifft_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  input = _ops.convert_to_tensor(input, _dtypes.complex64)
  _inputs_flat = [input]
  _attrs = None
...
def batch_ifft2d(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  r"""TODO: add doc.
...
def batch_ifft2d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  input = _ops.convert_to_tensor(input, _dtypes.complex64)
  _inputs_flat = [input]
  _attrs = None
...
def batch_ifft3d(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  r"""TODO: add doc.
...
def batch_ifft3d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Complex64], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Complex64]:
  input = _ops.convert_to_tensor(input, _dtypes.complex64)
  _inputs_flat = [input]
  _attrs = None
...
def fft_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_FFT_Tcomplex], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_FFT_Tcomplex]:
...
def fft2d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_FFT2D_Tcomplex], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_FFT2D_Tcomplex]:
  _attr_Tcomplex, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
  _inputs_flat = [input]
  _attrs = ("Tcomplex", _attr_Tcomplex)
...
def fft3d(input: _atypes.TensorFuzzingAnnotation[TV_FFT3D_Tcomplex], name=None) -> _atypes.TensorFuzzingAnnotation[TV_FFT3D_Tcomplex]:
...
def fft3d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_FFT3D_Tcomplex], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_FFT3D_Tcomplex]:
  _attr_Tcomplex, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
  _inputs_flat = [input]
  _attrs = ("Tcomplex", _attr_Tcomplex)
...
def ifft(input: _atypes.TensorFuzzingAnnotation[TV_IFFT_Tcomplex], name=None) -> _atypes.TensorFuzzingAnnotation[TV_IFFT_Tcomplex]:
...
def ifft_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_IFFT_Tcomplex], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_IFFT_Tcomplex]:
  _attr_Tcomplex, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
  _inputs_flat = [input]
  _attrs = ("Tcomplex", _attr_Tcomplex)
...
def ifft2d(input: _atypes.TensorFuzzingAnnotation[TV_IFFT2D_Tcomplex], name=None) -> _atypes.TensorFuzzingAnnotation[TV_IFFT2D_Tcomplex]:
...
def ifft2d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_IFFT2D_Tcomplex], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_IFFT2D_Tcomplex]:
  _attr_Tcomplex, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
  _inputs_flat = [input]
  _attrs = ("Tcomplex", _attr_Tcomplex)
...
def ifft3d(input: _atypes.TensorFuzzingAnnotation[TV_IFFT3D_Tcomplex], name=None) -> _atypes.TensorFuzzingAnnotation[TV_IFFT3D_Tcomplex]:
...
def ifft3d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_IFFT3D_Tcomplex], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_IFFT3D_Tcomplex]:
  _attr_Tcomplex, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
  _inputs_flat = [input]
  _attrs = ("Tcomplex", _attr_Tcomplex)
...
def irfft2d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_IRFFT2D_Tcomplex], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Treal: TV_IRFFT2D_Treal, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_IRFFT2D_Treal]:
  if Treal is None:
    Treal = _dtypes.float32
  Treal = _execute.make_type(Treal, "Treal")
  _attr_Tcomplex, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
...
def irfft3d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_IRFFT3D_Tcomplex], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Treal: TV_IRFFT3D_Treal, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_IRFFT3D_Treal]:
  if Treal is None:
    Treal = _dtypes.float32
  Treal = _execute.make_type(Treal, "Treal")
  _attr_Tcomplex, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
...
def rfft_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_RFFT_Treal], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tcomplex: TV_RFFT_Tcomplex, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RFFT_Tcomplex]:
  if Tcomplex is None:
    Tcomplex = _dtypes.complex64
  Tcomplex = _execute.make_type(Tcomplex, "Tcomplex")
...
def rfft2d_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_RFFT2D_Treal], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tcomplex: TV_RFFT2D_Tcomplex, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RFFT2D_Tcomplex]:
  if Tcomplex is None:
    Tcomplex = _dtypes.complex64
  Tcomplex = _execute.make_type(Tcomplex, "Tcomplex")
  _attr_Treal, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float32, _dtypes.float64, ], _dtypes.float32)
...
def rfft3d(input: _atypes.TensorFuzzingAnnotation[TV_RFFT3D_Treal], fft_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], Tcomplex:TV_RFFT3D_Tcomplex=_dtypes.complex64, name=None) -> _atypes.TensorFuzzingAnnotation[TV_RFFT3D_Tcomplex]:
