...
def anonymous_iterator(output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
...
def anonymous_iterator_eager_fallback(output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'anonymous_iterator' Op, not %r." % output_types)
...
def anonymous_iterator_v3(output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""A container for an iterator resource.
...
def anonymous_iterator_v3_eager_fallback(output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'anonymous_iterator_v3' Op, not %r." % output_types)
...
def anonymous_multi_device_iterator_v3(devices, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""A container for a multi device iterator resource.
...
def anonymous_multi_device_iterator_v3_eager_fallback(devices, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if not isinstance(devices, (list, tuple)):
    raise TypeError(
        "Expected list for 'devices' argument to "
        "'anonymous_multi_device_iterator_v3' Op, not %r." % devices)
...
def anonymous_random_seed_generator(seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name=None):
  r"""TODO: add doc.
...
def anonymous_random_seed_generator_eager_fallback(seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx):
...
def batch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def batch_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'batch_dataset' Op, not %r." % output_types)
...
def batch_dataset_v2_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], drop_remainder: _atypes.TensorFuzzingAnnotation[_atypes.Bool], output_types, output_shapes, parallel_copy: bool, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'batch_dataset_v2' Op, not %r." % output_types)
...
def cache_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], filename: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def cache_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], filename: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'cache_dataset' Op, not %r." % output_types)
...
def cache_dataset_v2(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], filename: _atypes.TensorFuzzingAnnotation[_atypes.String], cache: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def cache_dataset_v2_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], filename: _atypes.TensorFuzzingAnnotation[_atypes.String], cache: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'cache_dataset_v2' Op, not %r." % output_types)
...
def concatenate_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], another_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def concatenate_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], another_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'concatenate_dataset' Op, not %r." % output_types)
...
def dataset_to_single_element(dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, metadata:str="", name=None):
...
def dataset_to_single_element_eager_fallback(dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, metadata: str, name, ctx):
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'dataset_to_single_element' Op, not %r." % output_types)
...
def delete_iterator_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], deleter: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx):
...
def delete_memory_cache(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], deleter: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name=None):
  r"""TODO: add doc.
...
def delete_memory_cache_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], deleter: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx):
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  deleter = _ops.convert_to_tensor(deleter, _dtypes.variant)
  _inputs_flat = [handle, deleter]
  _attrs = None
...
def delete_random_seed_generator_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], deleter: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx):
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  deleter = _ops.convert_to_tensor(deleter, _dtypes.variant)
  _inputs_flat = [handle, deleter]
  _attrs = None
...
def delete_seed_generator(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], deleter: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name=None):
  r"""TODO: add doc.
...
def delete_seed_generator_eager_fallback(handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], deleter: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx):
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  deleter = _ops.convert_to_tensor(deleter, _dtypes.variant)
  _inputs_flat = [handle, deleter]
  _attrs = None
...
def deserialize_iterator_eager_fallback(resource_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], serialized: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx):
...
def dummy_memory_cache(name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""TODO: add doc.
...
def dummy_memory_cache_eager_fallback(name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  _inputs_flat = []
  _attrs = None
...
def dummy_seed_generator(name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""TODO: add doc.
...
def dummy_seed_generator_eager_fallback(name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  _inputs_flat = []
  _attrs = None
...
def filter_by_last_component_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def filter_by_last_component_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'filter_by_last_component_dataset' Op, not %r." % output_types)
...
def filter_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, predicate, output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def filter_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, predicate, output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'filter_dataset' Op, not %r." % output_types)
...
def finalize_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, has_captured_ref:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def finalize_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], output_types, output_shapes, has_captured_ref: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'finalize_dataset' Op, not %r." % output_types)
...
def flat_map_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, f, output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def flat_map_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, f, output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'flat_map_dataset' Op, not %r." % output_types)
...
def generator_dataset_eager_fallback(init_func_other_args, next_func_other_args, finalize_func_other_args, init_func, next_func, finalize_func, output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'generator_dataset' Op, not %r." % output_types)
...
def get_options_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  input_dataset = _ops.convert_to_tensor(input_dataset, _dtypes.variant)
  _inputs_flat = [input_dataset]
  _attrs = None
...
def interleave_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, cycle_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], block_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that applies `f` to the outputs of `input_dataset`.
...
def interleave_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, cycle_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], block_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'interleave_dataset' Op, not %r." % output_types)
...
def iterator(shared_name: str, container: str, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""A container for an iterator resource.
...
def iterator_eager_fallback(shared_name: str, container: str, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  shared_name = _execute.make_str(shared_name, "shared_name")
  container = _execute.make_str(container, "container")
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
...
def iterator_from_string_handle_eager_fallback(string_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if output_types is None:
    output_types = []
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
...
def iterator_from_string_handle_v2(string_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types=[], output_shapes=[], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""TODO: add doc.
...
def iterator_from_string_handle_v2_eager_fallback(string_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if output_types is None:
    output_types = []
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
...
def iterator_get_next(iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, name=None):
...
def iterator_get_next_eager_fallback(iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, name, ctx):
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'iterator_get_next' Op, not %r." % output_types)
...
def iterator_get_next_as_optional(iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def iterator_get_next_as_optional_eager_fallback(iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'iterator_get_next_as_optional' Op, not %r." % output_types)
...
def iterator_get_next_sync(iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, name=None):
  r"""Gets the next output from the given iterator.
...
def iterator_get_next_sync_eager_fallback(iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, name, ctx):
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'iterator_get_next_sync' Op, not %r." % output_types)
...
def iterator_to_string_handle_eager_fallback(resource_handle: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  resource_handle = _ops.convert_to_tensor(resource_handle, _dtypes.resource)
...
def iterator_v2(shared_name: str, container: str, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""TODO: add doc.
...
def iterator_v2_eager_fallback(shared_name: str, container: str, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  shared_name = _execute.make_str(shared_name, "shared_name")
  container = _execute.make_str(container, "container")
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
...
def make_iterator_eager_fallback(dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx):
  dataset = _ops.convert_to_tensor(dataset, _dtypes.variant)
  iterator = _ops.convert_to_tensor(iterator, _dtypes.resource)
...
def map_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, f, output_types, output_shapes, use_inter_op_parallelism:bool=True, preserve_cardinality:bool=False, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that applies `f` to the outputs of `input_dataset`.
...
def multi_device_iterator(devices, shared_name: str, container: str, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
...
def multi_device_iterator_from_string_handle(string_handle: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types=[], output_shapes=[], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
...
def multi_device_iterator_to_string_handle_eager_fallback(multi_device_iterator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.String]:
  multi_device_iterator = _ops.convert_to_tensor(multi_device_iterator, _dtypes.resource)
...
def optimize_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], optimizations: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, optimization_configs=[], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def optimize_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], optimizations: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, optimization_configs, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'optimize_dataset' Op, not %r." % output_types)
...
def options_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], serialized_options: str, output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def options_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], serialized_options: str, output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  serialized_options = _execute.make_str(serialized_options, "serialized_options")
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
...
def padded_batch_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], padded_shapes: List[_atypes.TensorFuzzingAnnotation[_atypes.Int64]], padding_values, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(padded_shapes, (list, tuple)):
    raise TypeError(
        "Expected list for 'padded_shapes' argument to "
        "'padded_batch_dataset' Op, not %r." % padded_shapes)
...
def padded_batch_dataset_v2(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], padded_shapes: List[_atypes.TensorFuzzingAnnotation[_atypes.Int64]], padding_values, drop_remainder: _atypes.TensorFuzzingAnnotation[_atypes.Bool], output_shapes, parallel_copy:bool=False, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that batches and pads `batch_size` elements from the input.
...
def parallel_batch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], drop_remainder: _atypes.TensorFuzzingAnnotation[_atypes.Bool], output_types, output_shapes, parallel_copy:bool=False, deterministic:str="default", metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def parallel_batch_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], batch_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], drop_remainder: _atypes.TensorFuzzingAnnotation[_atypes.Bool], output_types, output_shapes, parallel_copy: bool, deterministic: str, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'parallel_batch_dataset' Op, not %r." % output_types)
...
def parallel_filter_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], predicate, output_types, output_shapes, deterministic: str, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'parallel_filter_dataset' Op, not %r." % output_types)
...
def parallel_interleave_dataset_v2(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, cycle_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], block_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, sloppy:bool=False, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that applies `f` to the outputs of `input_dataset`.
...
def parallel_interleave_dataset_v3_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, cycle_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], block_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, deterministic: str, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'parallel_interleave_dataset_v3' Op, not %r." % output_types)
...
def parallel_interleave_dataset_v4(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, cycle_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], block_length: _atypes.TensorFuzzingAnnotation[_atypes.Int64], buffer_output_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int64], prefetch_input_elements: _atypes.TensorFuzzingAnnotation[_atypes.Int64], num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, deterministic:str="default", metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that applies `f` to the outputs of `input_dataset`.
...
def parallel_map_dataset_v2(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, use_inter_op_parallelism:bool=True, deterministic:str="default", preserve_cardinality:bool=False, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""Creates a dataset that applies `f` to the outputs of `input_dataset`.
...
def parallel_map_dataset_v2_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], other_arguments, num_parallel_calls: _atypes.TensorFuzzingAnnotation[_atypes.Int64], f, output_types, output_shapes, use_inter_op_parallelism: bool, deterministic: str, preserve_cardinality: bool, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'parallel_map_dataset_v2' Op, not %r." % output_types)
...
def prefetch_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, slack_period:int=0, legacy_autotune:bool=True, buffer_size_min:int=0, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def prefetch_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, slack_period: int, legacy_autotune: bool, buffer_size_min: int, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'prefetch_dataset' Op, not %r." % output_types)
...
def range_dataset(start: _atypes.TensorFuzzingAnnotation[_atypes.Int64], stop: _atypes.TensorFuzzingAnnotation[_atypes.Int64], step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, metadata:str="", replicate_on_split:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def reduce_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], initial_state, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism: bool, metadata: str, name, ctx):
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'reduce_dataset' Op, not %r." % output_types)
...
def repeat_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], count: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def repeat_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], count: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'repeat_dataset' Op, not %r." % output_types)
...
def rewrite_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], rewrite_name: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def rewrite_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], rewrite_name: _atypes.TensorFuzzingAnnotation[_atypes.String], output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'rewrite_dataset' Op, not %r." % output_types)
...
def shard_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], num_shards: _atypes.TensorFuzzingAnnotation[_atypes.Int64], index: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, require_non_empty:bool=False, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def shuffle_and_repeat_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], count: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, reshuffle_each_iteration:bool=True, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def shuffle_and_repeat_dataset_v2(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], count: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed_generator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, reshuffle_each_iteration:bool=True, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def shuffle_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, reshuffle_each_iteration:bool=True, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def shuffle_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, reshuffle_each_iteration: bool, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'shuffle_dataset' Op, not %r." % output_types)
...
def shuffle_dataset_v2(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed_generator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def shuffle_dataset_v2_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed_generator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'shuffle_dataset_v2' Op, not %r." % output_types)
...
def shuffle_dataset_v3_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed2: _atypes.TensorFuzzingAnnotation[_atypes.Int64], seed_generator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], output_types, output_shapes, reshuffle_each_iteration: bool, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'shuffle_dataset_v3' Op, not %r." % output_types)
...
def skip_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], count: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
TV_SparseTensorSliceDataset_Tvalues = TypeVar("TV_SparseTensorSliceDataset_Tvalues", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def sparse_tensor_slice_dataset(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_SparseTensorSliceDataset_Tvalues], dense_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def sparse_tensor_slice_dataset_eager_fallback(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_SparseTensorSliceDataset_Tvalues], dense_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def tf_record_dataset(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], compression_type: _atypes.TensorFuzzingAnnotation[_atypes.String], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def tf_record_dataset_eager_fallback(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], compression_type: _atypes.TensorFuzzingAnnotation[_atypes.String], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if metadata is None:
    metadata = ""
  metadata = _execute.make_str(metadata, "metadata")
  filenames = _ops.convert_to_tensor(filenames, _dtypes.string)
...
def take_dataset(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], count: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def take_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], count: _atypes.TensorFuzzingAnnotation[_atypes.Int64], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'take_dataset' Op, not %r." % output_types)
...
def tensor_dataset(components, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def tensor_dataset_eager_fallback(components, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_shapes, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_shapes' argument to "
        "'tensor_dataset' Op, not %r." % output_shapes)
...
def tensor_slice_dataset_eager_fallback(components, output_shapes, is_files: bool, metadata: str, replicate_on_split: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_shapes, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_shapes' argument to "
        "'tensor_slice_dataset' Op, not %r." % output_shapes)
...
def text_line_dataset(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], compression_type: _atypes.TensorFuzzingAnnotation[_atypes.String], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def text_line_dataset_eager_fallback(filenames: _atypes.TensorFuzzingAnnotation[_atypes.String], compression_type: _atypes.TensorFuzzingAnnotation[_atypes.String], buffer_size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if metadata is None:
    metadata = ""
  metadata = _execute.make_str(metadata, "metadata")
  filenames = _ops.convert_to_tensor(filenames, _dtypes.string)
...
def unwrap_dataset_variant(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def unwrap_dataset_variant_eager_fallback(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def window_dataset_eager_fallback(input_dataset: _atypes.TensorFuzzingAnnotation[_atypes.Variant], size: _atypes.TensorFuzzingAnnotation[_atypes.Int64], shift: _atypes.TensorFuzzingAnnotation[_atypes.Int64], stride: _atypes.TensorFuzzingAnnotation[_atypes.Int64], drop_remainder: _atypes.TensorFuzzingAnnotation[_atypes.Bool], output_types, output_shapes, metadata: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'window_dataset' Op, not %r." % output_types)
...
def window_op(inputs, output_types, output_shapes, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def window_op_eager_fallback(inputs, output_types, output_shapes, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'window_op' Op, not %r." % output_types)
...
def wrap_dataset_variant(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  r"""TODO: add doc.
...
def zip_dataset(input_datasets: List[_atypes.TensorFuzzingAnnotation[_atypes.Variant]], output_types, output_shapes, metadata:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
