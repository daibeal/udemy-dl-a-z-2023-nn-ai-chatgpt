...
def bitwise_and(x: _atypes.TensorFuzzingAnnotation[TV_BitwiseAnd_T], y: _atypes.TensorFuzzingAnnotation[TV_BitwiseAnd_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BitwiseAnd_T]:
...
def bitwise_and_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BitwiseAnd_T], y: _atypes.TensorFuzzingAnnotation[TV_BitwiseAnd_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BitwiseAnd_T]:
...
def bitwise_or(x: _atypes.TensorFuzzingAnnotation[TV_BitwiseOr_T], y: _atypes.TensorFuzzingAnnotation[TV_BitwiseOr_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BitwiseOr_T]:
...
def bitwise_or_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BitwiseOr_T], y: _atypes.TensorFuzzingAnnotation[TV_BitwiseOr_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BitwiseOr_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.int8, _dtypes.int16, _dtypes.int32, _dtypes.int64, _dtypes.uint8, _dtypes.uint16, _dtypes.uint32, _dtypes.uint64, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def bitwise_xor(x: _atypes.TensorFuzzingAnnotation[TV_BitwiseXor_T], y: _atypes.TensorFuzzingAnnotation[TV_BitwiseXor_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BitwiseXor_T]:
...
def bitwise_xor_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BitwiseXor_T], y: _atypes.TensorFuzzingAnnotation[TV_BitwiseXor_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BitwiseXor_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.int8, _dtypes.int16, _dtypes.int32, _dtypes.int64, _dtypes.uint8, _dtypes.uint16, _dtypes.uint32, _dtypes.uint64, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def invert(x: _atypes.TensorFuzzingAnnotation[TV_Invert_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Invert_T]:
...
def invert_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Invert_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Invert_T]:
...
def left_shift_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_LeftShift_T], y: _atypes.TensorFuzzingAnnotation[TV_LeftShift_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_LeftShift_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.int8, _dtypes.int16, _dtypes.int32, _dtypes.int64, _dtypes.uint8, _dtypes.uint16, _dtypes.uint32, _dtypes.uint64, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def population_count(x: _atypes.TensorFuzzingAnnotation[TV_PopulationCount_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.UInt8]:
...
def population_count_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_PopulationCount_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.UInt8]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.int8, _dtypes.int16, _dtypes.int32, _dtypes.int64, _dtypes.uint8, _dtypes.uint16, _dtypes.uint32, _dtypes.uint64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def right_shift_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_RightShift_T], y: _atypes.TensorFuzzingAnnotation[TV_RightShift_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RightShift_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.int8, _dtypes.int16, _dtypes.int32, _dtypes.int64, _dtypes.uint8, _dtypes.uint16, _dtypes.uint32, _dtypes.uint64, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
