...
def empty_tensor_map_eager_fallback(name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  _inputs_flat = []
  _attrs = None
...
TV_TensorMapErase_value_dtype = TypeVar("TV_TensorMapErase_value_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
TV_TensorMapHasKey_key_dtype = TypeVar("TV_TensorMapHasKey_key_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('tensor_map_has_key')
def tensor_map_has_key(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key: _atypes.TensorFuzzingAnnotation[TV_TensorMapHasKey_key_dtype], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def tensor_map_has_key_eager_fallback(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key: _atypes.TensorFuzzingAnnotation[TV_TensorMapHasKey_key_dtype], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  _attr_key_dtype, (key,) = _execute.args_to_matching_eager([key], ctx, [])
  input_handle = _ops.convert_to_tensor(input_handle, _dtypes.variant)
  _inputs_flat = [input_handle, key]
...
TV_TensorMapInsert_key_dtype = TypeVar("TV_TensorMapInsert_key_dtype", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
...
def tensor_map_insert_eager_fallback(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key: _atypes.TensorFuzzingAnnotation[TV_TensorMapInsert_key_dtype], value: _atypes.TensorFuzzingAnnotation[TV_TensorMapInsert_value_dtype], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  _attr_key_dtype, (key,) = _execute.args_to_matching_eager([key], ctx, [])
...
def tensor_map_lookup(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key: _atypes.TensorFuzzingAnnotation[TV_TensorMapLookup_key_dtype], value_dtype: TV_TensorMapLookup_value_dtype, name=None) -> _atypes.TensorFuzzingAnnotation[TV_TensorMapLookup_value_dtype]:
...
def tensor_map_lookup_eager_fallback(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key: _atypes.TensorFuzzingAnnotation[TV_TensorMapLookup_key_dtype], value_dtype: TV_TensorMapLookup_value_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TensorMapLookup_value_dtype]:
  value_dtype = _execute.make_type(value_dtype, "value_dtype")
  _attr_key_dtype, (key,) = _execute.args_to_matching_eager([key], ctx, [])
  input_handle = _ops.convert_to_tensor(input_handle, _dtypes.variant)
  _inputs_flat = [input_handle, key]
...
def tensor_map_size(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def tensor_map_size_eager_fallback(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  input_handle = _ops.convert_to_tensor(input_handle, _dtypes.variant)
...
def tensor_map_stack_keys_eager_fallback(input_handle: _atypes.TensorFuzzingAnnotation[_atypes.Variant], key_dtype: TV_TensorMapStackKeys_key_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TensorMapStackKeys_key_dtype]:
  key_dtype = _execute.make_type(key_dtype, "key_dtype")
  input_handle = _ops.convert_to_tensor(input_handle, _dtypes.variant)
  _inputs_flat = [input_handle]
