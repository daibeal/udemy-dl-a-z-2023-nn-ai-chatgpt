...
def sdca_fprint_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int64]:
...
def sdca_shrink_l1_eager_fallback(weights: List[_atypes.TensorFuzzingAnnotation[_atypes.Float32]], l1: float, l2: float, name, ctx):
  raise RuntimeError("sdca_shrink_l1 op does not support eager execution. Arg 'weights' is a ref.")
