...
def ctc_beam_search_decoder(inputs: _atypes.TensorFuzzingAnnotation[TV_CTCBeamSearchDecoder_T], sequence_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], beam_width: int, top_paths: int, merge_repeated:bool=True, name=None):
...
def ctc_greedy_decoder(inputs: _atypes.TensorFuzzingAnnotation[TV_CTCGreedyDecoder_T], sequence_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], merge_repeated:bool=False, blank_index:int=-1, name=None):
...
def ctc_loss(inputs: _atypes.TensorFuzzingAnnotation[TV_CTCLoss_T], labels_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], labels_values: _atypes.TensorFuzzingAnnotation[_atypes.Int32], sequence_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], preprocess_collapse_repeated:bool=False, ctc_merge_repeated:bool=True, ignore_longer_outputs_than_inputs:bool=False, name=None):
...
def ctc_loss_eager_fallback(inputs: _atypes.TensorFuzzingAnnotation[TV_CTCLoss_T], labels_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], labels_values: _atypes.TensorFuzzingAnnotation[_atypes.Int32], sequence_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], preprocess_collapse_repeated: bool, ctc_merge_repeated: bool, ignore_longer_outputs_than_inputs: bool, name, ctx):
  if preprocess_collapse_repeated is None:
    preprocess_collapse_repeated = False
  preprocess_collapse_repeated = _execute.make_bool(preprocess_collapse_repeated, "preprocess_collapse_repeated")
  if ctc_merge_repeated is None:
...
def ctc_loss_v2(inputs: _atypes.TensorFuzzingAnnotation[_atypes.Float32], labels_indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], labels_values: _atypes.TensorFuzzingAnnotation[_atypes.Int32], sequence_length: _atypes.TensorFuzzingAnnotation[_atypes.Int32], preprocess_collapse_repeated:bool=False, ctc_merge_repeated:bool=True, ignore_longer_outputs_than_inputs:bool=False, name=None):
  r"""Calculates the CTC Loss (log probability) for each batch entry.  Also calculates
