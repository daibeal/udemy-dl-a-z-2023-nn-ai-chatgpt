...
def close_summary_writer(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None):
  r"""TODO: add doc.
...
def close_summary_writer_eager_fallback(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx):
...
def create_summary_db_writer(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], db_uri: _atypes.TensorFuzzingAnnotation[_atypes.String], experiment_name: _atypes.TensorFuzzingAnnotation[_atypes.String], run_name: _atypes.TensorFuzzingAnnotation[_atypes.String], user_name: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None):
  r"""TODO: add doc.
...
def create_summary_file_writer(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], logdir: _atypes.TensorFuzzingAnnotation[_atypes.String], max_queue: _atypes.TensorFuzzingAnnotation[_atypes.Int32], flush_millis: _atypes.TensorFuzzingAnnotation[_atypes.Int32], filename_suffix: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None):
  r"""TODO: add doc.
...
def flush_summary_writer(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name=None):
  r"""TODO: add doc.
...
def flush_summary_writer_eager_fallback(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], name, ctx):
  writer = _ops.convert_to_tensor(writer, _dtypes.resource)
  _inputs_flat = [writer]
  _attrs = None
...
def import_event(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], event: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None):
  r"""TODO: add doc.
...
def import_event_eager_fallback(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], event: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  writer = _ops.convert_to_tensor(writer, _dtypes.resource)
...
def summary_writer(shared_name:str="", container:str="", name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  r"""TODO: add doc.
...
def summary_writer_eager_fallback(shared_name: str, container: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Resource]:
  if shared_name is None:
    shared_name = ""
  shared_name = _execute.make_str(shared_name, "shared_name")
  if container is None:
...
def write_graph_summary(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], tensor: _atypes.TensorFuzzingAnnotation[_atypes.String], name=None):
...
def write_graph_summary_eager_fallback(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], tensor: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
  writer = _ops.convert_to_tensor(writer, _dtypes.resource)
  step = _ops.convert_to_tensor(step, _dtypes.int64)
...
def write_histogram_summary(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], values: _atypes.TensorFuzzingAnnotation[TV_WriteHistogramSummary_T], name=None):
...
def write_histogram_summary_eager_fallback(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], values: _atypes.TensorFuzzingAnnotation[TV_WriteHistogramSummary_T], name, ctx):
...
def write_scalar_summary_eager_fallback(writer: _atypes.TensorFuzzingAnnotation[_atypes.Resource], step: _atypes.TensorFuzzingAnnotation[_atypes.Int64], tag: _atypes.TensorFuzzingAnnotation[_atypes.String], value: _atypes.TensorFuzzingAnnotation[TV_WriteScalarSummary_T], name, ctx):
...
TV_WriteSummary_T = TypeVar("TV_WriteSummary_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
