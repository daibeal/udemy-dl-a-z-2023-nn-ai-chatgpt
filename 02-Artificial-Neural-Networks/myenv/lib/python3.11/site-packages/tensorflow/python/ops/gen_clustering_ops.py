...
def nearest_neighbors_eager_fallback(points: _atypes.TensorFuzzingAnnotation[_atypes.Float32], centers: _atypes.TensorFuzzingAnnotation[_atypes.Float32], k: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx):
  points = _ops.convert_to_tensor(points, _dtypes.float32)
