...
def bessel_i0(x: _atypes.TensorFuzzingAnnotation[TV_BesselI0_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselI0_T]:
  r"""TODO: add doc.
...
def bessel_i0_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselI0_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselI0_T]:
...
def bessel_i0e(x: _atypes.TensorFuzzingAnnotation[TV_BesselI0e_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselI0e_T]:
  r"""TODO: add doc.
...
def bessel_i0e_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselI0e_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselI0e_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def bessel_i1(x: _atypes.TensorFuzzingAnnotation[TV_BesselI1_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselI1_T]:
  r"""TODO: add doc.
...
def bessel_i1_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselI1_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselI1_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def bessel_i1e(x: _atypes.TensorFuzzingAnnotation[TV_BesselI1e_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselI1e_T]:
  r"""TODO: add doc.
...
def bessel_i1e_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselI1e_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselI1e_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def bessel_j0(x: _atypes.TensorFuzzingAnnotation[TV_BesselJ0_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselJ0_T]:
  r"""TODO: add doc.
...
def bessel_j0_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselJ0_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselJ0_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def bessel_j1(x: _atypes.TensorFuzzingAnnotation[TV_BesselJ1_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselJ1_T]:
  r"""TODO: add doc.
...
def bessel_j1_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselJ1_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselJ1_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def bessel_k0(x: _atypes.TensorFuzzingAnnotation[TV_BesselK0_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselK0_T]:
  r"""TODO: add doc.
...
def bessel_k0_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselK0_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselK0_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def bessel_k0e(x: _atypes.TensorFuzzingAnnotation[TV_BesselK0e_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselK0e_T]:
  r"""TODO: add doc.
...
def bessel_k0e_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselK0e_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselK0e_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def bessel_k1(x: _atypes.TensorFuzzingAnnotation[TV_BesselK1_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselK1_T]:
  r"""TODO: add doc.
...
def bessel_k1_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselK1_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselK1_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def bessel_k1e(x: _atypes.TensorFuzzingAnnotation[TV_BesselK1e_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselK1e_T]:
  r"""TODO: add doc.
...
def bessel_k1e_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselK1e_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselK1e_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def bessel_y0(x: _atypes.TensorFuzzingAnnotation[TV_BesselY0_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselY0_T]:
  r"""TODO: add doc.
...
def bessel_y0_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselY0_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselY0_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def bessel_y1(x: _atypes.TensorFuzzingAnnotation[TV_BesselY1_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BesselY1_T]:
  r"""TODO: add doc.
...
def bessel_y1_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BesselY1_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BesselY1_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def dawsn(x: _atypes.TensorFuzzingAnnotation[TV_Dawsn_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Dawsn_T]:
  r"""TODO: add doc.
...
def dawsn_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Dawsn_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Dawsn_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def expint(x: _atypes.TensorFuzzingAnnotation[TV_Expint_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Expint_T]:
  r"""TODO: add doc.
...
def expint_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Expint_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Expint_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def fresnel_cos(x: _atypes.TensorFuzzingAnnotation[TV_FresnelCos_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_FresnelCos_T]:
  r"""TODO: add doc.
...
def fresnel_cos_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_FresnelCos_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_FresnelCos_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def fresnel_sin(x: _atypes.TensorFuzzingAnnotation[TV_FresnelSin_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_FresnelSin_T]:
  r"""TODO: add doc.
...
def fresnel_sin_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_FresnelSin_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_FresnelSin_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def spence(x: _atypes.TensorFuzzingAnnotation[TV_Spence_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Spence_T]:
  r"""TODO: add doc.
...
def spence_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Spence_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Spence_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
