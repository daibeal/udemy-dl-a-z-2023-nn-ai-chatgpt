...
def collective_all_to_all_v2_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveAllToAllV2_T], group_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], group_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], instance_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], ordering_token: List[_atypes.TensorFuzzingAnnotation[_atypes.Resource]], communication_hint: str, timeout_seconds: float, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveAllToAllV2_T]:
  if not isinstance(ordering_token, (list, tuple)):
    raise TypeError(
        "Expected list for 'ordering_token' argument to "
        "'collective_all_to_all_v2' Op, not %r." % ordering_token)
...
def collective_all_to_all_v3(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveAllToAllV3_T], communicator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], group_assignment: _atypes.TensorFuzzingAnnotation[_atypes.Int32], timeout_seconds:float=0, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveAllToAllV3_T]:
  r"""Mutually exchanges multiple tensors of identical type and shape.
...
def collective_all_to_all_v3_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveAllToAllV3_T], communicator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], group_assignment: _atypes.TensorFuzzingAnnotation[_atypes.Int32], timeout_seconds: float, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveAllToAllV3_T]:
  if timeout_seconds is None:
    timeout_seconds = 0
  timeout_seconds = _execute.make_float(timeout_seconds, "timeout_seconds")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.bfloat16, _dtypes.float32, _dtypes.half, _dtypes.float64, _dtypes.int32, _dtypes.int64, ])
...
def collective_assign_group_v2(group_assignment: _atypes.TensorFuzzingAnnotation[_atypes.Int32], device_index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], base_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None):
...
def collective_assign_group_v2_eager_fallback(group_assignment: _atypes.TensorFuzzingAnnotation[_atypes.Int32], device_index: _atypes.TensorFuzzingAnnotation[_atypes.Int32], base_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx):
  group_assignment = _ops.convert_to_tensor(group_assignment, _dtypes.int32)
...
def collective_bcast_recv_eager_fallback(T: TV_CollectiveBcastRecv_T, group_size: int, group_key: int, instance_key: int, shape, communication_hint: str, timeout_seconds: float, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveBcastRecv_T]:
  T = _execute.make_type(T, "T")
  group_size = _execute.make_int(group_size, "group_size")
  group_key = _execute.make_int(group_key, "group_key")
  instance_key = _execute.make_int(instance_key, "instance_key")
...
def collective_bcast_send(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveBcastSend_T], group_size: int, group_key: int, instance_key: int, shape, communication_hint:str="auto", timeout_seconds:float=0, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveBcastSend_T]:
...
def collective_bcast_send_v2(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveBcastSendV2_T], group_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], group_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], instance_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], communication_hint:str="auto", timeout_seconds:float=0, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveBcastSendV2_T]:
  r"""Broadcasts a tensor value to one or more other devices.
...
def collective_bcast_send_v2_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveBcastSendV2_T], group_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], group_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], instance_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], communication_hint: str, timeout_seconds: float, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveBcastSendV2_T]:
  if communication_hint is None:
    communication_hint = "auto"
  communication_hint = _execute.make_str(communication_hint, "communication_hint")
  if timeout_seconds is None:
...
def collective_gather(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveGather_T], group_size: int, group_key: int, instance_key: int, shape, communication_hint:str="auto", timeout_seconds:float=0, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveGather_T]:
...
def collective_gather_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveGather_T], group_size: int, group_key: int, instance_key: int, shape, communication_hint: str, timeout_seconds: float, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveGather_T]:
  group_size = _execute.make_int(group_size, "group_size")
  group_key = _execute.make_int(group_key, "group_key")
  instance_key = _execute.make_int(instance_key, "instance_key")
  shape = _execute.make_shape(shape, "shape")
...
def collective_gather_v2(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveGatherV2_T], group_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], group_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], instance_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], ordering_token: List[_atypes.TensorFuzzingAnnotation[_atypes.Resource]], communication_hint:str="auto", timeout_seconds:float=0, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveGatherV2_T]:
  r"""Mutually accumulates multiple tensors of identical type and shape.
...
def collective_reduce_scatter_v2_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveReduceScatterV2_T], group_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], group_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], instance_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], ordering_token: List[_atypes.TensorFuzzingAnnotation[_atypes.Resource]], merge_op: str, final_op: str, communication_hint: str, timeout_seconds: float, max_subdivs_per_device: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveReduceScatterV2_T]:
  if not isinstance(ordering_token, (list, tuple)):
    raise TypeError(
        "Expected list for 'ordering_token' argument to "
        "'collective_reduce_scatter_v2' Op, not %r." % ordering_token)
...
def collective_reduce_v2(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveReduceV2_T], group_size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], group_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], instance_key: _atypes.TensorFuzzingAnnotation[_atypes.Int32], ordering_token: List[_atypes.TensorFuzzingAnnotation[_atypes.Resource]], merge_op: str, final_op: str, communication_hint:str="auto", timeout_seconds:float=0, max_subdivs_per_device:int=-1, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveReduceV2_T]:
  r"""Mutually reduces multiple tensors of identical type and shape.
...
def collective_reduce_v3(input: _atypes.TensorFuzzingAnnotation[TV_CollectiveReduceV3_T], communicator: _atypes.TensorFuzzingAnnotation[_atypes.Resource], group_assignment: _atypes.TensorFuzzingAnnotation[_atypes.Int32], reduction: str, timeout_seconds:float=0, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CollectiveReduceV3_T]:
  r"""Mutually reduces multiple tensors of identical type and shape.
