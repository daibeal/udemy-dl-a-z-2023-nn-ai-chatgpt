...
def banded_triangular_solve(matrix: _atypes.TensorFuzzingAnnotation[TV_BandedTriangularSolve_T], rhs: _atypes.TensorFuzzingAnnotation[TV_BandedTriangularSolve_T], lower:bool=True, adjoint:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_BandedTriangularSolve_T]:
  r"""TODO: add doc.
...
def banded_triangular_solve_eager_fallback(matrix: _atypes.TensorFuzzingAnnotation[TV_BandedTriangularSolve_T], rhs: _atypes.TensorFuzzingAnnotation[TV_BandedTriangularSolve_T], lower: bool, adjoint: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BandedTriangularSolve_T]:
  if lower is None:
    lower = True
  lower = _execute.make_bool(lower, "lower")
  if adjoint is None:
...
def batch_cholesky(input: _atypes.TensorFuzzingAnnotation[TV_BatchCholesky_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BatchCholesky_T]:
  r"""TODO: add doc.
...
def batch_cholesky_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_BatchCholesky_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchCholesky_T]:
...
def batch_cholesky_grad(l: _atypes.TensorFuzzingAnnotation[TV_BatchCholeskyGrad_T], grad: _atypes.TensorFuzzingAnnotation[TV_BatchCholeskyGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BatchCholeskyGrad_T]:
  r"""TODO: add doc.
...
def batch_matrix_determinant(input: _atypes.TensorFuzzingAnnotation[TV_BatchMatrixDeterminant_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatrixDeterminant_T]:
  r"""TODO: add doc.
...
def batch_matrix_determinant_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_BatchMatrixDeterminant_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatrixDeterminant_T]:
...
def batch_matrix_inverse(input: _atypes.TensorFuzzingAnnotation[TV_BatchMatrixInverse_T], adjoint:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatrixInverse_T]:
  r"""TODO: add doc.
...
def batch_matrix_inverse_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_BatchMatrixInverse_T], adjoint: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatrixInverse_T]:
  if adjoint is None:
    adjoint = False
  adjoint = _execute.make_bool(adjoint, "adjoint")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float64, _dtypes.float32, ])
...
def batch_matrix_solve(matrix: _atypes.TensorFuzzingAnnotation[TV_BatchMatrixSolve_T], rhs: _atypes.TensorFuzzingAnnotation[TV_BatchMatrixSolve_T], adjoint:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatrixSolve_T]:
  r"""TODO: add doc.
...
def batch_matrix_solve_eager_fallback(matrix: _atypes.TensorFuzzingAnnotation[TV_BatchMatrixSolve_T], rhs: _atypes.TensorFuzzingAnnotation[TV_BatchMatrixSolve_T], adjoint: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatrixSolve_T]:
  if adjoint is None:
    adjoint = False
  adjoint = _execute.make_bool(adjoint, "adjoint")
...
def batch_matrix_triangular_solve_eager_fallback(matrix: _atypes.TensorFuzzingAnnotation[TV_BatchMatrixTriangularSolve_T], rhs: _atypes.TensorFuzzingAnnotation[TV_BatchMatrixTriangularSolve_T], lower: bool, adjoint: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatrixTriangularSolve_T]:
  if lower is None:
    lower = True
  lower = _execute.make_bool(lower, "lower")
  if adjoint is None:
...
def batch_self_adjoint_eig_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_BatchSelfAdjointEig_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchSelfAdjointEig_T]:
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float64, _dtypes.float32, ])
  _inputs_flat = [input]
  _attrs = ("T", _attr_T)
...
def batch_svd_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_BatchSvd_T], compute_uv: bool, full_matrices: bool, name, ctx):
  if compute_uv is None:
    compute_uv = True
  compute_uv = _execute.make_bool(compute_uv, "compute_uv")
  if full_matrices is None:
...
def cholesky(input: _atypes.TensorFuzzingAnnotation[TV_Cholesky_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Cholesky_T]:
...
def cholesky_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Cholesky_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Cholesky_T]:
...
def cholesky_grad_eager_fallback(l: _atypes.TensorFuzzingAnnotation[TV_CholeskyGrad_T], grad: _atypes.TensorFuzzingAnnotation[TV_CholeskyGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CholeskyGrad_T]:
...
def eig_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Eig_T], Tout: TV_Eig_Tout, compute_v: bool, name, ctx):
  Tout = _execute.make_type(Tout, "Tout")
  if compute_v is None:
    compute_v = True
  compute_v = _execute.make_bool(compute_v, "compute_v")
...
def einsum(inputs: List[_atypes.TensorFuzzingAnnotation[TV_Einsum_T]], equation: str, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Einsum_T]:
...
def einsum_eager_fallback(inputs: List[_atypes.TensorFuzzingAnnotation[TV_Einsum_T]], equation: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Einsum_T]:
  if not isinstance(inputs, (list, tuple)):
    raise TypeError(
        "Expected list for 'inputs' argument to "
        "'einsum' Op, not %r." % inputs)
...
def log_matrix_determinant_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_LogMatrixDeterminant_T], name, ctx):
...
def matrix_determinant_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_MatrixDeterminant_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MatrixDeterminant_T]:
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [input]
  _attrs = ("T", _attr_T)
...
def matrix_exponential(input: _atypes.TensorFuzzingAnnotation[TV_MatrixExponential_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_MatrixExponential_T]:
...
def matrix_exponential_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_MatrixExponential_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MatrixExponential_T]:
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float64, _dtypes.float32, _dtypes.half, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [input]
  _attrs = ("T", _attr_T)
...
def matrix_inverse_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_MatrixInverse_T], adjoint: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MatrixInverse_T]:
  if adjoint is None:
    adjoint = False
  adjoint = _execute.make_bool(adjoint, "adjoint")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float64, _dtypes.float32, _dtypes.half, _dtypes.complex64, _dtypes.complex128, ])
...
def matrix_logarithm(input: _atypes.TensorFuzzingAnnotation[TV_MatrixLogarithm_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_MatrixLogarithm_T]:
...
def matrix_logarithm_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_MatrixLogarithm_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MatrixLogarithm_T]:
...
def matrix_solve_ls_eager_fallback(matrix: _atypes.TensorFuzzingAnnotation[TV_MatrixSolveLs_T], rhs: _atypes.TensorFuzzingAnnotation[TV_MatrixSolveLs_T], l2_regularizer: _atypes.TensorFuzzingAnnotation[_atypes.Float64], fast: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MatrixSolveLs_T]:
  if fast is None:
    fast = True
  fast = _execute.make_bool(fast, "fast")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([matrix, rhs], ctx, [_dtypes.float64, _dtypes.float32, _dtypes.half, _dtypes.complex64, _dtypes.complex128, ])
...
def matrix_square_root_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_MatrixSquareRoot_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MatrixSquareRoot_T]:
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float64, _dtypes.float32, _dtypes.half, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [input]
  _attrs = ("T", _attr_T)
...
def matrix_triangular_solve_eager_fallback(matrix: _atypes.TensorFuzzingAnnotation[TV_MatrixTriangularSolve_T], rhs: _atypes.TensorFuzzingAnnotation[TV_MatrixTriangularSolve_T], lower: bool, adjoint: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MatrixTriangularSolve_T]:
  if lower is None:
    lower = True
  lower = _execute.make_bool(lower, "lower")
  if adjoint is None:
...
def self_adjoint_eig(input: _atypes.TensorFuzzingAnnotation[TV_SelfAdjointEig_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SelfAdjointEig_T]:
...
def self_adjoint_eig_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_SelfAdjointEig_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SelfAdjointEig_T]:
...
def self_adjoint_eig_v2(input: _atypes.TensorFuzzingAnnotation[TV_SelfAdjointEigV2_T], compute_v:bool=True, name=None):
...
def self_adjoint_eig_v2_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_SelfAdjointEigV2_T], compute_v: bool, name, ctx):
  if compute_v is None:
    compute_v = True
  compute_v = _execute.make_bool(compute_v, "compute_v")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float64, _dtypes.float32, _dtypes.half, _dtypes.complex64, _dtypes.complex128, ])
...
def svd(input: _atypes.TensorFuzzingAnnotation[TV_Svd_T], compute_uv:bool=True, full_matrices:bool=False, name=None):
...
def tridiagonal_mat_mul_eager_fallback(superdiag: _atypes.TensorFuzzingAnnotation[TV_TridiagonalMatMul_T], maindiag: _atypes.TensorFuzzingAnnotation[TV_TridiagonalMatMul_T], subdiag: _atypes.TensorFuzzingAnnotation[TV_TridiagonalMatMul_T], rhs: _atypes.TensorFuzzingAnnotation[TV_TridiagonalMatMul_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TridiagonalMatMul_T]:
...
def tridiagonal_solve(diagonals: _atypes.TensorFuzzingAnnotation[TV_TridiagonalSolve_T], rhs: _atypes.TensorFuzzingAnnotation[TV_TridiagonalSolve_T], partial_pivoting:bool=True, perturb_singular:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_TridiagonalSolve_T]:
