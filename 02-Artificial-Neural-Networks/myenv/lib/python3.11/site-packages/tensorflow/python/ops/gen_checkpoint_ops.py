...
def load_and_remap_matrix(ckpt_path: _atypes.TensorFuzzingAnnotation[_atypes.String], old_tensor_name: _atypes.TensorFuzzingAnnotation[_atypes.String], row_remapping: _atypes.TensorFuzzingAnnotation[_atypes.Int64], col_remapping: _atypes.TensorFuzzingAnnotation[_atypes.Int64], initializing_values: _atypes.TensorFuzzingAnnotation[_atypes.Float32], num_rows: int, num_cols: int, max_rows_in_memory:int=-1, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Float32]:
