...
def csr_sparse_matrix_to_dense_eager_fallback(sparse_input: _atypes.TensorFuzzingAnnotation[_atypes.Variant], type: TV_CSRSparseMatrixToDense_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CSRSparseMatrixToDense_type]:
  type = _execute.make_type(type, "type")
...
def dense_to_csr_sparse_matrix_eager_fallback(dense_input: _atypes.TensorFuzzingAnnotation[TV_DenseToCSRSparseMatrix_T], indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def sparse_matrix_mul_eager_fallback(a: _atypes.TensorFuzzingAnnotation[_atypes.Variant], b: _atypes.TensorFuzzingAnnotation[TV_SparseMatrixMul_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  _attr_T, (b,) = _execute.args_to_matching_eager([b], ctx, [])
  a = _ops.convert_to_tensor(a, _dtypes.variant)
  _inputs_flat = [a, b]
  _attrs = ("T", _attr_T)
...
def sparse_matrix_nnz_eager_fallback(sparse_matrix: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  sparse_matrix = _ops.convert_to_tensor(sparse_matrix, _dtypes.variant)
  _inputs_flat = [sparse_matrix]
  _attrs = None
...
def sparse_matrix_ordering_amd_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Variant], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
...
def sparse_matrix_softmax(logits: _atypes.TensorFuzzingAnnotation[_atypes.Variant], type: TV_SparseMatrixSoftmax_type, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def sparse_matrix_softmax_eager_fallback(logits: _atypes.TensorFuzzingAnnotation[_atypes.Variant], type: TV_SparseMatrixSoftmax_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  type = _execute.make_type(type, "type")
...
def sparse_matrix_softmax_grad(softmax: _atypes.TensorFuzzingAnnotation[_atypes.Variant], grad_softmax: _atypes.TensorFuzzingAnnotation[_atypes.Variant], type: TV_SparseMatrixSoftmaxGrad_type, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def sparse_matrix_softmax_grad_eager_fallback(softmax: _atypes.TensorFuzzingAnnotation[_atypes.Variant], grad_softmax: _atypes.TensorFuzzingAnnotation[_atypes.Variant], type: TV_SparseMatrixSoftmaxGrad_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  type = _execute.make_type(type, "type")
...
def sparse_matrix_sparse_cholesky_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Variant], permutation: _atypes.TensorFuzzingAnnotation[_atypes.Int32], type: TV_SparseMatrixSparseCholesky_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  type = _execute.make_type(type, "type")
  input = _ops.convert_to_tensor(input, _dtypes.variant)
...
def sparse_matrix_transpose_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Variant], type: TV_SparseMatrixTranspose_type, conjugate: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  type = _execute.make_type(type, "type")
  if conjugate is None:
    conjugate = False
  conjugate = _execute.make_bool(conjugate, "conjugate")
...
def sparse_matrix_zeros_eager_fallback(dense_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], type: TV_SparseMatrixZeros_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
  type = _execute.make_type(type, "type")
...
def sparse_tensor_to_csr_sparse_matrix(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_SparseTensorToCSRSparseMatrix_T], dense_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
...
def sparse_tensor_to_csr_sparse_matrix_eager_fallback(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_SparseTensorToCSRSparseMatrix_T], dense_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Variant]:
